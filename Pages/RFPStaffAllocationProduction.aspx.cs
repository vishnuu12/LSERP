...
public partial class Pages_RFPStaffAllocationProduction : System.Web.UI.Page
{
    #region"Declaration"
    ...
    protected void btnSaveStaff_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            objCommon.DepartmentName = "Production";
    ...
    protected void gvStaffAssignmentDetails_OnRowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else
        {
            ...
            if (e.CommandName == "UnitAStaff")
            {
                ...
                ds = objp.GetProductionEmployeeList();
    ...
    public void SaveAlertDetails(string EmployeeIds)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < str.Length; i++)
            {
                ...
                objAlerts.EmailID = "";
                objAlerts.GroupID = 0;
                objAlerts.Subject = "RFP Assigned Alert";
    ...
    private void BindStaffAssignmentEnquiryDetails()
    {
        ...
        try
        {
            ...
            ds = objCommon.GetRFPStaffAllocationDetails("LS_GetProductionEmployeeDetails");
