<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true" CodeFile="RFPStaffAllocationProduction.aspx.cs"
    Inherits="Pages_RFPStaffAllocationProduction" ClientIDMode="Predictable"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
      <%--  function showDataTable() {
            $('#<%=gvStaffAssignmentDetails.ClientID %>').DataTable({
                'aoColumnDefs': [{
                    'bSortable': false,
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Production Staff Assignment</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Production Staff Assignment</li>
                                                </ol>
                                     </nav>
                                ...
                                <div class="main-card">
                                    <div class="card-body">
                                        <div class="col-md-12 row">
                                            <div class="col-md-6">
                                                <p class="h-style">
                                                    <asp:Label ID="lbltitle" runat="server" Text="PO Staff Assignment"></asp:Label>
                                                </p>
                                            </div>
