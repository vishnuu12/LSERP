...
public partial class Pages_VendorFinshedWorkOrderWaitingForQualityVerification : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetEnquiryClarrificationForMarketingAndDesign("LS_GetVendorFinshedWorkOrderWaitingQC");
