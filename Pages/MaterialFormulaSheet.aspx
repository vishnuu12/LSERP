                    ...
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="javascript:void(0);">MasterSetup</a></li>
                                                    <li class="active breadcrumb-item" aria-current="page">Part Formula Sheet</li>
                                                </ol>
                                     </nav>
                    ...
                    <div class="card-container">
                        <div id="divAdd" runat="server">
                            <div class="ip-div text-center">
                                <asp:LinkButton ID="btnAddNew" runat="server" Text="Add New Part Formula" OnClick="btnAddNew_Click"
                                ...
                                <div class="col-sm-12 p-t-10">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:TextBox ID="txtFormula" runat="server" CssClass="form-control" ToolTip="Enter Formula"
                                            AutoComplete="off" placeholder="Enter Formula Code"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-4">
                                    </div>
                                </div>
                                ...
                                <div class="main-card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class="h-style">
                                                    <asp:Label ID="lbltitle" runat="server" Text="Part Formula Details"></asp:Label></p>
                                            </div>
                                        ...
                                        <div class="col-sm-12 p-t-10 p-l-0 p-r-0">
                                            <asp:GridView ID="gvMaterialFormula" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField ItemStyle-CssClass="text-center" HeaderText="Part Name" ItemStyle-Width="25%">
                                                        <ItemTemplate>
