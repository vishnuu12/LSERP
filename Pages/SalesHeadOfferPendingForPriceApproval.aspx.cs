...
public partial class Pages_SalesHeadOfferPendingForPriceApproval : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetOfferPendingPriceApproval("LS_GetOfferPendingPriceApproval");
