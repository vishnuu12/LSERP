...
public partial class Pages_AlertForMaterialInwardForFollwingMaterialWaitingForQualityClearace : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetEnquiryClarrificationForMarketingAndDesign("LS_GetAlertForMaterialInwardForFollowingMaterialInwardQualityClearance");
