        ...
        <div>
            <asp:UpdatePanel ID="upQuote" runat="server">
                <ContentTemplate>
                    ...
                    <div class="ip-div col-sm-12 text-center">
                                        ...
                                        <div class="col-sm-2">
                                            <asp:TextBox ID="txtFromDate" runat="server" CssClass="form-control datepicker" MaxLength="10"
                                                placeholder="Select From Date" ToolTip="Select From Date" data-date-end-date="0d"></asp:TextBox></div>
                                        <div class="col-sm-1">
                                        </div>
                                        <div class="col-sm-1">
                                            <label class="form-label">
                                        ...
                                        <div class="col-sm-2">
                                            <asp:TextBox ID="txtToDate" runat="server" CssClass="form-control datepicker" MaxLength="10"
                                                placeholder="Select From Date" ToolTip="Select To Date" data-date-end-date="0d"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-3">
                    ...
                    <div id="output" class="output_section ip-div text-center" style="float:left;">
                     <div class="page-container" style="float: left; width: 100%">
                        <div class="main-card">
                            <div class="card-body">
                            <div class="">
                                    <p class="h-style" id="headingcontent" runat="server"></p>
                                     <div class="f-right">
                                     </div>
                                        <div class="clear"></div>
                                    </div>
