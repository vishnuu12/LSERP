<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="MyInBox.aspx.cs" Inherits="Pages_MyInBox" %>
    ...
    <div class="main-container main-container_close">
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">My Inbox</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">My Inbox</li>
                                                </ol>
                                     </nav>
        ...
        <div>
            <asp:UpdatePanel ID="upDocumenttype" runat="server">
                <Triggers>
                    <asp:PostBackTrigger ControlID="gvMyInbox" />
                </Triggers>
                <ContentTemplate>
                                ...
                                <div class="main-card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-12 p-t-10">
                                            <asp:GridView ID="gvMyInbox" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                EmptyDataText="No Records Found" CssClass="table table-hover table-bordered medium"
                                                HeaderStyle-HorizontalAlign="Center" OnRowCommand="gvMyInbox_OnRowCommand" DataKeyNames="FileName">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="From" HeaderStyle-CssClass="text-left">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Subject" HeaderStyle-CssClass="text-left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblSubject" runat="server" Text='<%# Eval("Header")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Email/SMS" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="View Message" ItemStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblMessage" runat="server" Style="display: none;" Text='<%# Eval("Message")%>'></asp:Label>
                                                    ...
                                                    <asp:TemplateField HeaderText="Attach" ItemStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnViewAtch" runat="server" CommandArgument='<%#((GridViewRow) Container).RowIndex %>' CommandName="ViewAttch">
                                                                  <img src="../Assets/images/view.png" /></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                ...
                <asp:UpdatePanel ID="upView" runat="server">
                    ...
                    <ContentTemplate>
                        <div class="modal-header">
                            <h4 class="modal-title ADD">Message
                            </h4>
                            ...
                            <div class="inner-container">
                                <div id="divQPDetails" runat="server">
                                    ...
                                    <%--<div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4">
                                            <asp:LinkButton ID="btnSave" runat="server" CssClass="btn btn-cons btn-save AlignTop"
                                                OnClick="btnViewAttachements"><img src="../Assets/images/view.png" /></asp:LinkButton>
                                        </div>
                                        <div class="col-sm-4">
                                        </div>
                                    </div>--%>
