<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="DeflectionTestReport.aspx.cs" Inherits="Pages_DeflectionTestReport" %>
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Deflection Test Report</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Deflection test Report</li>
                                                </ol>
                                     </nav>
                            ...
                            <div class="page-container" style="float: left; width: 100%">
                                <div class="main-card">
                                                ...
                                                <table align="center" id="tbl_customerDetails" class="tr_class table" style="text-transform: none;">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <span id="Span13" class="eqdetailslabel">PO No</span>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <span id="Span14" class="eqdetailslabel">QAP No</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtQAPNo" CssClass="form-control mandatoryfield" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <span id="Span1" class="eqdetailslabel">Bellow Serial No</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtBellowSerialNo" CssClass="form-control mandatoryfield" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                                <span id="Span4" class="eqdetailslabel">Customer Name</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtCustomerName" CssClass="form-control mandatoryfield" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <span id="Span9" class="eqdetailslabel">Required Movement</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtRequiredMovement" CssClass="form-control mandatoryfield" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                            ...
                                                            <td align="left">
                                                                <span id="Span6" class="eqdetailslabel">Size</span>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <span id="Span7" class="eqdetailslabel">Actual</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtActual" CssClass="form-control mandatoryfield" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <span id="Span8" class="eqdetailslabel">Remarks</span>
                                                            </td>
                                                            <td align="left">
                                    ...
                                    <div class="col-sm-12 text-center">
                                        <asp:LinkButton ID="btnSaveDT" runat="server" CssClass="btn btn-cons btn-save AlignTop"
                                            Text="Add" OnClientClick="return Mandatorycheck('ContentPlaceHolder1_divInput');"
                                            OnClick="btnSaveDT_Click">
                                        </asp:LinkButton>
                                    </div>
                                    <div id="divOutPut" class="col-sm-12 p-t-10" style="overflow-x: scroll;" runat="server">
                                        <asp:GridView ID="gvDTReport" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                ...
                                                <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnAdd" runat="server" CommandArgument='<%#((GridViewRow) Container).RowIndex %>'
                                                            OnClientClick='<%# string.Format("return deleteConfirm({0});",Eval("DTRID")) %>'>
                                        ...
                                        <asp:HiddenField ID="hdnDTRID" runat="server" Value="0" />
