<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="DailyActivitiesProductionDetails.aspx.cs" Inherits="Pages_DailyActivitiesProductionDetails" ClientIDMode="Predictable" %>
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Daily Activities Production Enquiry</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Daily Activities Production Enquiry</li>
                                                </ol>
                                     </nav>
                                ...
                                <div class="col-sm-12 p-t-20">
                                    ...
                                    <div class="col-sm-6 text-left">
                                        <asp:DropDownList ID="ddlCurentStatus" runat="server"
                                            ...
                                            <asp:ListItem Text="Stage Inspection" Value="Pending Under For Customer"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-sm-2">
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-12" style="overflow-x: scroll;">
                                            <asp:GridView ID="gvDailyActivitiesReport" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover no-more-tables"
                                                Width="100%" ShowHeaderWhenEmpty="True" EmptyDataText="No Records Found" DataKeyNames="DAPDID">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Delete">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtnDelete" runat="server"
                                                                OnClientClick='<%# string.Format("return deleteConfirm({0});",Eval("DAPDID")) %>'>
