...
public partial class Pages_VEReport : System.Web.UI.Page
{
    #region"Declaration"
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                objQt = new cQuality();
                DataSet ds = objQt.DeleteQualityTestReportDetailsByPrimaryID("LS_DeleteVEReportDetailsByVERID", arg.ToString());
