...
public partial class Pages_SalesHeadContractReviewDiscripencyForMarketingAndDesign : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    protected void gvEnquiryProjectAssignmentReport_DataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (dr["Completion Status"].ToString() == "InComplete")
                {
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetEnquiryClarrificationForMarketingAndDesign("LS_GetContractReviewDiscripencyForMarketingAndDesign");
