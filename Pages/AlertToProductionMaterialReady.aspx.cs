...
public partial class Pages_AlertToProductionMaterialReady : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetEnquiryClarrificationForMarketingAndDesign("LS_GetAlertToProductionTeamMaterialReadyState");
