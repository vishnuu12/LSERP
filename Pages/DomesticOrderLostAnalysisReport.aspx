<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true" CodeFile="DomesticOrderLostAnalysisReport.aspx.cs"
    Inherits="Pages_DomesticOrderLostAnalysisReport" ClientIDMode="Predictable" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function PrintNewCustomerAddtionList(QRCode) {
            ...
            var divCustomerDetails = $('#ContentPlaceHolder1_divdomesticorderlostanalysis_p').html();
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Domestic Order Lost Analysis Report  </h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">ISO Report</li>
                                                </ol>
                                     </nav>
                                ...
                                <div class="main-card">
                                    <div class="card-body">
                                        ...
                                        <div id="divdetails" runat="server">
                                            <div class="col-sm-12 p-t-10">
                                                <div class="col-sm-4">
                                                    <label style="color: brown; font-size: large;">Total No Of Offer Submit </label>
                                                </div>
                                                <div class="col-sm-4">
                                                    <asp:Label ID="lblTotalNoOfOfferSUbmit" Style="color: #000; font-size: large; font-weight: bold;" runat="server"> </asp:Label>
                                                </div>
                                                <div class="col-sm-4">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12 p-t-10">
                                                <div class="col-sm-4">
                                                    <label style="color: brown; font-size: large;">Loss Order  </label>
                                                </div>
                                                <div class="col-sm-4">
                                                    <asp:Label ID="lblorderloss" Style="color: #000; font-size: large; font-weight: bold;" runat="server"> </asp:Label>
                                                </div>
                                                <div class="col-sm-4">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12 p-t-10">
                                                <div class="col-sm-4">
                                                    <label style="color: brown; font-size: large;">Order Confirm  </label>
                                                </div>
                                                <div class="col-sm-4">
                                                    <asp:Label ID="lblOrderOffer" Style="color: #000; font-size: large; font-weight: bold;" runat="server"> </asp:Label>
                                                </div>
                                                <div class="col-sm-4">
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-t-10 text-center">
                                                <label style="font-weight: bold; color: #000; font-size: 20px;">Order Lost Details</label>
                                            </div>
                                            ...
                                            <div class="col-sm-12 p-t-10">
                                                <asp:GridView ID="gvCustomerAddtionReportDetails" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Customer Name">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblProspectName" runat="server" Text='<%# Eval("ProspectName")%>'>
                                                                </asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Enquiry No">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblEnquiryNumber" runat="server" Text='<%# Eval("EnquiryNumber")%>'>
                                                                </asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Offer Type">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblOfferTypeName" runat="server" Text='<%# Eval("OfferTypeName")%>'>
                                                                </asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Lost Detail">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblLostDetail" runat="server" Text='<%# Eval("LostDetail")%>'>
                                                                </asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                        ...
                                        <div id="divdomesticorderlostanalysis_p" runat="server" style="display: none;">

                                            <div class="col-sm-12 text-center" style="background-color: #b0acac; padding-top: 10px; padding-bottom: 10px;">

                                                <asp:Label Style="color: Black; font-weight: bolder; font-size: large ! important;" ID="lblheadername_p"
                                                    runat="server" Text="">
                                                </asp:Label>
                                            ...
                                            <div class="col-sm-12 p-t-10 text-center">
                                                ...
                                                <label style="color: brown; font-size: large;">Total No Of Offer Submit </label>
                                                <asp:Label ID="lbltotalNoOfoffersubmit_p" Style="color: #000; font-size: large; font-weight: bold;" runat="server"> </asp:Label>
                                            ...
                                            <div class="col-sm-12 p-t-10 text-center">
                                                ...
                                                <label style="color: brown; font-size: large;">Loss Order  </label>
                                                <asp:Label ID="lbllossorder_p" Style="color: #000; font-size: large; font-weight: bold;" runat="server"> </asp:Label>
                                            ...
                                            <div class="col-sm-12 p-t-10 text-center">
                                                ...
                                                <asp:Label ID="lblorderconfirm_p" Style="color: #000; font-size: large; font-weight: bold;" runat="server"> </asp:Label>
                                            </div>


                                            <div class="col-sm-12 p-t-10">
                                                <asp:GridView ID="gvdometicorderlostdetails_p" runat="server"
                                                    CssClass="table table-bordered table-hover no-more-tables orderingfalse"
                                                    ShowHeaderWhenEmpty="True" EmptyDataText="No Records Found" AutoGenerateColumns="false">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="S.No" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
