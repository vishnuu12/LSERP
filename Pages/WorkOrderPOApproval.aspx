<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="WorkOrderPOApproval.aspx.cs" Inherits="Pages_WorkOrderPOApproval" ClientIDMode="Predictable" %>
    ...
    <script type="text/javascript">
        ...
        function opennewtab(Filepath) {
            ...
            for (var i = 0; i < FileName.length; i++)
                window.open('http://lonestarindia.in/LSERPDocs/WorkOrderIndent/' + FileName[i], '_blank');
        }
        ...
        function PrintWorkOrderPO(Approvedtime, POStatus) {
            ...
            winprint.document.write("<label style='display:block;width:100%;'>For " + $('#ContentPlaceHolder1_hdnCompanyName').val() + "</label>");
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Work Order PO Approval</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-12 p-t-10" style="overflow-x: scroll;">
                                            <asp:GridView ID="gvWorkOrderPO" runat="server" AutoGenerateColumns="False" OnRowCommand="gvWorkOrderPO_OnRowCommand"
                                                ...
                                                OnRowDataBound="gvWorkOrderPO_OnRowDataBound"
                                                CssClass="table table-hover table-bordered medium" DataKeyNames="WPOID,POStatus,Wonumber,PORevision,DrawingFile">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="L1 Approved By">
                                                        <ItemTemplate>
                                                            <asp:Label ID="L2ApprovedBy" runat="server" Text='<%# Eval("WPOL3ApprovedBy")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="L1 Approved Date">
                                                        <ItemTemplate>
                                                            <asp:Label ID="L2ApprovedDate" runat="server" Text='<%# Eval("WPOL3ApprovedDate")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="L2 Approved By">
                                                        <ItemTemplate>
                                                            <asp:Label ID="L1ApprovedBy" runat="server" Text='<%# Eval("WPOL2ApprovedBy")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="L2 Approved Date">
                                                        <ItemTemplate>
                                                            <asp:Label ID="L1ApprovedDate" runat="server" Text='<%# Eval("WPOL2ApprovedDate")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="PDF" HeaderStyle-Width="70px" ItemStyle-CssClass="70px">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblAmdVersion" Style="color: brown;" runat="server"> </asp:Label>
                                                    ...
                                                    <asp:TemplateField HeaderText="OLD Print">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtnOldPDF" runat="server" CommandArgument='<%#((GridViewRow) Container).RowIndex %>'
                                                                CommandName="PrintPDF">  <img src="../Assets/images/pdf.png" /></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
