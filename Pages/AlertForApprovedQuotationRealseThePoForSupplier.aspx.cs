...
public partial class Pages_AlertForApprovedQuotationRealseThePoForSupplier : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetEnquiryClarrificationForMarketingAndDesign("LS_GetAlertForApprovedQuotationReleaseToPOForSupplier");
