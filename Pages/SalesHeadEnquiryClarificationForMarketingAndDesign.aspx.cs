...
public partial class Pages_SalesHeadEnquiryClarificationForMarketingAndDesign : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    protected void gvEnquiryProjectAssignmentReport_DataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (string.IsNullOrEmpty(dr["Completion Status"].ToString()) || dr["Completion Status"].ToString() == "InComplete")
                {
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetEnquiryClarrificationForMarketingAndDesign("LS_GetEnquiryClarriFicationForMarketingAndDesign");
