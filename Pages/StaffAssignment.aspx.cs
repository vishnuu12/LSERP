...
public partial class Pages_StaffAssignment : System.Web.UI.Page
{
    ...
    protected void gvStaffAssignmentDetails_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            ...
            if (ddl.SelectedIndex != 0 && (txt.Text != "" || (_objSess.type == 5 || _objSess.type == 1)))
            {
                ...
                if (_objSess.type != 5 && _objSess.type != 1) objCommon.DesignerDeadLineDate = DateTime.ParseExact((((TextBox)gvStaffAssignmentDetails.Rows[e.RowIndex].FindControl("txtDesignerDeadLineDate")).Text), "dd/MM/yyyy", CultureInfo.InvariantCulture);
    ...
    protected void gvStaffAssignmentDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        try
        {
            ...
            {
                if (_objSess.type == 5 || _objSess.type == 1) e.Row.Cells[7].Attributes.Add("style", "display:none;");
    ...
    public void SaveAlertDetails(string EnquiryID, string EmployeeID)
    {
        ...
        try
        {
            ...
            objAlerts.file = "";
            objAlerts.reciverID = EmployeeID;
            objAlerts.EmailID = "";
            objAlerts.GroupID = 0;
