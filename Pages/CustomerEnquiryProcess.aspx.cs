    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (ValidateFields())
            {
                ...
                objSales.Type = ddlEnquiryNewType.SelectedValue.ToString();
    ...
    protected void gvCustomerEnquiry_OnRowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            ...
            if (e.CommandName.ToString() == "EditEnquiry")
            {
                ...
                ddlEnquiryNewType.SelectedValue = ds.Tables[0].Rows[0]["EnquiryNewType"].ToString();
            ...
            if (e.CommandName.ToString() == "View")
            {
                ...
                EnquiryNewType_V.Text = ds.Tables[0].Rows[0]["EnquiryNewType"].ToString();
    ...
    protected void gvAttachments_OnRowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            ...
            if (e.CommandName.ToString() == "ViewDocs")
            {
                ...
                cCommon.DownLoad(FileName, CusstomerEnquirySavePath + ViewState["EnquiryNumber"].ToString() + "\\" + FileName);
...
//    private void PrintGeneralWorkOrderPODetails()
//    {
...
//            string Page = url.Replace(Replacevalue, "GeneralWorkorderPoPrint.aspx?GDCID=" + 22 + "");
