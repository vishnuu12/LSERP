<%@ Page Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="SalesCostApproval.aspx.cs" Inherits="Pages_SalesCostApproval" ClientIDMode="Predictable" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function BindMarketingOverHeadCost(ele) {
            ...
            var UnitCostINR = parseFloat(parseFloat(MarketingOverHeadCost) + parseFloat(PackagingCost) + parseFloat(AddPartBomCost) - parseFloat(IssuePartBomCost)).toFixed(2);
        ...
        function UnitCostForignCurrency(ele) {
            ...
            var ValidCost = parseFloat(BomCost) + parseFloat(AddPartBomCost) + parseFloat(PackagingCost) - parseFloat(IssuePartBomCost);
        ...
        function SaveConfirm() {
            swal({
                title: "Are you sure?",
                text: "If Yes, No Further Edit Once Cost Approved",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
                ...
                __doPostBack("CostApprove", "");
            });
            return false;
        }

        function SalesCostReviewConfirm() {
            swal({
                title: "Are you sure?",
                text: "If Yes, Are you Sure",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Sales Cost Approval</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Sales Cost Approval</li>
                                                </ol>
                                     </nav>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-12 p-t-10 p-l-0 p-r-0" style="overflow-x: scroll;">
                                            <asp:GridView ID="gvsalescost" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                ...
                                                EmptyDataText="No Records Found" DataKeyNames="EnquiryID,DDID,FileName,ETCID">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-CssClass="marketingclass">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblmarketingOverHeadCost" CssClass="MarketingOverheadValueCost" Text='<%# Eval("MarketingCost") =="" ? "0.00":Eval("MarketingCost")%>'
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblPackagingCosthead" CssClass="PackagingCostValue" Text='<%# Eval("PackagingCost") =="" ? "0.00":Eval("PackagingCost")%>'
                                                                runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                        ...
                                        <div class="ip-div text-center btnreprocess p-t-10">
                                            ...
                                            <asp:Button ID="btnAccepted" Visible="false" OnClick="btnAccepted_Click" runat="server"
                                                CssClass="btn btn-cons btn-success btnAproval" Text="Accepted" />
                                            <asp:Button ID="btn_previewcostsheet" OnClientClick="return btnAssignCost();" OnClick="btnAproval_Click"
                                                runat="server" CssClass="btn btn-cons btn-success btnAproval" Text="Submit" />

                                            <asp:Button ID="btnReviewSalesCost" OnClientClick="return SalesCostReviewConfirm();"
                                                runat="server" CssClass="btn btn-cons btn-success" Text="Sales Cost Review" />
