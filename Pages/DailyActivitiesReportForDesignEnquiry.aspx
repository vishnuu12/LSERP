<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master"
    AutoEventWireup="true" CodeFile="DailyActivitiesReportForDesignEnquiry.aspx.cs"
    Inherits="Pages_DailyActivitiesReportForDesignEnquiry" ClientIDMode="Predictable" %>
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Daily Activities Design Enquiry</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Daily Activities Enquiry</li>
                                                </ol>
                                     </nav>
                        ...
                        <div id="divInput" runat="server">
                            <div class="ip-div text-center">
                                ...
                                <div class="col-sm-12 p-t-10">
                                    ...
                                    <div class="col-sm-6 text-left">
                                        <asp:RadioButtonList ID="rblReSchduleSubmissiondate" runat="server" CssClass="radio radio-success" RepeatDirection="Horizontal"
                                            AutoPostBack="true" OnSelectedIndexChanged="rblReSchduleSubmissiondate_OnSelectIndexChanged" RepeatLayout="Flow"
                                            TabIndex="5">
                                ...
                                <div id="divreschdule" runat="server" visible="false">
                                    ...
                                    <div class="col-sm-12 p-t-10">
                                        ...
                                        <div class="col-sm-6 text-left">
                                            <asp:TextBox ID="txtReason" runat="server" CssClass="form-control mandatoryfield"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-2">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 p-t-10">
                                        ...
                                        <div class="col-sm-6 text-left">
                                            <asp:TextBox ID="txtRescheduleDate" runat="server" CssClass="form-control datepicker mandatoryfield"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-2">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12 p-t-10">
                                    ...
                                    <div class="col-sm-6 text-left">
                                        <asp:TextBox ID="txtRemarks" CssClass="form-control mandatoryfield" TextMode="MultiLine" Rows="4" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-2">
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-12" style="overflow-x: scroll;">
                                            <asp:GridView ID="gvDailyActivitiesReport" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover no-more-tables"
                                                Width="100%" ShowHeaderWhenEmpty="True" EmptyDataText="No Records Found" DataKeyNames="DADEDID">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Re Schdule Reason">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblReschedulereason" runat="server" Text='<%# Eval("RescheduleReason") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="Re Schedule Date">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblrescheduledate" runat="server" Text='<%# Eval("ResceduleSubmissionDate") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Delete">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtnDelete" runat="server" CommandName="EditDADE">
