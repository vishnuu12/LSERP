<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true" 
    CodeFile="GRNStockReportsNew.aspx.cs" Inherits="Pages_GRNStockReportsNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript" >
        ...
        function showDataTable() {
            $('#ContentPlaceHolder1_gvGRNReports').DataTable({
                'aoColumnDefs': [{
                    'bSortable': false,
        ...
        function PrintGRN(GRNIDID) {
            OpenGRNPrint(GRNIDID);
            return false;
        }

        function OpenGRNPrint(GRNIDID) {
            var str = window.location.href.split('/');
            var replacevalue = str[str.length - 1];
            window.open(window.location.href.replace(replacevalue, 'GRNPrintDetailsNew.aspx?GRNIDID=' + GRNIDID + ''), '_blank');
        }
     ...
     <style type="text/css">
        ...
        table#ContentPlaceHolder1_gvGRNReports td {
            color: #000;
            font-weight: bold;
            font-size: smaller;
        }
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">GRN Print</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">GRN Print</li>
                                                </ol>
                                     </nav>
                                                ...
                                                <Columns>
                                                     ...
                                                     <asp:TemplateField HeaderText="GRN Print" ItemStyle-HorizontalAlign="left" HeaderStyle-Width="105px"
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                OnClientClick='<%# string.Format("return PrintGRN({0});",Eval("GRNIDID")) %>'>
