<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="OfferDispatch.aspx.cs" Inherits="Pages_OfferDispatch" ValidateRequest="false"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function Validate() {
            if ($('#ContentPlaceHolder1_gvOfferDetails').find('[type="checkbox"]:checked').length > 0) {
                return true;
            }
            else {
                ErrorMessage('Error', 'No Offer Selected');
                return false;
            }
        }
    ...
    <div class="main-container main-container_close">
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Offer Dispatch</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="active breadcrumb-item" aria-current="page">Offer Dispatch</li>
                            </ol>
                        </nav>
        ...
        <div>
            <asp:UpdatePanel ID="upQuote" runat="server" UpdateMode="Always">
                <Triggers>
                    <asp:PostBackTrigger ControlID="gvOfferDetails" />
                </Triggers>
                <ContentTemplate>
                                ...
                                <div class="main-card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 p-t-10">
                                                <asp:GridView ID="gvOfferDetails" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                    EmptyDataText="No Records Found" OnRowCommand="gvOfferDetails_OnRowCommand" CssClass="table table-hover table-bordered medium"
                                                    DataKeyNames="EnquiryNumber,EODID">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Offer No" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblOfferNumber" runat="server" Text='<%# Eval("OfferNo")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Offer Cost" ItemStyle-HorizontalAlign="left" HeaderStyle-Width="200px"
                                                            HeaderStyle-HorizontalAlign="left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblOfferCost" runat="server" Text='<%# Eval("OfferCost")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Offer Dispatched" HeaderStyle-CssClass="text-center"
                                                            ItemStyle-CssClass="text-center">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbtnOfferDispatched" runat="server" Text='<%# Eval("OfferDispatched")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="View Item Details" HeaderStyle-CssClass="text-center"
                                                            ItemStyle-CssClass="text-center">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Offer Print (OLD)" HeaderStyle-CssClass="text-center"
                                                            ItemStyle-CssClass="text-center">
                                                            <ItemTemplate>
                                                        ...
                                                        <%--    <asp:TemplateField HeaderText="Offer Cost Print" HeaderStyle-CssClass="text-center"
                                                            ItemStyle-CssClass="text-center">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnCostPrint" runat="server" CommandArgument='<%#((GridViewRow) Container).RowIndex %>'
                                                                    CommandName="ViewOfferCostDetails"><img src="../Assets/images/pdf.png" /></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>--%>
                                                        <asp:TemplateField HeaderText="Offer Print" HeaderStyle-CssClass="text-center"
                                                            ItemStyle-CssClass="text-center">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnOfferPrint" runat="server"
                                                                    CommandArgument='<%#((GridViewRow) Container).RowIndex %>'
                                                                    CommandName="ViewOfferPrintDetails"><img src="../Assets/images/pdf.png" /></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-4">
                                                    <asp:LinkButton ID="btnOfferDispatch" CssClass="btn btn-success" runat="server" Text="Offer Dispatch"
                                                        OnClientClick="return Validate();" OnClick="btnOfferDispatch_Click"></asp:LinkButton>
                                                </div>
                                                <div class="col-sm-4">
                                                </div>
                                            </div>
                                            <div class="col-sm-12 p-t-10">
                                                <label style="font-size: 20px; color: red;">Offer Generated Before 22 Feb 2022 Print Offer(Old)  Else Offer Print  </label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
