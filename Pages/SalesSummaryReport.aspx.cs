...
public partial class Pages_SalesSummaryReport : System.Web.UI.Page
{
    #region"Declaration"
    ...
    public static object GetData()
    {
        ...
        try
        {
            ...
            if (HttpContext.Current.Session["SalesSummaryReport"] == null)
            {
                dataList = LoadData();
              ...
              !string.IsNullOrWhiteSpace(search))
            {
                ...
                dataList = dataList.Where(p =>
                          ...
                          || p["OfferLost"].ToString().ToLower().Contains(search.ToLower())
                          ).ToList();
            }
