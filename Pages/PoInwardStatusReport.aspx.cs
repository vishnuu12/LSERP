...
public partial class Pages_PoInwardStatusReport : System.Web.UI.Page
{
    #region"Declaration"
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                HttpContext.Current.Session["POInwardStatusReport"] = null;
    ...
    public static object GetData()
    {
        ...
        try
        {
            ...
            if (HttpContext.Current.Session["POInwardStatusReport"] == null)
            {
                dataList = LoadData();
                HttpContext.Current.Session["POInwardStatusReport"] = dataList;
            }
            else
                dataList = (List<Dictionary<string, object>>)HttpContext.Current.Session["POInwardStatusReport"];
              ...
              !string.IsNullOrWhiteSpace(search))
            {
                ...
                dataList = dataList.Where(p =>
                          ...
                          || p["InwardCost"].ToString().ToLower().Contains(search.ToLower())
                          || p["InwardStatus"].ToString().ToLower().Contains(search.ToLower())
                          ).ToList();
            }
    ...
    private static List<Dictionary<string, object>> LoadData()
    {
        ...
        try
        {
            ds = objR.POAndInwardStatusReportDetails_New();
    ...
    public static object ExcelDownLoad()
    {
        ...
        try
        {
            ...
            dt.Columns.Remove("SPOID");
            dt.Columns.Remove("InwardStatus");
            ...
            string LetterName = "POInwardStatusReport.xlsx";
            ...
            _objc.SaveExcelFile("PoInwardStatusReport.aspx", LetterName, "1001");
        ...
        return new
        {
            Data = new { FileName = "POInwardStatusReport.xlsx" }
        };
    }
