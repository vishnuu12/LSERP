...
public partial class Pages_WPSPendingAlertForQualutyTeamMembers : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetEnquiryClarrificationForMarketingAndDesign("LS_WPSPendingAlertForQuality");
