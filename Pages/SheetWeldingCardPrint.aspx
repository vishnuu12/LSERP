<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="SheetWeldingCardPrint.aspx.cs" Inherits="Pages_SheetWeldingCardPrint" ClientIDMode="Predictable" %>
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Sheet Welding Card Print</h3>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <asp:UpdatePanel ID="upDocumenttype" runat="server">
                ...
                <ContentTemplate>
                    <div class="card-container">
                        ...
                        <div id="divSheetWeldingPDF" runat="server" style="display: block;">
                            <div id="d" class="FrontPagepopupcontent" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-sm-6" style="overflow-wrap: break-word;">
                                        ...
                                        <div class="sideheading">
                                            ...
                                            <asp:Label ID="lblQCCompletionDate_SW_P" CssClass="lbl_v" runat="server"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row p-t-10">
                                ...
                                <div class="col-sm-12 p-t-10">
                                    <asp:GridView ID="gvWPSDetails_SW_P" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="VOLT" ItemStyle-HorizontalAlign="left"
                                                HeaderStyle-HorizontalAlign="left">
                                                <ItemTemplate>
                                ...
                                <div class="col-sm-12 p-t-10" runat="server" visible="false">
                                    <asp:GridView ID="gvTypeOfCheck_SW_P" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                        EmptyDataText="No Records Found"
                                        CssClass="table table-hover table-bordered medium">
                                        <Columns>
                                            <asp:TemplateField HeaderText="S.No" HeaderStyle-Width="5%" ItemStyle-Width="5%" HeaderStyle-CssClass="text-center"
