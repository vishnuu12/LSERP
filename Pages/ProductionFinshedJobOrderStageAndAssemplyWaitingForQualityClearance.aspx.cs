...
public partial class Pages_ProductionFinshedJobOrderStageAndAssemplyWaitingForQualityClearance : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    protected void gvEnquiryProjectAssignmentReport_DataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            //    if (dr["Warning"].ToString() == "Warning")
            //    {
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetEnquiryClarrificationForMarketingAndDesign("LS_GetProductionFinishedJobOrderStageAndAssemplyWaitingForQualityClearance");
