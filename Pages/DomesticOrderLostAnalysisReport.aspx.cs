...
public partial class Pages_DomesticOrderLostAnalysisReport : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    protected void btnprint_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ds = objRt.GetMarketingReportDetailsByFromDateAndToDate("LS_GetDomesticOrderLostAnalysisReport");

            lblheadername_p.Text = "Domestic Order Lost Analysis Report";
    ...
    protected void btnExcelDownload_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string LetterName = "DomesticOrderAnalysisReport.xls";
            ...
            _objc.SaveExcelFile("DomesticOrderAnalysisReport.aspx", LetterName, objSession.employeeid);
        }
        catch (Exception ex)
        {
            Log.Message(ex.ToString());
    ...
    public void exportExcel(DataTable dt, string fileName, string LetterName, string gemBoxKey)
    {
        try
        {
            ...
            SheetLocation1 = workbook.Worksheets.Add("Domestic Order Lost");

            SheetLocation1 = exportex(dt, dt.Rows.Count, dt.Columns.Count, LetterName,
                "Domestic Order Lost Analysis Report For The Date Between  " + txtFromDate.Text + " And " + txtToDate.Text + "", "", 2, SheetLocation1);
