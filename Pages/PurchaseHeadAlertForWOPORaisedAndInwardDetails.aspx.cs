...
public partial class Pages_PurchaseHeadAlertForWOPORaisedAndInwardDetails : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetEnquiryClarrificationForMarketingAndDesign("LS_GetWorkOrderPORaisedAndInwardQCDetails");
