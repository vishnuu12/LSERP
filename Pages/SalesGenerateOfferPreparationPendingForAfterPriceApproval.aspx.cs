...
public partial class Pages_SalesGenerateOfferPreparationPendingForAfterPriceApproval : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    protected void gvEnquiryProjectAssignmentReport_DataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (string.IsNullOrEmpty(dr["Approval Status"].ToString()))
                {
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetOfferPendingPriceApproval("LS_GetGenerateOfferPendingforAfterPriceApproval");
