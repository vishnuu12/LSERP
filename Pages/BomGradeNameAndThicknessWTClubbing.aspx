<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="BomGradeNameAndThicknessWTClubbing.aspx.cs" Inherits="Pages_BomGradeNameAndThicknessWTClubbing" %>
                                ...
                                <div class="main-card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class="h-style">
                                                    <asp:Label ID="lbltitle" runat="server" Text="Part Name Details"></asp:Label>
                                                </p>
                                            </div>
                                        ...
                                        <div class="col-sm-12 p-t-10">
                                            <asp:GridView ID="gvBomWTClubbing" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Grade Name" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="WT" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center">
                                                        <ItemTemplate>
