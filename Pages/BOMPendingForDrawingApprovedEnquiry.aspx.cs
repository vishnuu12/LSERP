...
public partial class Pages_BOMPendingForDrawingApprovedEnquiry : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetEnquiryClarrificationForMarketingAndDesign("LS_GetBOMPendingForDrawingApprovedEnquiry");
