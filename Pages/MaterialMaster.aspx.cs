...
public partial class Pages_MaterialMaster : System.Web.UI.Page
{
    ...
    //            txtAddNorm.Attributes.Add("style", "display:block;");
    ...
    //            txtAddNorm.Attributes.Add("style", "display:none;");
    ...
    protected void gvMaterialMaster_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName.ToString() == "EditMaterialName")
            {
                ...
                ddlMaterialType.SelectedValue = ((Label)gvMaterialMaster.Rows[index].FindControl("lblMaterialType")).Text.ToString();
