...
// Valid Phone Number
function ValidPhone(textbox) {
    if (textbox.value.length > 0 && textbox.value.length < 10) {
        textbox.focus();
        return false;
    }
    else {
...
// Valid Currency
function ValidCurrency(textbox) {
...
// Valid PinCode
function ValidPinCode(textbox) {
    if (textbox.value.length > 0 && (textbox.value.substring(0, 1) == 0 || textbox.value.length < 6)) {
        textbox.focus();
        return false;
    }
    else {
...
// Valid Aadhar
function ValidAadhar(textbox) {
    if (textbox.value.length > 0 && textbox.value.length < 12) {
        textbox.focus();
        return false;
    }
    else {
...
// Valid Gstn
function ValidGstn(textbox) {
    if (textbox.value.length > 0 && textbox.value.length < 15) {
        textbox.focus();
        return false;
    }
    else {
...
//Allow Numeric With Dot
function isNumericWithDot(keyCode) {
    if (keyCode == 16)
        isShift = true;

    return ((keyCode >= 48 && keyCode <= 57 || keyCode == 8 || keyCode == 46 || keyCode == 110 || keyCode == 9 || keyCode == 110 ||
