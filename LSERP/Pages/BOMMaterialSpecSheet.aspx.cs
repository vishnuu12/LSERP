    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                dsEnquiryNumber = objc.GetEnquiryNumberByUserID(Convert.ToInt32(objSession.employeeid), ddlEnquiryNumber);
    ...
    private void DeleteAllBomPart()
    {
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows[0]["msg"].ToString() == "Deleted")
                ScriptManager.RegisterStartupScript(this, this.GetType(), "DataTable", "SuccesMessage('Succes','BOM All Part Deleted successFully');", true);
            else
