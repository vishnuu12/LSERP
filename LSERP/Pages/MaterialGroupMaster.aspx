    ...
    <script type="text/javascript">
        ...
        function ValidateAdd() {
            ...
            if ($('#<%=txtMaterialGroup.ClientID %>')[0].value == "") {
                $('#<%=txtMaterialGroup.ClientID %>').notify('Field Required.', { arrowShow: true, position: 't,r', autoHide: true });
                msg = "1";
            }

            else if ($('#<%=ddlPrefix.ClientID %>')[0].value == "") {
                $('#<%=ddlPrefix.ClientID %>').notify('Field Required.', { arrowShow: true, position: 't,r', autoHide: true });
                msg = "1";
            }
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-6 text-left">
                                        <asp:TextBox ID="txtMaterialGroup" runat="server" Width="70%" CssClass="form-control"
                                            ToolTip="Enter Material Group" placeholder="Enter Material Group">
                                        </asp:TextBox>
                                    </div>
                                    <div class="col-sm-2">
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-12 p-t-10">
                                            <asp:GridView ID="gvMaterialGroup" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                ...
                                                HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvMaterialGroup_RowDataBound"
                                                OnRowCommand="gvMaterialGroup_RowCommand" DataKeyNames="MGID">
                                                <Columns>
