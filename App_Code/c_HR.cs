...
public  class c_HR
{
    ...
    public DataSet SaveEmployeeBasicInfo()
    {
        try
        {
            ...
            c.Parameters.Add("@EmployeeLocation", EmployeeLocation);
    ...
    public DataSet GetMyGroupNameDetailsByEmployeeID()
    {
        DataSet ds = new DataSet();
        try
        {
            ...
            SqlCommand c = new SqlCommand();
            c.CommandType = CommandType.StoredProcedure;
            c.CommandText = "LS_GetGroupNameDetailsByEmployeeID";
            c.Parameters.Add("@EmployeeID", EmpID);
            DAL.GetDataset(c, ref ds);
        }
        catch (Exception ex)
    ...
    public DataSet GetEmployeeDetailsByDepartmentIDs()
    {
        DataSet ds = new DataSet();
        try
        {
            ...
            SqlCommand c = new SqlCommand();
            c.CommandType = CommandType.StoredProcedure;
            c.CommandText = "LS_GetEmployeeDetailsByDepartmentIDs";
            c.Parameters.Add("@departmentids", departmentids);
            DAL.GetDataset(c, ref ds);
        }
        catch (Exception ex)
        {
    ...
    public DataSet GetEmployeeDetailsByGroupNameIDs()
    {
        DataSet ds = new DataSet();
        try
        {
            ...
            SqlCommand c = new SqlCommand();
            c.CommandType = CommandType.StoredProcedure;
            c.CommandText = "LS_GetEmployeeDetailsByGroupNameIDs";
            c.Parameters.Add("@GroupNameIds", GroupNameIds);
            DAL.GetDataset(c, ref ds);
        }
        catch (Exception ex)
        {
    ...
    public DataSet GetEmployeeList(DropDownList ddlName)
    {
        DataSet ds = new DataSet();
        try
        {
    ...
    public DataSet GetSalaryPaymentMode(DropDownList ddlSalaryPaymentMode)
    {
        DataSet ds = new DataSet();
        try
        {
