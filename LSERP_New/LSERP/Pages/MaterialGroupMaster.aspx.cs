...
public partial class Pages_MaterialGroupMaster : System.Web.UI.Page
{
        ...
        try
        {
            if (ValidateControls())
            {
                ...
                if (ds.Tables[0].Rows[0]["Message"].ToString() == "AE")
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Message", "ErrorMessage('Error','Material Group Name Already Exists');hideLoader();", true);
                ...
                else if (ds.Tables[0].Rows[0]["Message"].ToString() == "AEP")
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Message", "ErrorMessage('Error','Prefix Name Already Exists');hideLoader();", true);
    ...
    protected void btnPDFDownload_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            gvMaterialGroup.Columns[3].Visible = false;
            ...
            gvMaterialGroup.Columns[3].Visible = true;
    ...
    protected void gvMaterialGroup_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
