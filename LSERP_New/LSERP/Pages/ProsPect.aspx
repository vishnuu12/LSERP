...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function showDataTable() {
            $('#<%=gvProsPect.ClientID %>').DataTable({ 'aoColumnDefs': [{
                'bSortable': false,
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div>
                                                <asp:TextBox ID="txtEmail" runat="server" placeholder="Enter Email" CssClass="form-control"
                                                    MaxLength="300" ToolTip="Enter Email" TabIndex="3" autocomplete="nope" onkeypress="return validateEmail(this);"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="text-left">
                                ...
                                <div class="main-card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class="h-style">
                                                    <asp:Label ID="lbltitle" runat="server" Text="Prospect Details"></asp:Label></p>
                                            </div>
