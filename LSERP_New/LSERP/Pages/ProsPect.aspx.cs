        ...
        try
        {
            if (ValidateControls())
            {
                ...
                else
                {
                    ...
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "Message", "hideLoader();SuccessMessage('Success','ProsPect Name Saved successfully');", true);
                    }
                    else
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "Message", "hideLoader();SuccessMessage('Success','ProsPect Name Updated successfully');", true);
