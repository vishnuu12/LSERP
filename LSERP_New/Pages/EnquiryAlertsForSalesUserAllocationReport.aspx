<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="EnquiryAlertsForSalesUserAllocationReport.aspx.cs" Inherits="Pages_EnquiryAlertsForSalesUserAllocationReport" %>
                            ...
                            <div class="page-container" style="float: left; width: 100%">
                                <div class="main-card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-md-12 p-t-10 row">
                                            <div class="col-md-6">
                                                <p class="h-style">
                                                    <asp:Label ID="lbltitle" runat="server" Text="Sales Staff Report"></asp:Label></p>
                                            </div>
