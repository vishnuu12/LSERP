<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="MTReports.aspx.cs" Inherits="Pages_MTReports" %>
                            ...
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">
                                        Magnetic Particle Examination Report</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Magnetic Particle Examination Report</li>
                                                </ol>
                                     </nav>
                            ...
                            <div class="page-container" style="float: left; width: 100%">
                                <div class="main-card">
                                            ...
                                            <div class="col-sm-12 p-t-10 p-l-0 p-r-0">
                                                <table align="center" id="tbl_customerDetails" class="tr_class table" style="text-transform: none;">
                                                    <tbody>
                                                        <tr class="eqheading">
                                                            <td>
                                                                <div class="offerFormHeading1">
                                                                    Magnetic Particle Examination Report</div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                                <span id="Span16" class="eqdetailslabel">PO No</span>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <span id="Span20" class="eqdetailslabel">RFP No</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtRFPNo" CssClass="form-control mandatoryfield" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <span id="Span21" class="eqdetailslabel">Customer Po No</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtCustomerPONo" CssClass="form-control mandatoryfield" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <span id="Span6" class="eqdetailslabel">Lighting Equipment</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtLightEquipment" CssClass="form-control mandatoryfield" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <span id="Span24" class="eqdetailslabel">Light Intensity Method</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtLightIntensityMethod" CssClass="form-control" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                                <span id="Span10" class="eqdetailslabel">Magnetic Particle</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtMagneticParticle" CssClass="form-control mandatoryfield" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <span id="Span11" class="eqdetailslabel">Brand Name And Color</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtBrandNameAndColor" CssClass="form-control" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                                <span id="Span22" class="eqdetailslabel">Temprature of the Part</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtTempratureOfThePart" CssClass="form-control mandatoryfield" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <span id="Span23" class="eqdetailslabel">Brand Name And Color</span>
                                                            </td>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <span id="Span25" class="eqdetailslabel">Current Used</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtCurrentUsed" CssClass="form-control" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                                <span id="Span26" class="eqdetailslabel">Test Sensitivity</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtTestSensitivity" CssClass="form-control" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td align="left">
                                                                <span id="Span27" class="eqdetailslabel">Acceptance Standard</span>
                                                            </td>
                                                            <td align="left">
                                                            ...
                                                            <td>
                                                                <div id="divLPIReport" runat="server">
                                                                    <div id="Div1" class="col-sm-12 p-t-10" runat="server">
                                                                        <asp:GridView ID="gvMTRdetails" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                                            CssClass="table table-hover table-bordered medium" EmptyDataText="No Records Found"
                                                                            DataKeyNames="MPERID,MPERDID">
                                                                            <Columns>
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <span id="Span17" class="eqdetailslabel">Recording Of Indication</span>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtRecordingOfIndicatiomn" CssClass="form-control" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr class="eqheading">
                                                            <td>
                                    ...
                                    <div id="divOutPut" class="col-sm-12 p-t-10" style="overflow-x: scroll;" runat="server">
                                        <asp:GridView ID="gvMTReportHeader" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                ...
                                                <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnAdd" runat="server" CommandArgument='<%#((GridViewRow) Container).RowIndex %>'
                                                            OnClientClick='<%# string.Format("return deleteConfirm({0});",Eval("MPERID")) %>'>
                                        ...
                                        <asp:HiddenField ID="hdnMPERID" runat="server" Value="0" />
