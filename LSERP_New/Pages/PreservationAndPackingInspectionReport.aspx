<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="PreservationAndPackingInspectionReport.aspx.cs" Inherits="Pages_PreservationAndPackingInspectionReport" %>
                            ...
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">
                                        Preservation And Inspection Packing Report</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Preservation And Inspection Packing Report</li>
                                                </ol>
                                     </nav>
                            ...
                            <div class="main-card">
                                <div id="divInput" runat="server">
                                                    ...
                                                    <tr class="eqheading">
                                                        <td>
                                                            <div class="offerFormHeading1">
                                                                Prservation And Packing Inspection Report
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <span id="Span1" class="eqdetailslabel">Item Name</span>
                                                        </td>
                                                        <td align="left">
                                        ...
                                        <asp:GridView ID="gvItemDetails" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="QTY" ItemStyle-HorizontalAlign="left" HeaderStyle-Width="105px"
                                                    HeaderStyle-HorizontalAlign="left">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtQTY" runat="server" CssClass="form-control" Text='<%# Eval("QTY")%>'></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                    ...
                                    <div class="col-sm-12 text-center">
                                        ...
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="txtobserved" runat="server" CssClass="form-control mandatoryfield"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="col-sm-12 text-center p-t-10">
                                        ...
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="txtPacking" runat="server" TextMode="MultiLine" CssClass="form-control mandatoryfield"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-2 text-left">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 text-center p-t-10">
                                        ...
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="txtMarking" runat="server" CssClass="form-control mandatoryfield"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-2 text-left">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 text-center p-t-10">
                                        <asp:LinkButton ID="btnSavePPIR" runat="server" CssClass="btn btn-cons btn-save AlignTop"
                                            Text="Save" OnClientClick="return Validate();" OnClick="btnSavePPIR_Click">
                                        </asp:LinkButton>
                                    </div>
                                </div>
                                <div id="divOutPut" class="col-sm-12 p-t-10" style="overflow-x: scroll;" runat="server">
                                    <asp:GridView ID="gvPPReportHeader" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                        EmptyDataText="No Records Found" CssClass="table table-hover table-bordered medium"
                                        DataKeyNames="PPIRID">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnAdd" runat="server" CommandArgument='<%#((GridViewRow) Container).RowIndex %>'
                                                        OnClientClick='<%# string.Format("return deleteConfirm({0});",Eval("PPIRID")) %>'>
                                    ...
                                    <asp:HiddenField ID="hdnPPIRID" runat="server" Value="0" />
