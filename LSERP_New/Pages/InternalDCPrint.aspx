<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true" CodeFile="InternalDCPrint.aspx.cs" Inherits="Pages_InternalDCPrint" ClientIDMode="Predictable" %>
                    ...
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="active breadcrumb-item" aria-current="page">Internal DC Print</li>
                            </ol>
                        </nav>
        ...
        <div>
            <asp:UpdatePanel ID="upDocumenttype" runat="server">
                ...
                <ContentTemplate>
                        ...
                        <div id="divInput" runat="server">
                            <div class="ip-div text-center">
                                ...
                                <div id="divInternalDC_p" runat="server">
                                    <div class="col-sm-12 text-center" style="background-color: #b0acac; padding-top: 5px; padding-bottom: 5px;">
                                        <asp:Label Style="color: Black; font-weight: bolder; font-size: large ! important;" ID="lblheading_p"
                                            runat="server" Text=" BELLOWS DIVISION DELIVERY CHALLAN">
                                        </asp:Label>
                                    </div>
                                    ...
                                    <div>
                                        <div class="col-sm-12 p-t-10" style="overflow-x: auto; white-space: nowrap;">
                                            <asp:GridView ID="gvItemDescriptionDetails_p" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Item Description" ItemStyle-HorizontalAlign="left"
                                                        HeaderStyle-Width="450px" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblItemDescription" runat="server" Text='<%# Eval("ItemDescription")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Quantity" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10px"
                                                        HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                    ...
                    <asp:HiddenField ID="hdnIDCID" runat="server" />
