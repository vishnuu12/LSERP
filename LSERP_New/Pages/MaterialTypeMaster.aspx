<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="MaterialTypeMaster.aspx.cs" Inherits="Pages_MaterialTypeMaster" ClientIDMode="Predictable" %>
                    ...
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Material Type</li>
                                                </ol>
                                     </nav>
                        ...
                        <div class="ip-div text-center">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6 text-left">
                                    <asp:TextBox ID="txtMaterialType" runat="server" Width="70%" CssClass="form-control mandatoryfield"
                            ...
                            <div class="col-sm-12 p-t-10">
                                ...
                                <div class="col-sm-6 text-left">
                                    <asp:TextBox runat="server" ID="txtDescription" CssClass="form-control mandatoryfield"
                                        Width="70%" ToolTip="Enter Description" placeholder="Enter Description" TextMode="MultiLine" />
                                </div>
                                <div class="col-sm-2">
                                </div>
                            </div>
                            <div class="col-sm-12 p-t-20">
                                <div class="col-sm-4 text-right">
                                    <label class="form-label">
                                        Material Type Fields</label>
                                </div>
                                <div class="col-sm-8 p-l-0">
                                    <asp:CheckBoxList ID="chkMTFields" Style="margin-right: 20px; margin-left: 20px;"
                                    ...
                                    <div class="col-sm-12 p-t-10">
                                        <asp:GridView ID="gvMaterial" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Material Type Specs">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblMTFields" runat="server" Text='<%# Eval("MTFields")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
