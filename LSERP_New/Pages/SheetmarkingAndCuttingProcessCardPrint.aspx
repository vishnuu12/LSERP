<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="SheetmarkingAndCuttingProcessCardPrint.aspx.cs" Inherits="Pages_SheetmarkingAndCuttingProcessCardPrint" ClientIDMode="Predictable" %>
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Sheet Marking And Cutting Print</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="active breadcrumb-item" aria-current="page">Sheet Marking And Cutting Print</li>
                            </ol>
                        </nav>
                ...
                <ContentTemplate>
                    <div class="card-container">
                        <div class="col-sm-12 p-b-10 text-center">
                            <asp:LinkButton ID="btnprint" runat="server" CssClass="btn btn-cons btn-success" Text="GET JOB CARD PRINT" OnClick="btnprint_Click">
                            </asp:LinkButton>
                        </div>
                        <div id="divSheetMarkingAndCuttingPDF" class="p-t-10" runat="server" style="display: block;">
                            <div id="div13" class="FrontPagepopupcontent" runat="server">
                                ...
                                <div>
                                    ...
                                    <div id="divcontractor" style="display: none;" runat="server">
                                        <div class="row">
                                            <div class="col-sm-4 text-left">
                                                <label style="color: black;">
                                ...
                                <div class="row">
                                    <div class="col-sm-6" style="overflow-wrap: break-word;">
                                        ...
                                        <div class="sideheading">
                                            ...
                                            <asp:Label ID="lblQCCompletionDate_SMC_P" CssClass="lbl_v" runat="server"></asp:Label>
                                        </div>
                                ...
                                <div class="col-sm-12 p-t-10" runat="server" visible="false">
                                    <asp:GridView ID="gvTypeOfCheck_SMC_P" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                        EmptyDataText="No Records Found"
                                        CssClass="table table-hover table-bordered medium">
                                        <Columns>
                                            <asp:TemplateField HeaderText="S.No" HeaderStyle-Width="5%" ItemStyle-Width="5%" HeaderStyle-CssClass="text-center"
