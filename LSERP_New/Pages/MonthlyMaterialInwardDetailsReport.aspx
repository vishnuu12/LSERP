<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master"
    AutoEventWireup="true" CodeFile="MonthlyMaterialInwardDetailsReport.aspx.cs" Inherits="Pages_MonthlyMaterialInwardDetailsReport" %>
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Monthly Stock Material Inward Report Details </h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Monthly Stock Material Inward Report Details</li>
                                                </ol>
                                     </nav>
                                ...
                                <div class="main-card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-12" style="overflow-x: scroll;">
                                            <asp:GridView ID="gvMonthlyMaterialInwardReportDetails" runat="server" CssClass="table table-bordered table-hover no-more-tables"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Stock Inward On" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="54px"
                                                        HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Stock QTY" ItemStyle-HorizontalAlign="Left"
                                                        HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
