<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="DesignSummarySheet.aspx.cs" Inherits="Pages_DesignSummarySheet" ClientIDMode="Predictable" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function BindDate() {
            ...
            $('#tblDesignSummaryReport').DataTable({
                ...
                "ajax": ({
                    type: "GET",
                    url: "DesignSummarySheet.aspx/GetData", //It calls our web method  
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Design Summary Report </h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Design Summary Report</li>
                                                </ol>
                                     </nav>
