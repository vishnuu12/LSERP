    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (ValidateControls())
            {
                ...
                objMat.FieldType = rblFieldType.SelectedValue;
                ...
                if (ds.Tables[0].Rows[0]["Message"].ToString() == "Added")
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Save", "InfoMessage('Information','Specs Name Already Exists');hideLoader();", true);
