<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true" CodeFile="BellowFormingAndTangentCuttingPrint.aspx.cs"
    Inherits="Pages_BellowFormingAndTangentCuttingPrint" ClientIDMode="Predictable" %>
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Bellow Formimg And Tangent Cutting Print</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="active breadcrumb-item" aria-current="page">BFTC Print</li>
                            </ol>
                        </nav>
            ...
            <asp:UpdatePanel ID="upDocumenttype" runat="server">
                ...
                <ContentTemplate>
                    <div class="card-container">
                        ...
                        <div id="divBellowFormingAndTangentCuttingPDF" runat="server" style="display: block;">
                            <div id="BFTC" class="FrontPagepopupcontent" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-sm-6" style="overflow-wrap: break-word;">
                                        ...
                                        <div class="sideheading">
                                            ...
                                            <asp:Label ID="lblFormingMethod_BFTC_P" CssClass="lbl_v" runat="server"></asp:Label>
                                        </div>
                                        <div class="sideheading">
                                            <label style="color: black;" class="lbl_h">
                                                Target Date
                                        ...
                                        <div class="sideheading">
                                            ...
                                            <asp:Label ID="lblQCCompletionDate_BFTC_P" CssClass="lbl_v" runat="server"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="col-sm-12 p-t-10" runat="server" visible="false">
                                    <asp:GridView ID="gvTypeOfCheck_BFTC_P" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                        EmptyDataText="No Records Found"
                                        CssClass="table table-hover table-bordered medium">
                                        <Columns>
                                            <asp:TemplateField HeaderText="S.No" HeaderStyle-Width="5%" ItemStyle-Width="5%" HeaderStyle-CssClass="text-center"
