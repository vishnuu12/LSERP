...
public partial class Pages_QualityHeadStoresAndPurchaseMaterialRejectedByQualityWithReason : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetEnquiryClarrificationForMarketingAndDesign("LS_GetStoresAndPurchaseMaterialRejectedByQualityWithReason");
