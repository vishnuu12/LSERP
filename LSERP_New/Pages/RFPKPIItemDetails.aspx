<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true" CodeFile="RFPKPIItemDetails.aspx.cs"
    Inherits="Pages_RFPKPIItemDetails" ClientIDMode="Predictable" %>
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">RFP KPI Item Details </h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="active breadcrumb-item" aria-current="page">RFP KPI Item Details </li>
                            </ol>
                        </nav>
                                    ...
                                    <div class="col-sm-12 p-t-10" style="overflow-x: scroll;">
                                        <asp:GridView ID="gvRFPItemDetails" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Item Status" ItemStyle-CssClass="text-center"
