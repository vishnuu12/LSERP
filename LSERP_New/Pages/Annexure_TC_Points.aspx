...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function deleteConfirm(TACPID) {
            swal({
                title: "Are you sure?",
                text: "If Yes, the TAC Point will be deleted permanently",
                type: "warning",
                ...
                //showLoader();
                __doPostBack('deletegvrow', TACPID);
            });
            return false;
        }

        function showDataTable() {
            $('#<%=gvAnnexure.ClientID %>').DataTable({
                'aoColumnDefs': [{
                    'bSortable': false,
        ...
        function ClearFields() {
            ...
            document.getElementById('<%=hdnTACPID.ClientID %>').value = "0";
        ...
        function ValidateAdd() {
            ...
            if (document.getElementById('<%=ddlTAC.ClientID %>').selectedIndex == 0) {
                $('#<%=ddlTAC.ClientID %>').notify('Field Required.', { arrowShow: true, position: 'r,r', autoHide: true });
                msg = "1";
            }
                    ...
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Annexure_TAC_points</li>
                                                </ol>
                                     </nav>
                    ...
                    <div class="card-container">
                        <div id="divAdd" runat="server">
                            <div class="ip-div text-center">
                                <asp:LinkButton ID="btnAddNew" runat="server" Text="Add TAC Point" OnClientClick="return ShowInputSection();"
                        ...
                        <div id="divInput" runat="server">
                            <div class="ip-div text-center">
                                <div class="col-sm-12 p-t-10">
                                    ...
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtPoint" runat="server" CssClass="form-control" ToolTip="Enter TAC Point"
                                            placeholder="Enter TAC Point" MaxLength="2000"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-2">
                                    </div>
                                </div>
                                <div class="col-sm-12 p-t-10">
                                    ...
                                    <div class="col-sm-6">
                                        <asp:DropDownList ID="ddlTAC" runat="server" CssClass="form-control">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-sm-2">
                                    </div>
                                ...
                                <div class="main-card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class="h-style">
                                                    <asp:Label ID="lbltitle" runat="server" Text=" TAC Points"></asp:Label></p>
                                            </div>
                                        ...
                                        <div class="col-sm-12 p-t-10 p-l-0 p-r-0">
                                            <asp:GridView ID="gvAnnexure" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                ...
                                                HeaderStyle-HorizontalAlign="Center" EmptyDataText="No Records Found" DataKeyNames="TACPID">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField SortExpression="TAC Point" HeaderText="TAC Points" ItemStyle-Width="25%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblPoint" runat="server" Text='<%# Eval("Point")%>' Style="text-align: center"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField SortExpression="TAC Header" HeaderText="TAC Header" ItemStyle-Width="25%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblTACHeader" runat="server" Text='<%# Eval("HeaderName")%>' Style="text-align: center"></asp:Label>
                                                    ...
                                                    <asp:TemplateField HeaderText="Delete" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center"
                                                        HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtnDelete" runat="server" Style="text-align: center" OnClientClick='<%# string.Format("return deleteConfirm({0});",Eval("TACPID")) %>'>
                                                            <img src="../Assets/images/del-ec.png" alt=""/></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                            <asp:HiddenField ID="hdnTACPID" runat="server" Value="0" />
                                        </div>
                                    </div>
                                </div>
                            </div>
