...
public partial class Pages_DesignHeadAlertForDrawingRevisedDetails : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    protected void gvEnquiryProjectAssignmentReport_DataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (string.IsNullOrEmpty(dr["Approved Revision"].ToString()))
                {
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetReceivedPOFromCustomerToRFPReleaseDate("LS_GetSalesItemRevisedDetails");
