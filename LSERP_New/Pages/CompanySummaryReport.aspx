<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master"
    AutoEventWireup="true" CodeFile="CompanySummaryReport.aspx.cs"
    Inherits="Pages_CompanySummaryReport" ClientIDMode="Predictable" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function BindDate() {
            ...
            $('#tblCompanySummaryReport').DataTable({
                ...
                "ajax": ({
                    type: "GET",
                    url: "CompanySummaryReport.aspx/GetData", //It calls our web method  
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Company Summary Report </h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Company Summary Report</li>
                                                </ol>
                                     </nav>
