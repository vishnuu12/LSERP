                        ...
                        <div id="divInput" runat="server">
                            <div class="ip-div text-center">
                                <div class="col-sm-12 p-t-10">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:TextBox ID="txtSpecsName" runat="server" CssClass="form-control" ToolTip="Enter Material Specs Name"
                                            AutoComplete="off" placeholder="Enter Material Specs Name"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-4">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:RadioButtonList ID="rblFieldType" runat="server" CssClass="radio radio-success"
                                            RepeatDirection="Horizontal">
                                            <asp:ListItem Text="Input Field" Value="I" Selected="True"></asp:ListItem>
                                            <asp:ListItem Text="Formula Field" Value="F"></asp:ListItem>
                                        </asp:RadioButtonList>
                                    </div>
                                    <div class="col-sm-4">
                                    </div>
                                        ...
                                        <div class="col-sm-12 p-t-10 p-l-0 p-r-0">
                                            <asp:GridView ID="gvMaterialSpecsDetails" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Field Type" ItemStyle-CssClass="text-center" ItemStyle-Width="35%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblFieldType" runat="server" Text='<%# Eval("FieldType")%>' Font-Bold="false"
                                                                Font-Italic="false" Style="font-family: Arial; font-size: 12px; text-align: center"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
