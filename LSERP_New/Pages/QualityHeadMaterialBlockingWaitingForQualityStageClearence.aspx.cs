...
public partial class Pages_QualityHeadMaterialBlockingWaitingForQualityStageClearence : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetEnquiryClarrificationForMarketingAndDesign("LS_MaterialBlockingWaitingForQualityStageClearence");
