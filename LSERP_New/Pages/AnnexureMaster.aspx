<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="AnnexureMaster.aspx.cs" EnableEventValidation="false" Inherits="AnnexureMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function ClearFields() {
            $('#<%=txtAnnexureName.ClientID %>')[0].value = "";

            document.getElementById('<%=hdnAMID.ClientID %>').value = "0";
        ...
        function ValidateAdd() {
            ...
            if ($('#<%=txtAnnexureName.ClientID %>')[0].value == "") {
                $('#<%=txtAnnexureName.ClientID %>').notify('Field Required.', { arrowShow: true, position: 't,r', autoHide: true });
                msg = "1";
            }
                    ...
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Annexure Master</li>
                                                </ol>
                                     </nav>
                    ...
                    <div class="card-container">
                        <div id="divAdd" runat="server">
                            <div class="ip-div text-center">
                                <asp:LinkButton ID="btnAddNew" runat="server" Text="Add New Annexure"
                                    OnClientClick="return ShowInputSection();" CssClass="btn ic-w-btn add-btn"></asp:LinkButton>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-12 p-t-10">
                                    <div class="col-sm-4">
                                        <label class="form-label">
                                            Annexure Header / Title
                                        </label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtAnnexureName" runat="server" CssClass="form-control" ToolTip="Enter Annexure Name/Title"
                                            placeholder="Enter Annexure Name/Title" MaxLength="100"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-2">
                                    </div>
                                </div>
                                ...
                                <div class="main-card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class="h-style">
                                                    <asp:Label ID="lbltitle" runat="server" Text=" Annexure Name/Title"></asp:Label></p>
                                            </div>
                                        ...
                                        <div class="col-sm-12 p-t-10 p-l-0 p-r-0">
                                            <asp:GridView ID="gvAnnexure" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                ...
                                                HeaderStyle-HorizontalAlign="Center" EmptyDataText="No Records Found" DataKeyNames="AMID">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField SortExpression="Annexure Name" HeaderText="Annexure Name / Title"
                                                        ItemStyle-Width="25%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblAnnexure" runat="server" Text='<%# Eval("AnnexureName")%>' Style="text-align: center"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Delete" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center"
                                                        HeaderStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtnDelete" runat="server" Style="text-align: center" OnClientClick='<%# string.Format("return deleteConfirm({0});",Eval("AMID")) %>'>
                                                            <img src="../Assets/images/del-ec.png" alt=""/></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                            <asp:HiddenField ID="hdnAMID" runat="server" Value="0" />
                                        </div>
                                    </div>
                                </div>
                            </div>
