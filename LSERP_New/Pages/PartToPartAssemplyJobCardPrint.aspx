<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="PartToPartAssemplyJobCardPrint.aspx.cs" Inherits="Pages_PartToPartAssemplyJobCardPrint" ClientIDMode="Predictable" %>
                    ...
                    <div class="card-container">
                        ...
                        <div id="divFabricationAndWeldingPDF" runat="server" style="display: block;">
                            <div id="d1" class="FrontPagepopupcontent" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-sm-6" style="overflow-wrap: break-word;">
                                        ...
                                        <div class="sideheading">
                                            ...
                                            <asp:Label ID="lblMRNNo_FW_P" CssClass="lbl_v" runat="server"></asp:Label>
                                        </div>
                                ...
                                <div class="col-sm-12 text-center p-t-10" style="display: none;">
                                    <label style="color: Black;">
                                        BOUGHT OUT ITEM ISSUE DETAILS
                                    </label>
                                </div>
                                <div class="col-sm-12 p-t-10 text-left" style="display: none;">
