<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master"
    AutoEventWireup="true" CodeFile="POApproval.aspx.cs" Inherits="Pages_POApproval" ClientIDMode="Predictable" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function ShowDatatable() {
            $('#ContentPlaceHolder1_gvPOApprovedDetails').DataTable({
                "retrieve": true,
                "pageLength": 50,
            });
        }
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Purchase Order Approval</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <ContentTemplate>
                    <div class="card-container">
                        ...
                        <div id="divInput" runat="server">
                            <div class="col-sm-12">
                                <label>Purhcase Order Approved Details  </label>
                            </div>
                            <div class="col-sm-12 p-t-10">
                                <table id="tblSPOPriceDetails" class="table table-hover table-bordered medium">
                                    <tr>
                                        <th>Last Month Value</th>
                                        <th>Current Month Value</th>
                                    </tr>
                                    <tr>
                                        <td rowspan="3">
                                            <asp:Label ID="lblPOApprovedLMV" runat="server"> </asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblPOApprovedCMV" runat="server"> </asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblPOpendingCMV" runat="server"> </asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblTotalAmtCMV" runat="server"> </asp:Label></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                            ...
                            <div class="page-container" style="float: left; width: 100%">
                                <div class="main-card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-12 p-t-10" style="overflow-x: scroll;">
                                            <asp:GridView ID="gvSupplierPODetails" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="L1 Approved By" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="level2ApprovedBy" runat="server" Text='<%# Eval("Level3ApprovedBy")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="L1 Approved On" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="level2ApprovedOn" runat="server" Text='<%# Eval("POLevel3ApprovedDate")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="L2 Approved By" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="level1ApprovedBy" runat="server" Text='<%# Eval("Level2ApprovedBy")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="L2 Approved On" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="level1ApprovedOn" runat="server" Text='<%# Eval("POLevel2ApprovedDate")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="PDF">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtnPDF" runat="server" ToolTip='<%# Eval("AmendmentReason")%>' CommandArgument='<%#((GridViewRow) Container).RowIndex %>'
                                                                OnClientClick='<%# string.Format("return PrintPurchaseOrder({0});",Eval("SPOID")) %>'>
                                        ...
                                        <%--POValue	ApprovedDate	ApprovedBy	EmpName	ApprovedDateorder--%>

                                        <div class="col-sm-12 p-t-10">
                                            <asp:GridView ID="gvPOApprovedDetails" runat="server" AutoGenerateColumns="False"
                                                ShowHeaderWhenEmpty="True" EmptyDataText="No Records Found"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="SPO Number" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblSPONumber" runat="server" Text='<%# Eval("PONo")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Approved Date" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblApprovedDate" runat="server" Text='<%# Eval("ApprovedDate")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Approved By" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblApprovedBy" runat="server" Text='<%# Eval("ApprovedBy")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="PO Value With Tax" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                                                        <ItemTemplate>
