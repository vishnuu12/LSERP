...
public partial class Pages_FabricationAndWelding : System.Web.UI.Page
{
    #region"Declaretion"
    ...
    private void JobCardPrintDetails()
    {
        ...
        try
        {
            ...
            lblProcessName_FW_P_H.Text = ds.Tables[0].Rows[0]["RFPNo"].ToString() + " / " + ds.Tables[1].Rows[0]["PartName"].ToString() + " / " + ds.Tables[0].Rows[0]["ProcessName"].ToString();
