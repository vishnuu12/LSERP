<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="GeneralWorkOrderIndentApproval.aspx.cs" Inherits="Pages_GeneralWorkOrderIndentApproval" ClientIDMode="Predictable" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            var table = $('#ContentPlaceHolder1_gvGeneralWorkOrderIndent').DataTable(); $("#ContentPlaceHolder1_gvGeneralWorkOrderIndent tfoot th").each(function (i) {
                var select = $('<select><option value=""></option></select>').appendTo($(this).empty()).on('change', function () {
                    var val = $(this).val(); table.column(i).search(val ? '^' + $(this).val() + '$' : val, true, false).draw();
        ...
        function ValidateAll() {
            var checked = $('#ContentPlaceHolder1_gvGeneralWorkOrderIndent').find('input:checked').not('#ContentPlaceHolder1_gvGeneralWorkOrderIndent_chkall').length;
            if (checked > 0) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">General Work Order Indent Approval</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">Indent Approval</li>
                                                </ol>
                                     </nav>
     ...
     <div>
            <asp:UpdatePanel ID="upDocumenttype" runat="server">
                <Triggers>
                    <asp:PostBackTrigger ControlID="gvGeneralWorkOrderIndent" />
                </Triggers>
                <ContentTemplate>
                    <div class="card-container">
                        ...
                        <div id="divInput" runat="server">
                            <div class="text-center">
                                <asp:LinkButton ID="btnAddNew" runat="server" Text="Pending Records" OnClick="btnPending_Click"
                                    CausesValidation="false" Style="background-color:#FF5733;border-color:azure" CssClass="btn btn-success"></asp:LinkButton>
                                <asp:LinkButton ID="LinkButton1" runat="server" Text="Approved Records" OnClick="btnApproved_Click"
                                    CausesValidation="false" Style="background-color:#50C878;border-color:azure" CssClass="btn btn-success"></asp:LinkButton>
                                ...
                                <div class="main-card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-12 p-t-10" style="overflow-x:auto;">
                                            ...
                                            <asp:GridView ID="gvGeneralWorkOrderIndent" runat="server" AutoGenerateColumns="False" OnRowCommand="gvGeneralWorkOrderIndent_OnRowCommand"
                                                ShowHeaderWhenEmpty="True" EmptyDataText="No Records Found"  OnRowDataBound="gvGeneralWorkOrderIndent_OnRowDataBound"
