<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true" CodeFile="OTHERDC.aspx.cs"
    Inherits="Pages_OTHERDC" ClientIDMode="Predictable" %>
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">OTHER DC</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="active breadcrumb-item" aria-current="page">OTHER DC</li>
                            </ol>
                        </nav>
                            ...
                            <div class="ip-div text-center">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-6 text-left">
                                        <asp:DropDownList ID="ddlFromUnit" runat="server" ToolTip="Select From Unit Name"
                                ...
                                <div class="col-sm-12 p-t-10">
                                    ...
                                    <div class="col-sm-6 text-left">
                                        <asp:TextBox ID="txttounitName" runat="server" CssClass="form-control mandatoryfield"
                                            ToolTip="Enter To Unit Name" placeholder="Enter To Unit Name">
                                        </asp:TextBox>
                                    </div>
                                    <div class="col-sm-2">
                                    </div>
                                ...
                                <div class="col-sm-12 p-t-10">
                                    ...
                                    <div class="col-sm-6 text-left">
                                        <asp:TextBox ID="txtTounitAddress" TextMode="MultiLine" Rows="3" runat="server" CssClass="form-control mandatoryfield"
                                            ToolTip="Enter To Address" placeholder="Enter DC Number">
                                        </asp:TextBox>
                                    </div>
                                    <div class="col-sm-2">
                                    </div>
                                ...
                                <div class="col-sm-12 p-t-10">
                                    ...
                                    <div class="col-sm-6 text-left">
                                        <asp:TextBox ID="txtexpectedDuration" runat="server" CssClass="form-control mandatoryfield"
                                ...
                                <div class="col-sm-12 p-t-10">
                                    ...
                                    <div class="col-sm-6 text-left">
                                        <asp:TextBox ID="txtRemarks" TextMode="MultiLine" Rows="3" runat="server" CssClass="form-control mandatoryfield"
                                ...
                                <div class="main-card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-12 p-t-10" style="overflow-x: scroll;">
                                            <asp:GridView ID="gvOTHERDC" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                EmptyDataText="No Records Found" CssClass="table table-hover table-bordered medium"
                                                OnRowCommand="gvOTHERDC_OnrowCommand" OnRowDataBound="gvOTHERDC_OnRowDataBound"
                                                DataKeyNames="OTHID">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="DC No" ItemStyle-HorizontalAlign="left"
                                                        HeaderStyle-HorizontalAlign="left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDCNo" runat="server" Text='<%# Eval("DCNo")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="To Address" ItemStyle-HorizontalAlign="left"
                                                        HeaderStyle-HorizontalAlign="left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblToAddress" runat="server" Text='<%# Eval("ToUNitAddress")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Add" ItemStyle-HorizontalAlign="left" HeaderStyle-Width="105px"
                                                        HeaderStyle-HorizontalAlign="left">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnAddotherDC" runat="server" Text="Add DC" ToolTip="Add DC" CommandName="AddOtherDC"
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnEdit" runat="server" Text="Edit"
                                                                ...
                                                                CommandName="EditOtherDC"><img src="../Assets/images/edit-ec.png" /></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="PDF" ItemStyle-HorizontalAlign="left"
                                                        HeaderStyle-HorizontalAlign="left">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnPrint" runat="server" Text="Add DC" CommandName="InternalDCPDF"
                                                                ToolTip="Print" OnClientClick='<%# string.Format("return PrintDC({0});",Eval("OTHID")) %>'> <img src="../Assets/images/pdf.png" /></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="left"
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtnDelete" runat="server"
                                                                OnClientClick='<%# string.Format("return deleteInternalDC({0});",Eval("OTHID")) %>'>
                                                            <img src="../Assets/images/del-ec.png" alt=""/></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                            <asp:HiddenField ID="hdnOTHID" runat="server" Value="0" />
                                            <asp:HiddenField ID="hdnOTDID" runat="server" Value="0" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="docdiv" class="docdiv">
                                <div class="inner-container" style="text-transform: uppercase;">
                                    <div id="divDCIssuedDetails" runat="server" visible="true">
                                        ...
                                        <div class="col-sm-12 text-center p-t-10">
                                            <asp:Button ID="btnotherdcDetails" Text="Save" CssClass="btn btn-cons btn-success"
                                                OnClientClick="return Mandatorycheck('ContentPlaceHolder1_divDCIssuedDetails');"
                                                OnClick="btnotherdcDetails_Click" runat="server" />
                                        </div>

                                        <div class="col-sm-12 p-t-10" style="overflow-x: scroll;">
                                            <asp:GridView ID="gvOTHERDCDetails" runat="server" AutoGenerateColumns="False"
                                                ShowHeaderWhenEmpty="True" EmptyDataText="No Records Found"
                                                CssClass="table table-hover table-bordered medium"
                                                OnRowCommand="gvOTHERDCDetails_OnRowCommand"
                                                DataKeyNames="OTDID">
                                                <Columns>
