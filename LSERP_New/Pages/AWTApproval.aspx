<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="AWTApproval.aspx.cs" Inherits="Pages_AWTApproval" ClientIDMode="Predictable" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function ValidateApproval(flag) {
            ...
            var Checked = $('#ContentPlaceHolder1_gvAWTApproval').find('input:checked').length;
            if (Checked > 0) {
                if (flag == 'A') {
                    return true;
                }
                ...
                ErrorMessage('Error', 'Please Select Part Name');
                return false;
            }
        }
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">AWT Approval</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">AWT Approval</li>
                                                </ol>
                                     </nav>
                                ...
                                <div class="main-card">
                                    <div class="card-body">
                                        <div class="col-sm-12 p-t-10" style="overflow-x: scroll;" id="divMandatoryCheck">
                                            <asp:GridView ID="gvAWTApproval" runat="server" AutoGenerateColumns="False"
                                                ShowHeaderWhenEmpty="True" EmptyDataText="No Records Found" CssClass="table table-hover table-bordered medium"
                                                HeaderStyle-HorizontalAlign="Center" DataKeyNames="PRDID">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Bom AWT Unit Weight" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblBomWeight" runat="server" Text='<%# Eval("DesignAWT")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Production Unit Weight" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblProductionWeight" runat="server" Text='<%# Eval("AWT")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
