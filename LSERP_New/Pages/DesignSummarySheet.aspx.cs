...
public partial class Pages_DesignSummarySheet : System.Web.UI.Page
{
    #region"Declaration"
    ...
    public static object GetData()
    {
        ...
        string Jsonstring;
        string sessionname = "DesignSummaryReport";
        ...
        try
        {
            ...
            if (HttpContext.Current.Session["DesignSummaryReport"] == null)
            {
                dataList = LoadData();
                HttpContext.Current.Session["DesignSummaryReport"] = dataList;
            }
            else
                dataList = (List<Dictionary<string, object>>)HttpContext.Current.Session["DesignSummaryReport"];
              ...
              !string.IsNullOrWhiteSpace(search))
            {
                ...
                dataList = dataList.Where(p =>
                          ...
                          || p["BomApproved"].ToString().ToLower().Contains(search.ToLower())
                          || p["RFPStatus"].ToString().ToLower().Contains(search.ToLower())
                          ).ToList();
            }
    ...
    private static List<Dictionary<string, object>> LoadData()
    {
        ...
        try
        {
            ds = objR.GetDesignSummaryReportDetails();
