<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="ExcelIntoDataTable.aspx.cs" Inherits="Pages_ExcelIntoDataTable" %>
                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <h3 class="page-title-head d-inline-block">Drawing Bill Of Material</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-container">
                        <div id="divAdd" runat="server" visible="false">
                            <div class="ip-div text-center">
                                <div class="col-sm-12">
                                    <asp:FileUpload ID="fpexcel" CssClass="form-control" runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
