<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="CustomerType.aspx.cs" Inherits="Pages_CustomerType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function deleteConfirm(CustomerTypeId) {
            swal({
                title: "Are you sure?",
                text: "If Yes, the Customer Type will be deleted permanently",
                type: "warning",
                ...
                //showLoader();
                __doPostBack('deletegvrow', CustomerTypeId);
            });
            return false;
        }

        function showDataTable() {
            $('#<%=gvCustomerType.ClientID %>').DataTable({ 'aoColumnDefs': [{
                'bSortable': false,
        ...
        function ValidateAdd() {
            ...
            if ($('#<%=txtCustomerType.ClientID %>')[0].value == "") {
                $('#<%=txtCustomerType.ClientID %>').notify('Field Required.', { arrowShow: true, position: 't,r', autoHide: true });
                msg = "1";
            }
        ...
        function ClearFields() {
            $('#<%=txtCustomerType.ClientID %>')[0].value = "";
                    ...
                    <div class="page-title-right">
                        <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">CustomerType</li>
                                                </ol>
                                     </nav>
            ...
            <asp:UpdatePanel ID="upDocumenttype" runat="server">
                ...
                <ContentTemplate>
                    <div class="card-container">
                        <div id="divAdd" class="text-center" runat="server">
                            <asp:LinkButton ID="btnAddNew" runat="server" Text="Add New" OnClientClick="return ShowInputSection();"
                            ...
                            <div class="ip-div text-center">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-6 text-left">
                                        <asp:TextBox ID="txtCustomerType" runat="server" Width="70%" CssClass="form-control"
                                            ToolTip="Enter Customer Type" placeholder="Enter Customer Type">
                                        </asp:TextBox>
                                    </div>
                                    <div class="col-sm-2">
                                    </div>
                            ...
                            <div class="page-container" style="float: left; width: 100%">
                                <div class="main-card">
                                    <div class="card-body">
                                        <div class="">
                                            <p class="h-style">
                                                <asp:Label ID="lbltitle" runat="server" Text="Customer Type Details"></asp:Label></p>
                                            <div class="f-right">
                                            </div>
                                            <div class="clear">
                                            </div>
                                        ...
                                        <div class="col-sm-12 p-t-10">
                                            <asp:GridView ID="gvCustomerType" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                                                EmptyDataText="No Records Found" CssClass="table table-hover table-bordered medium"
                                                HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvCustomerType_RowDataBound"
                                                OnRowCommand="gvCustomerType_RowCommand" DataKeyNames="CustomerTypeId">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Customer Type">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCustomerType" runat="server" Text='<%# Eval("TypeName")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtnEdit" runat="server" CommandArgument='<%#((GridViewRow) Container).RowIndex %>'
                                                                CommandName="EditCustomerType">
                                                           <img src="../Assets/images/edit-ec.png" alt="" /></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Delete">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtnDelete" runat="server" OnClientClick='<%# string.Format("return deleteConfirm({0});",Eval("CustomerTypeId")) %>'>
                                                            <img src="../Assets/images/del-ec.png" alt=""/></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                            <asp:HiddenField ID="hdnCustomerTypeID" runat="server" Value="0" />
                                        </div>
                                    </div>
                                </div>
                            </div>
