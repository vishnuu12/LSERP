...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
          ...
          function myAddtionalPart() {

            var AddtionalPart = document.getElementById('ContentPlaceHolder1_chkAddtionalPart');
            if (AddtionalPart.checked) {
                $("#ContentPlaceHolder1_chkAddtionalPart").prop('checked', true);
                $("#ContentPlaceHolder1_chkIssuePart").prop('checked', false);
            } else {
                $("#ContentPlaceHolder1_chkAddtionalPart").prop('checked', false);
            }
        }
        function myIssuePart() {
            var IssuePart = document.getElementById('ContentPlaceHolder1_chkIssuePart');
            if (IssuePart.checked) {
                $("#ContentPlaceHolder1_chkAddtionalPart").prop('checked', false);
                $("#ContentPlaceHolder1_chkIssuePart").prop('checked', true);
            } else {
                $("#ContentPlaceHolder1_chkIssuePart").prop('checked', false);
            }
        }
    ...
    <script type="text/javascript">
        ...
        function viewpartlayout(index) {
            __doPostBack('viewpartlayout', index);
        }
        ...
        function SaveBOMSheet() {
            ...
            if (!btnSaveEnapled.includes("btnSaveDisabled")) {
                ...
                if (msg) {
                    ...
                    else if ($('#ContentPlaceHolder1_chkIssuePart').is(':checked')) {
                        AddtionalPart = 'Issue';
                    }
                    else {
                        AddtionalPart = 'No';
        ...
        <div>
            <asp:UpdatePanel ID="upQuote" runat="server" UpdateMode="Always">
                <Triggers>
                    ...
                    <asp:PostBackTrigger ControlID="btnviewcosting" />
                </Triggers>
                <ContentTemplate>
                    <div class="card-container">
                        ...
                        <div id="divInput" runat="server">
                            <div class="ip-div text-center">
                                ...
                                <div class="col-sm-12 p-t-10" id="checkID">
                                    <div class="col-sm-4">
                                    </div>
                                    <%--OnCheckedChanged="chkAddtionalPart_CheckedChanged"--%>
                                    <div class="col-sm-2">
                                        <asp:CheckBox ID="chkAddtionalPart" Text="AddtionalPart" CssClass="AddtionalIssuePart" onclick="myAddtionalPart()" runat="server" AutoPostBack="false" />
                                    </div>
                                    <div class="col-sm-2">
                                        <asp:CheckBox ID="chkIssuePart" Text="Free Issue Part" CssClass="AddtionalIssuePart"  onclick="myIssuePart()" runat="server" AutoPostBack="false" />
                                    </div>
                                    <div class="col-sm-4">
                                    </div>
                                </div>
                            ...
                            <div class="page-container" style="float: left; width: 100%">
                                <div class="main-card">
                                    <div class="card-body">
                                                    ...
                                                    <asp:TemplateField HeaderText="View Part Lay Out">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnPartLayOut" runat="server" Text="PartLayOut" CommandName="ViewLayOut"
                                                                OnClientClick='<%# string.Format("return viewpartlayout({0});",((GridViewRow) Container).RowIndex) %>'
                                                                ToolTip="View"> <img src="../Assets/images/view.png" /></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                        ...
                                        <div class="col-sm-12 p-t-10" style="overflow-x: scroll;">
                                            <asp:GridView ID="gvIssuePart" runat="server" AutoGenerateColumns="true" ShowHeaderWhenEmpty="True"
                                                EmptyDataText="No Records Found" CssClass="table table-hover table-bordered medium pagingfalse"
                                                OnRowDataBound="gvBOMCostDetails_OnRowDataBound" OnRowCommand="gvBOMCostDetails_OnRowCommand"
                                                HeaderStyle-HorizontalAlign="Center" DataKeyNames="ETCID,MID,BOMID,PartName,LayOutFile">
                                                <Columns>
                                        ...
                                        <div class="col-sm-12 p-t-10 text-center">
                                            <label class="form-label" style="display: contents;">
                                                Free Issue BOM Cost</label>
                                            <asp:Label ID="lblIssueBomTotalCost" Style="padding-left: inherit;" runat="server"></asp:Label>
                                        </div>
                                        <div class="col-sm-12 p-t-10 text-center">
                                            <label class="form-label" style="color: Blue;">
                                        ...
                                        <div class="col-sm-12 text-center p-t-10">
                                            ...
                                            <div class="col-sm-4 text-center">
                                                <asp:LinkButton ID="btnviewcosting" CssClass="btn btn-cons btn-success" runat="server"
                                                    Text="View Costing Sheet" OnClick="btnviewcosting_Click"></asp:LinkButton>
                                            </div>
                                            <div class="col-sm-4 text-center">
                                                <asp:LinkButton ID="lbtnDeleteAll" CssClass="btn btn-cons btn-success" runat="server"
