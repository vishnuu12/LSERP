<%@ Page Title="" Language="C#" MasterPageFile="~/Master/CommonMaster.master" AutoEventWireup="true"
    CodeFile="WorkorderPoPrint.aspx.cs" Inherits="Pages_WorkorderPoPrint" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function PrintWorkOrderPO(Approvedtime, POStatus, ApprovedBy) {
            ...
            winprint.document.write("<label style='display:block;width:100%;font-weight:bold;padding-top:5px;padding-left:84px;'>For " + $('#ContentPlaceHolder1_hdnCompanyName').val() +" </label>");
            if (POStatus == "1") {
                if (ApprovedBy != '') {
    ...
    <div class="main-container main-container_close">
        ...
        <div>
            <asp:UpdatePanel ID="upDocumenttype" runat="server">
                <Triggers>
                    <asp:PostBackTrigger ControlID="btnWorkOrderPrint" />
                </Triggers>
                <ContentTemplate>
                    <div class="card-container">
                        ...
                        <div class="text-center">
                            <asp:LinkButton ID="btnWorkOrderPrint" runat="server" Text="Print" CssClass="btn btn-cons btn-success"
                                OnClick="btnWorkOrderPrint_Click"></asp:LinkButton>
                        </div>
