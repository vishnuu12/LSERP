...
public partial class Pages_AlertForDrawingUploadCompletedReviewForDesignHead : System.Web.UI.Page
{
    #region"DecLaration"
    ...
    private void BindEnquiryProjectAssignmentDetails()
    {
        ...
        try
        {
            ...
            ds = objc.GetEnquiryClarrificationForMarketingAndDesign("LS_GetDrawingUploadCompletedReviewByDesignHead");
