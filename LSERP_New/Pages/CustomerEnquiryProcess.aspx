                    ...
                    <div class="card-container">
                        <div id="divAdd" class="btnAddNew" runat="server">
                            <div class="text-center">
                              ...
                              <!-- <asp:LinkButton ID="LinkButton1" runat="server" Text="Old Enquiries" OnClientClick="script2()"
                                    CausesValidation="false" CssClass="btn btn-success"></asp:LinkButton>-->
                            </div>
                        </div>
                            ...
                            <div class="ip-div text-center">
                                ...
                                <div class="col-sm-12 p-t-10">
                                    ...
                                    <div class="col-sm-4 text-right">
                                        ...
                                        <div>
                                            <asp:DropDownList ID="ddlEnquiryNewType" runat="server" TabIndex="2" ToolTip="Select Prospect"
                                                AutoPostBack="true"
                                                CssClass="form-control mandatoryfield">
                                                <asp:ListItem Selected="True" Value="0" Text="-- Select --"></asp:ListItem>
                                                <asp:ListItem  Value="Bellows" Text="Bellows"></asp:ListItem>
                                                <asp:ListItem  Value="Strainers" Text="Strainers"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-sm-8">
                                        ...
                                        <div id="enquirydetailsdiv" class="enquirydetailsdiv" runat="server">
                                            ...
                                            <div class="col-sm-12 p-t-10">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <div>
                                                        <asp:Label ID="EnquiryNewType_V" runat="server" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
