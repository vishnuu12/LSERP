<%@ page title="" language="C#" masterpagefile="~/DocuManager.master" autoeventwireup="true" inherits="admin_administrator, App_Web_1kqnuvut" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script language="JavaScript" type="text/javascript">
        function DeleteConfirmation() {
            if (confirm("Are you sure want to delete Administrator?")) {
                ShowLoader();
                return true;
            }
            else {
            ...
            <td align="center" valign="top">
                <asp:UpdatePanel runat="server" ID="upnlUser" UpdateMode="Conditional">
                    <ContentTemplate>
                                    ...
                                    <tr style="background: rgb(235, 235, 235); border-top: solid 1px #d9d9d9;">
                                        ...
                                        <td align="right" width="50%" valign="top">
                                            <asp:ImageButton ID="btnAddNew" runat="server" ImageUrl="~/icons/addnew.png" Width="32px"
                                                Height="32px" ToolTip="Click to Add Administrator" OnClick="btnAddNew_Click" OnClientClick="ShowLoader();" />
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <asp:Panel ID="tblUser" runat="server" Width="720px" ScrollBars="Auto" Height="550px"
                            Visible="false">
                            <br />
                                        ...
                                        <td align="left" width="690px" valign="top">
                                            <table class="grid-bottom" width="680px" cellpadding="3" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtCompanyName" runat="server" CssClass="txtBox" TabIndex="4" Width="200px"
                                                                Enabled="False" Visible="false"></asp:TextBox>
                                                        <asp:DropDownList ID="ddlCompanyName" CssClass="dropdown" runat="server" ValidationGroup="User"
                                                            AutoPostBack="False" TabIndex="1" Width="200px">
                                                        </asp:DropDownList>

                                                    </td>
                                                    <td>
                                                     <asp:RequiredFieldValidator ID="rfvCompanyName" runat="server" ControlToValidate="ddlCompanyName"
                                                            ErrorMessage="*" CssClass="reqField" ToolTip="Please Select Company Name" ValidationGroup="User"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" width="200px">
                                                        <asp:TextBox ID="txtFirstName" runat="server" CssClass="txtBox" TabIndex="2" Width="200px"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtPhoneNo" runat="server" CssClass="txtBox" TabIndex="4" Width="200px"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtEmail" runat="server" CssClass="txtBox" TabIndex="5" Width="200px"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtAddress" runat="server" CssClass="txtAddress" TabIndex="6" TextMode="MultiLine"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtCity" runat="server" CssClass="txtBox" TabIndex="7" Width="200px"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:DropDownList ID="ddlState" runat="server" ValidationGroup="User" TabIndex="9"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtPostalCode" runat="server" CssClass="txtBox" TabIndex="10" Width="200px"
