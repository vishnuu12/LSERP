...
var ddimagepanner = {
    ...
    magnifyicons: ['../Images/magnify.gif', '../Images/magnify2.gif', 16, 16], //set path to zoom in/out images, plus their dimensions
    ...
    zoomfunct: function ($, $img, s) {
        ...
        var $zoomimages = $('<img src="' + magnifyicons[0] + '" /><img src="' + magnifyicons[1] + '" style="margin-left:10px;" />')
			.css({ width: magnifyicons[2], height: magnifyicons[3], cursor: 'pointer', zIndex: 1000, position: 'absolute',
			    ...
			    top: '5px', left: s.wrappersize[0] - magnifyicons[2] - 50, opacity: 0.7
			})
			.attr("title", "Zoom Out")
