...
public partial class Pages_CAPARequestPending : System.Web.UI.Page
{
    #region "Declaration"
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (target == "ShareRaisedProblem")
            {
                ...
                ds = objReport.UpdateProductionCorrectiveActionQCStatusByCAPAID();

                if (ds.Tables[0].Rows[0]["Message"].ToString() == "Updated")
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Sucess", "SuccessMessage('Success','QC Requested Successfully');", true);
    ...
    private void BindCAPARequestPendingDetails()
    {
        ...
        {
            objReport.UserID = objSession.employeeid;
            ds = objReport.GetCAPARequestPendingDetails();
    ...
    protected void gvCAPADetails_OnRowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            ...
            ds = objReport.DeleteCAPAActionReportDetailsByCAPADID("LS_DeleteCAPAActionReportDetailsByProcees2");
        ...
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (dr["CAPAASID"].ToString() == ViewState["RowCount"].ToString())
                    btnDelete.Visible = dr["ProcessStep"].ToString() == "P2" ? true : false;
                else
