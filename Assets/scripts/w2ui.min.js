    ...
    function(a) {
        a.fn.w2render = function(b) {
            ...
            "string" == typeof b && (b = {
                ...
                "#" == d && (d = ""), g = a(c.originalEvent.target).attr("index").split(":"), "INPUT" == f.tagName ? (a(f).val(d).data("skipInit", !0), b.fireChange && a(f).change(), a(f).next().find(">div").css("background-color", d)) : a(f).data("_color", d), "function" == typeof b.onSelect && b.onSelect(d)
            ...
            var l = function(c, d) {
                    ...
                    }), d ? a("#w2ui-overlay .color-original").css("background-color", e) : ("INPUT" == f.tagName ? (a(f).val(e).data("skipInit", !0), b.fireChange && a(f).change(), a(f).next().find(">div").css("background-color", e)) : a(f).data("_color", e), "function" == typeof b.onSelect && b.onSelect(e))
                },
                m = function() {
                ...
                q = function(a) {
                    ...
                    var h = parseInt(b.css("left")) + g,
                        j = parseInt(b.css("top")) + g,
                        k = b.parent().attr("name");
                    if ("palette" == k && l({
                            s: Math.round(h / b.parent().width() * 100),
                            v: Math.round(100 - j / b.parent().height() * 100)
                        }), "rainbow" == k) {
                        var m = Math.round(2.4 * h);
                        l({
                            h: m
                        }), n()
                    }
                    "alpha" == k && l({
                        a: parseFloat(Number(h / 150).toFixed(2))
                    })
                };
            a.fn._colorAdvanced !== !0 && b.advanced !== !0 || a("#w2ui-overlay .w2ui-color-tabs :nth-child(2)").click(), l({}, !0), n(), m();
            var r = "mousedown.w2color",
                s = "mouseup.w2color",
                t = "mousemove.w2color";
            w2utils.isIOS && (r = "touchstart.w2color", s = "touchend.w2color", t = "touchmove.w2color  "),
                a("#w2ui-overlay .palette").off(".w2color").on("mousedown.w2color", o), a("#w2ui-overlay .rainbow").off(".w2color").on("mousedown.w2color", o), a("#w2ui-overlay .alpha").off(".w2color").on("mousedown.w2color", o), f.nav = function(b) {
                    switch (b) {
                        case "up":
                            g[0]--;
                            break;
    ...
    function($) {
        ...
        $.fn.w2grid = function(a) {
            ...
            getFirst: function() {
                ...
                return Array.isArray(b) && b.length > 0 && (a = this.records[b[0]].recid), a
            },
            remove: function() {
            ...
            refreshBody: function() {
                ...
                if (g.data("scrolldata", {
                        ...
                        lastDelta: 0,
                        time: 0
                    }).find(".w2ui-grid-frecords, .w2ui-grid-records").on("mousewheel DOMMouseScroll ", function(b) {
                        b.preventDefault();
                        var c = b.originalEvent,
                            d = g.data("scrolldata"),
                            e = $(this).siblings(".w2ui-grid-records").addBack().filter(".w2ui-grid-records"),
                            f = "undefined" != typeof c.wheelDelta ? c.wheelDelta * -1 / 120 : (c.detail || c.deltaY) / 3,
                            i = e.scrollTop();
                    ...
                    if (1 == a.which && ("text" == e.last.userSelect && (delete e.last.userSelect, $(e.box).find(".w2ui-grid-body").css(w2utils.cssPrefix("user-select", "none"))), !("row" == e.selectType && ($(a.target).parents().hasClass("w2ui-head") || $(a.target).hasClass("w2ui-head")) || e.last.move && "expand" == e.last.move.type))) {
                        if (a.altKey) $(e.box).find(".w2ui-grid-body").css(w2utils.cssPrefix("user-select", "text")), e.selectNone(), e.last.move = {
                            ...
                            if (e.last.move) {
                                ...
                                (l.hasClass("w2ui-grid-records") || l.hasClass("w2ui-grid-frecords") || l.hasClass("w2ui-grid-columns") || l.hasClass("w2ui-grid-fcolumns") || l.hasClass("w2ui-grid-summary")) && (j = e.last.move.focusX - $(e.box).find("#grid_" + e.name + "_records").scrollLeft(),
                                    k = e.last.move.focusY - $(e.box).find("#grid_" + e.name + "_records").scrollTop()), ($(h).hasClass("w2ui-grid-footer") || $(h).parents("div.w2ui-grid-footer").length > 0) && (k = $(e.box).find("#grid_" + e.name + "_footer").position().top), i.css({
                                    left: j - 10,
                                    top: k
                                })
                            }
                    ...
                    for (var l in i) {
                        ...
                        if ("" != m && "-" != m && "--" != m && "---" != m) {
                            ...
                            j.length > 1 && (w2utils.formatters[j[1]] ? k = w2utils.formatters[j[1]](k, j[2] || null) : console.log('ERROR: w2utils.formatters["' + j[1] + '"] does not exists.')),
                                "function" == typeof m && (k = m(e, a, b)), (d.showEmpty === !0 || null != k && "" != k) && (null != d.maxLength && "string" == typeof k && k.length > d.maxLength && (k = k.substr(0, d.maxLength) + "..."), c += "<tr><td>" + l + "</td><td>" + (k || "") + "</td></tr>")
    ...
    a.fn.w2field = function(c, d) {
        ...
        keyDown: function(b, c) {
            ...
            if ("time" == d.type) {
                ...
                g && (a(d.el).val(d.fromMin(m)).change(),
