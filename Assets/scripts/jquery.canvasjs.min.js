...
*/
(function () {
    function oa(h, m) { h.prototype = cb(m.prototype); h.prototype.constructor = h; h.base = m.prototype } function cb(h) { function m() { } m.prototype = h; return new m } function Va(h, m, w) {
        "millisecond" === w ? h.setMilliseconds(h.getMilliseconds() + 1 * m) : "second" === w ? h.setSeconds(h.getSeconds() + 1 * m) : "minute" === w ? h.setMinutes(h.getMinutes() + 1 * m) : "hour" === w ? h.setHours(h.getHours() + 1 * m) : "day" === w ? h.setDate(h.getDate() + 1 * m) : "week" === w ? h.setDate(h.getDate() + 7 * m) : "month" === w ? h.setMonth(h.getMonth() + 1 * m) : "year" === w && h.setFullYear(h.getFullYear() +
            1 * m); return h
    } function Y(h, m) { var w = !1; 0 > h && (w = !0, h *= -1); h = "" + h; for (m = m ? m : 1; h.length < m;)h = "0" + h; return w ? "-" + h : h } function Fa(h) { if (!h) return h; h = h.replace(/^\s\s*/, ""); for (var m = /\s/, w = h.length; m.test(h.charAt(--w));); return h.slice(0, w + 1) } function Ba(h) {
    h.roundRect = function (h, w, s, u, ra, D, y, F) {
        y && (this.fillStyle = y); F && (this.strokeStyle = F); "undefined" === typeof ra && (ra = 5); this.lineWidth = D; this.beginPath(); this.moveTo(h + ra, w); this.lineTo(h + s - ra, w); this.quadraticCurveTo(h + s, w, h + s, w + ra); this.lineTo(h + s,
            w + u - ra); this.quadraticCurveTo(h + s, w + u, h + s - ra, w + u); this.lineTo(h + ra, w + u); this.quadraticCurveTo(h, w + u, h, w + u - ra); this.lineTo(h, w + ra); this.quadraticCurveTo(h, w, h + ra, w); this.closePath(); y && this.fill(); F && 0 < D && this.stroke()
    }
    ...
    } function s(h) { return null === h || "undefined" === typeof h } function Ca(h) { h.indexOf || (h.indexOf = db); return h } function eb(h) { if (T.fSDec) h[X("`eeDwdouMhrudods")](X("e`u`@ohl`uhnoHuds`uhnoDoe"), function () { T._fTWm && T._fTWm(h) }) } function Wa(h, m, w) {
        w = w || "normal"; var s = h + "_" + m + "_" + w, u = Xa[s]; if (isNaN(u)) {
            try {
                ...
                h + "; font-size:" + m + "px; font-weight:" + w + ";"; if (!wa) { var ra = document.body; wa = document.createElement("span"); wa.innerHTML = ""; var D = document.createTextNode("Mpgyi"); wa.appendChild(D); ra.appendChild(wa) } wa.style.display = ""; wa.setAttribute("style", h); u = Math.round(wa.offsetHeight); wa.style.display = "none"
            } catch (y) { u = Math.ceil(1.1 * m) } u = Math.max(u, m); Xa[s] = u
        } return u
    } function N(h, m) {
        var w = []; if (w = {
        ...
        u = u || []; qa = s(qa) ? fb ? { passive: !1, capture: !1 } : !1 : qa; u.push([h, m, w, qa]); return h.addEventListener ? (h.addEventListener(m, w, qa), w) : h.attachEvent ? (u = function (m) { m = m || window.event; m.preventDefault = m.preventDefault || function () { m.returnValue = !1 }; m.stopPropagation = m.stopPropagation || function () { m.cancelBubble = !0 }; w.call(h, m) }, h.attachEvent("on" +
            m, u), u) : !1
    } function gb(h) {
        if (h._menuButton) h.exportEnabled ? (ga(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), Ka(h._menuButton), h._menuButton.title = h._cultureInfo.menuText) : ua(h._menuButton); else if (h.exportEnabled && u) {
            var m = !1; h._menuButton = document.createElement("button"); va(h, h._menuButton, "menu"); h._toolBar.appendChild(h._menuButton); J(h._menuButton, "touchstart", function (h) { m = !0 }, h.allDOMEventHandlers); J(h._menuButton, "click", function () {
            ...
            }, h.allDOMEventHandlers, !0); J(h._menuButton, "mouseover", function () { m || (ga(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColorOnHover, color: h.toolbar.fontColorOnHover }), 0 >= navigator.userAgent.search("MSIE") && ga(h._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, h.allDOMEventHandlers, !0); J(h._menuButton,
                "mouseout", function () { m || (ga(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), 0 >= navigator.userAgent.search("MSIE") && ga(h._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) }, h.allDOMEventHandlers, !0)
        } if (h.exportEnabled && h._dropdownMenu) {
            ga(h._dropdownMenu, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }); for (var w = h._dropdownMenu.childNodes, s = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText],
            ...
            w.innerHTML = h._cultureInfo.saveJPGText, w.style.backgroundColor = h.toolbar.itemBackgroundColor, w.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(w), J(w, "touchstart", function (h) { m = !0 }, h.allDOMEventHandlers), J(w, "mouseover", function () { m || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), J(w, "mouseout", function () { m || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) },
                ...
                }, h.allDOMEventHandlers, !0), J(w, "mouseout", function () { m || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), J(w, "click", function () { h.exportChart({ format: "png", fileName: h.exportFileName }); ua(h._dropdownMenu) }, h.allDOMEventHandlers, !0))
    } function Ya(h, m, w) {
        h *= ka; m *= ka; h = w.getImageData(h, m, 2, 2).data; m = !0; for (w = 0; 4 > w; w++)if (h[w] !== h[w + 4] | h[w] !== h[w + 8] |
            h[w] !== h[w + 12]) { m = !1; break } return m ? h[0] << 16 | h[1] << 8 | h[2] : 0
    } function la(h, m, w) { return h in m ? m[h] : w[h] } function La(h, m, w) { if (u && Za) { var s = h.getContext("2d"); Ma = s.webkitBackingStorePixelRatio || s.mozBackingStorePixelRatio || s.msBackingStorePixelRatio || s.oBackingStorePixelRatio || s.backingStorePixelRatio || 1; ka = Qa / Ma; h.width = m * ka; h.height = w * ka; Qa !== Ma && (h.style.width = m + "px", h.style.height = w + "px", s.scale(ka, ka)) } else h.width = m, h.height = w } function hb(h) {
        if (!ib) {
            var m = !1, w = !1; "undefined" === typeof pa.Chart.creditHref ?
                (h.creditHref = X("iuuqr;..b`ow`rkr/bnl."), h.creditText = X("B`ow`rKR/bnl")) : (m = h.updateOption("creditText"), w = h.updateOption("creditHref")); if (h.creditHref && h.creditText) {
        ...
        var w = document.createElement("canvas"); w.setAttribute("class", "canvasjs-chart-canvas"); La(w, h, m); u || "undefined" === typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(w); return w
    } function ga(h, m) { for (var w in m) h.style[w] = m[w] } function va(h, m, w) {
        m.getAttribute("state") || (m.style.backgroundColor = h.toolbar.itemBackgroundColor, m.style.color = h.toolbar.fontColor, m.style.border = "none", ga(m, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" })); m.getAttribute("state") !==
    ...
    } function Ka() { for (var h = null, m = 0; m < arguments.length; m++)h = arguments[m], h.style && (h.style.display = "inline") } function ua() {
        for (var h =
            null, m = 0; m < arguments.length; m++)(h = arguments[m]) && h.style && (h.style.display = "none")
    } function Ra(h, m, w, s, u) { if (null === h || "undefined" === typeof h) return "undefined" === typeof w ? m : w; h = parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? m / 100 : 1); "undefined" !== typeof s && (h = Math.min(s, h), "undefined" !== typeof u && (h = Math.max(u, h))); return !isNaN(h) && h <= m && 0 <= h ? h : "undefined" === typeof w ? m : w } function V(h, m, w, u, qa) {
    this._defaultsKey = h; this._themeOptionsKey = m; this._index = u; this.parent = qa; this._eventListeners = [];
    ...
    "undefined" ===
        typeof u && (u = 0); this._padding = u; this._x1 = h; this._y1 = m; this._x2 = w; this._y2 = s; this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding
    } function ia(h, m) { ia.base.constructor.call(this, "TextBlock", null, m, null, null); this.ctx = h; this._isDirty = !0; this._wrappedText = null; this._initialize() } function Sa(h, m) { Sa.base.constructor.call(this, "Toolbar", "toolbar", m, null, h); this.chart = h; this.canvas = h.canvas; this.ctx = this.chart.ctx; this.optionsName = "toolbar" } function ya(h, m) {
    ...
    this.pool =
        []
    } function Ia(h) { var m; h && Ja[h] && (m = Ja[h]); Ia.base.constructor.call(this, "CultureInfo", null, m, null, null) } var Ga = !1, T = {}, u = !!document.createElement("canvas").getContext, pa = {
        Chart: {
            ...
            enabled: !0, shared: !1, animationEnabled: !0, content: null, contentFormatter: null, reversed: !1, backgroundColor: u ? "rgba(255,255,255,.9)" : "rgb(255,255,255)", borderColor: null,
        ...
        H, $, Z, da, ha; $ = "#333333"; Z = "#000000"; H = "#666666"; ha = da = "#000000"; var U = 20, F = 14, Ua = {
            colorSet: "colorSet1", backgroundColor: "#FFFFFF", title: { fontFamily: Ea, fontSize: 32, fontColor: $, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Ea, fontSize: F, fontColor: $, fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{ indexLabelFontFamily: y, indexLabelFontSize: F, indexLabelFontColor: $, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
                ...
                titleFontFamily: y, titleFontSize: U, titleFontColor: $, titleFontWeight: "normal", labelFontFamily: y, labelFontSize: F, labelFontColor: Z,
            ...
            colorSet: "colorSet2", title: {
                ...
                titleFontFamily: y, titleFontSize: U, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: y, labelFontSize: F,
    ...
    U = 20; F = 14; Ea = {
        colorSet: "colorSet12", backgroundColor: "#2A2A2A", title: { fontFamily: Ea, fontSize: 32, fontColor: $, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Ea, fontSize: F, fontColor: $, fontWeight: "normal", verticalAlign: "top", margin: 5 }], toolbar: { itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372", buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" }, data: [{
            ...
            titleFontFamily: y, titleFontSize: U, titleFontColor: Z, titleFontWeight: "normal", labelFontFamily: y, labelFontSize: F, labelFontColor: Z, labelFontWeight: "normal",
        ...
        dark2: {
            colorSet: "colorSet2", backgroundColor: "#32373A", title: { fontFamily: y, fontSize: 32, fontColor: $, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: y, fontSize: F, fontColor: $, fontWeight: "normal", verticalAlign: "top", margin: 5 }], toolbar: { itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372", buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" }, data: [{
                ...
                titleFontFamily: y, titleFontSize: U, titleFontColor: Z, titleFontWeight: "normal", labelFontFamily: y, labelFontSize: F, labelFontColor: Z, labelFontWeight: "normal", lineThickness: 0,
    ...
    T.fSDec = function (h) { for (var m = "", w = 0; w < h.length; w++)m += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(w)); return m }; T.obj = {
        wm: "B`ow`rKR!Ush`m", wmFnSt: "qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg", wmTB: "udyuC`rdmhod", wmFn: "gnou", wmFnS: "ghmmRuxmd", wmFnT: "ghmmUdyu", wmFnClr: "fsdx", wmCtx: "buy",
        wmTop: "unq", msrTxt: "ld`rtsdUdyu"
        ...
        if ("undefined" === typeof T.pro.sCH && !bb) try {
            var m = (new Date).getMonth() % 3, w, s, u = h[T.fSDec(T.obj.wmCtx)]; u[T.fSDec(T.obj.wmTB)] = T.fSDec(T.obj.wmTop); u[T.fSDec(T.obj.wmFn)] = 11 + T.fSDec(T.obj.wmFnSt); u[T.fSDec(T.obj.wmFnS)] = T.fSDec(T.obj.wmFnClr); w = "cm" === T.pos[m] || "um" === T.pos[m] ? 0 : h.width - u[T.fSDec(T.obj.msrTxt)](T.fSDec(T.obj.wm)).width;
            s = "um" === T.pos[m] ? 0 : h.height - 11; u[T.fSDec(T.obj.wmFnT)](T.fSDec(T.obj.wm), w, s); "cs" === T.pos[m] && (h[T.fSDec("^bsdehuMhoj")].style.right = T.fSDec("`tun"))
        } catch (y) { }
    }
    })(); var fb = function () { var h = !1; try { var m = Object.defineProperty && Object.defineProperty({}, "passive", { get: function () { h = !0; return !1 } }); window.addEventListener && (window.addEventListener("test", null, m), window.removeEventListener("test", null, m)) } catch (w) { h = !1 } return h }(), Xa = {}, wa = null, kb = function () {
        this.ctx.clearRect(0, 0, this.width, this.height);
        this.backgroundColor && (this.ctx.fillStyle = this.backgroundColor, this.ctx.fillRect(0, 0, this.width, this.height))
    }, lb = function (h, m, w) { m = Math.min(this.width, this.height); return Math.max("theme4" === this.theme ? 0 : 300 <= m ? 12 : 11, Math.round(m * (h / 400))) }, Aa = function () {
        var h = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g, m = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), w = "Sun Mon Tue Wed Thu Fri Sat".split(" "), s = "January February March April May June July August September October November December".split(" "),
        u = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), y = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, D = /[^-+\dA-Z]/g; return function (F, N, M) {
            var T = M ? M.days : m, H = M ? M.months : s, Q = M ? M.shortDays : w, J = M ? M.shortMonths : u; M = ""; var R = !1; F = F && F.getTime ? F : F ? new Date(F) : new Date; if (isNaN(F)) throw SyntaxError("invalid date"); "UTC:" === N.slice(0, 4) && (N = N.slice(4), R = !0); M = R ? "getUTC" : "get"; var V = F[M + "Date"](), L = F[M + "Day"](),
                W = F[M + "Month"](), a = F[M + "FullYear"](), d = F[M + "Hours"](), c = F[M + "Minutes"](), b = F[M + "Seconds"](), e = F[M + "Milliseconds"](), f = R ? 0 : F.getTimezoneOffset(); return M = N.replace(h, function (l) {
                    switch (l) {
                        case "D": return V; case "DD": return Y(V, 2); case "DDD": return Q[L]; case "DDDD": return T[L]; case "M": return W + 1; case "MM": return Y(W + 1, 2); case "MMM": return J[W]; case "MMMM": return H[W]; case "Y": return parseInt(String(a).slice(-2)); case "YY": return Y(String(a).slice(-2), 2); case "YYY": return Y(String(a).slice(-3), 3); case "YYYY": return Y(a,
                            4); case "h": return d % 12 || 12; case "hh": return Y(d % 12 || 12, 2); case "H": return d; case "HH": return Y(d, 2); case "m": return c; case "mm": return Y(c, 2); case "s": return b; case "ss": return Y(b, 2); case "f": return Y(String(e), 3).slice(0, 1); case "ff": return Y(String(e), 3).slice(0, 2); case "fff": return Y(String(e), 3).slice(0, 3); case "t": return 12 > d ? "a" : "p"; case "tt": return 12 > d ? "am" : "pm"; case "T": return 12 > d ? "A" : "P"; case "TT": return 12 > d ? "AM" : "PM"; case "K": return R ? "UTC" : (String(F).match(y) || [""]).pop().replace(D,
                                ""); case "z": return (0 < f ? "-" : "+") + Math.floor(Math.abs(f) / 60); case "zz": return (0 < f ? "-" : "+") + Y(Math.floor(Math.abs(f) / 60), 2); case "zzz": return (0 < f ? "-" : "+") + Y(Math.floor(Math.abs(f) / 60), 2) + Y(Math.abs(f) % 60, 2); default: return l.slice(1, l.length - 1)
                    }
                })
        }
    }(), ea = function (h, m, w) {
        if (null === h) return ""; if (!isFinite(h)) return h; h = Number(h); var s = 0 > h ? !0 : !1; s && (h *= -1); var u = w ? w.decimalSeparator : ".", y = w ? w.digitGroupSeparator : ",", D = ""; m = String(m); var D = 1, F = w = "", N = -1, M = [], T = [], H = 0, Q = 0, R = 0, J = !1, V = 0, F = m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
        ...
        m = D.split("."); D = (m[0] + "").split(""); h = (m[1] + "").split(""); D && "0" === D[0] && D.shift(); for (J = F = L = Q = N = 0; 0 < M.length;)if (m = M.pop(), "#" === m || "0" === m) if (N++ , N === H) { var W = D, D = []; if ("0" === m) for (m = H - Q - (W ? W.length : 0); 0 < m;)W.unshift("0"), m--; for (; 0 < W.length;)w = W.pop() + w, J++ , 0 === J % F && (L === R && 0 < W.length) && (w = y + w) } else 0 < D.length ? (w = D.pop() + w, Q++ , J++) : "0" === m && (w = "0" + w, Q++ , J++), 0 === J % F && (L === R && 0 < D.length) && (w = y + w); else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (L++ , F = J, J = 0, 0 < D.length &&
            (w = y + w)) : w = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + w : m + w : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), w += m.replace(/[0]+/, function (a) { return Y(V, a.length) })); y = ""; for (M = !1; 0 < T.length;)m = T.shift(), "#" === m || "0" === m ? 0 < h.length && 0 !== Number(h.join("")) ? (y += h.shift(), M = !0) : "0" === m && (y += "0", M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? y += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length -
                1] || !/[eE][+-]*[0]+/.test(m) ? y += m : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), y += m.replace(/[0]+/, function (a) { return Y(V, a.length) })); w += (M ? u : "") + y; return s ? "-" + w : w
    }, Na = function (h) { var m = 0, w = 0; h = h || window.event; h.offsetX || 0 === h.offsetX ? (m = h.offsetX, w = h.offsetY) : h.layerX || 0 == h.layerX ? (m = h.layerX, w = h.layerY) : (m = h.pageX - h.target.offsetLeft, w = h.pageY - h.target.offsetTop); return { x: m, y: w } }, Za = !0, Qa = window.devicePixelRatio || 1, Ma = 1, ka = Za ? Qa / Ma : 1, ca = function (h, m, w, s, u, y, D, F, N, M, T, Q, J) {
    "undefined" ===
    ...
    V.prototype.setOptions = function (h, m) { if (pa[this._defaultsKey]) { var s = pa[this._defaultsKey], u; for (u in s) "publicProperties" !== u && s.hasOwnProperty(u) && (this[u] = h && u in h ? h[u] : m && u in m ? m[u] : s[u]) } else Ga && window.console && console.log("defaults not set") }; V.prototype.get = function (h) {
        ...
        s = "undefined" === typeof s ? !0 : s; var u = pa[this._defaultsKey]; if ("options" === h) this.createUserOptions(m); else if (u.hasOwnProperty(h) || u.publicProperties && u.publicProperties.hasOwnProperty(h) && "readWrite" === u.publicProperties[h]) this.options._isPlaceholder && this.createUserOptions(), this.options[h] = m; else {
        ...
        u = "undefined" === typeof u ? !0 : u; var y = pa[this._defaultsKey]; y.hasOwnProperty(h) || y.publicProperties && y.publicProperties.hasOwnProperty(h) && "readWrite" === y.publicProperties[h] ? (this.options._isPlaceholder && this.createUserOptions(), "undefined" === typeof this.options[h] && (this.options[h] =
    ...
    }; V.prototype.remove = function (h) { h = "undefined" === typeof h ? !0 : h; if (this.isOptionsInArray) { var m = this.parent.options[this.optionsName]; Ca(m); var s = m.indexOf(this.options); 0 <= s && m.splice(s, 1) } else delete this.parent.options[this.optionsName]; h && (this.stockChart || this.chart || this).render() }; V.prototype.updateOption = function (h) {
    !pa[this._defaultsKey] && (Ga && window.console) && console.log("defaults not set"); var m = pa[this._defaultsKey], u = {}, y = this[h], F = this._themeOptionsKey,
    ...
    h && m && (this._eventListeners[h] =
    ...
    }; V.prototype.removeEventListener = function (h, m) { if (h && m && this._eventListeners[h]) for (var s = this._eventListeners[h], u = 0; u < s.length; u++)if (s[u].eventHandler === m) { s[u].splice(u, 1); break } }; V.prototype.removeAllEventListeners = function () { this._eventListeners = [] }; V.prototype.dispatchEvent = function (h, m, s) {
        if (h && this._eventListeners[h]) {
            m = m || {}; for (var u = this._eventListeners[h], y = 0; y < u.length; y++)u[y].eventHandler.call(u[y].context,
                m)
        ...
        this.text = h; this._isDirty = !0; this._wrappedText =
            ...
            h = String(h); if (!h) return { text: "", width: 0 }; var u = s = 0, y = h.length - 1, F = Infinity; for (this.ctx.font = this._getFontString(); u <= y;) {
                var F = Math.floor((u + y) / 2), D = h.substr(0, F + 1); s = this.ctx.measureText(D).width;
            ...
            var h = new String(Fa(String(this.text))), m = [], s = this.ctx.font, u = 0, y = 0; this.ctx.font = this._getFontString(); if (0 === this.frontSize) y = u = 0; else for (; 0 < h.length;) {
                var F = this.maxHeight - (this.topPadding +
                    this.bottomPadding), D = this._getLineWithWidth(h, this.maxWidth - (this.leftPadding + this.rightPadding), !1); D.height = this._lineHeight; m.push(D); var H = y, y = Math.max(y, D.width), u = u + D.height, h = Fa(h.slice(D.text.length, h.length)); F && u > F && (D = m.pop(), u -= D.height, y = H)
            ...
            var h; h = "" + (this.fontStyle ? this.fontStyle + " " :
                ""); h += this.fontWeight ? this.fontWeight + " " : ""; h += this.fontSize ? this.fontSize + "px " : ""; var m = this.fontFamily ? this.fontFamily + "" : ""; !u && m && (m = m.split(",")[0], "'" !== m[0] && '"' !== m[0] && (m = "'" + m + "'")); return h += m
        }; oa(Sa, V); oa(ya, V); ya.prototype.setLayout = function () {
            if (this.text) {
                var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = h.layoutManager.getFreeSpace(), u = m.x1, y = m.y1, F = 0, H = 0, D = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, N, J; "top" === this.verticalAlign ||
                    "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = m.width - 4 - D * ("center" === this.horizontalAlign ? 2 : 1)), H = 0.5 * m.height - this.margin - 2, F = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = m.height - 4), H = 0.5 * m.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = m.width - 4), H = 0.5 * m.height - 4)); var M; s(this.padding) || "number" !== typeof this.padding ? s(this.padding) || "object" !==
                        typeof this.padding || (M = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0, M += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0) : M = 2 * this.padding; this.wrap || (H = Math.min(H, 1.5 * this.fontSize + M)); H = new ia(this.ctx, {
                            ...
                            this.width = M.width, this.height = M.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (u = m.x1 + 2, y = m.y2 - 2 - (this.maxWidth / 2 - M.width / 2), F = -90, J = "left", this.width = M.height, this.height = M.width) : "right" === this.horizontalAlign ? (u = m.x2 - 2, y = m.y1 + 2 + (this.maxWidth / 2 - M.width / 2), F = 90, J = "right", this.width = M.height, this.height = M.width) : "center" === this.horizontalAlign && (y = h.y1 + (h.height / 2 - M.height / 2), u = h.x1 + (h.width / 2 - M.width / 2), J = "center", this.width = M.width, this.height = M.height), N = "center"); H.x =
                                u; H.y = y; H.angle = F; H.horizontalAlign = N; this._textBlock = H; h.layoutManager.registerSpace(J, { width: this.width + ("left" === J || "right" === J ? this.margin + 2 : 0), height: this.height + ("top" === J || "bottom" === J ? this.margin + 2 : 0) }); this.bounds = { x1: u, y1: y, x2: u + this.width, y2: y + this.height }; this.ctx.textBaseline = "top"
            }
        }; ya.prototype.render = function () { this._textBlock && this._textBlock.render(!0) }; oa(Ha, V); Ha.prototype.setLayout = ya.prototype.setLayout; Ha.prototype.render = ya.prototype.render; Ta.prototype.get = function (h, m) {
            var u =
                null; 0 < this.pool.length ? (u = this.pool.pop(), La(u, h, m)) : u = ta(h, m); return u
        }; Ta.prototype.release = function (h) { this.pool.push(h) }; oa(Ia, V); var Oa = { addTheme: function (h, m) { ab[h] = m }, addColorSet: function (h, m) { za[h] = m }, addCultureInfo: function (h, m) { Ja[h] = m }, formatNumber: function (h, m, u) { u = u || "en"; if (Ja[u]) return ea(h, m || "#,##0.##", new Ia(u)); throw "Unknown Culture Name"; }, formatDate: function (h, m, u) { u = u || "en"; if (Ja[u]) return Aa(h, m || "DD MMM YYYY", new Ia(u)); throw "Unknown Culture Name"; } }; "undefined" !== typeof module &&
            "undefined" !== typeof module.exports ? module.exports = Oa : "function" === typeof define && define.amd ? define([], function () { return Oa }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS : Oa); y = Oa.Chart = function () {
                function h(a, d) { return a.x - d.x } function m(a, d, c) {
                    ...
                    for (var c = [], b, e = 0; e < a.length; e++)if (0 == e) c.push(a[0]); else {
                        var f, l, v; v = e - 1; f = 0 === v ? 0 : v - 1; l = v === a.length - 1 ? v : v + 1; b = Math.abs((a[l].x - a[f].x) / (0 === a[l].x - a[v].x ? 0.01 : a[l].x - a[v].x)) * (d - 1) /
                            2 + 1; var A = (a[l].x - a[f].x) / b; b = (a[l].y - a[f].y) / b; c[c.length] = a[v].x > a[f].x && 0 < A || a[v].x < a[f].x && 0 > A ? { x: a[v].x + A / 3, y: a[v].y + b / 3 } : { x: a[v].x, y: a[v].y + b / 9 }; v = e; f = 0 === v ? 0 : v - 1; l = v === a.length - 1 ? v : v + 1; b = Math.abs((a[l].x - a[f].x) / (0 === a[v].x - a[f].x ? 0.01 : a[v].x - a[f].x)) * (d - 1) / 2 + 1; A = (a[l].x - a[f].x) / b; b = (a[l].y - a[f].y) / b; c[c.length] = a[v].x > a[f].x && 0 < A || a[v].x < a[f].x && 0 > A ? { x: a[v].x - A / 3, y: a[v].y - b / 3 } : { x: a[v].x, y: a[v].y - b / 9 }; c[c.length] = a[e]
                    } return c
                } function y(a, d, c, b, e, f, l, v, A, k) {
                    var n = 0; k ? (l.color = f, v.color = f) :
                ...
                this.chart = a; this.ctx = this.chart.plotArea.ctx;
                    ...
                    var a =
                        this; this.updateOption("width"); this.updateOption("height"); this.updateOption("dataPointWidth"); this.updateOption("dataPointMinWidth"); this.updateOption("dataPointMaxWidth"); this.updateOption("interactivityEnabled"); this.updateOption("theme"); this.updateOption("colorSet") && (this.selectedColorSet = "undefined" !== typeof za[this.colorSet] ? za[this.colorSet] : za.colorSet1); this.updateOption("backgroundColor"); this.backgroundColor || (this.backgroundColor = "rgba(0,0,0,0)"); this.updateOption("culture"); this._cultureInfo =
                            new Ia(this.options.culture); this.updateOption("animationEnabled"); this.animationEnabled = this.animationEnabled && u; this.updateOption("animationDuration"); this.updateOption("rangeChanging"); this.updateOption("rangeChanged"); this.updateOption("exportEnabled"); this.updateOption("exportFileName"); this.updateOption("zoomType"); this.toolbar = new Sa(this, this.options.toolbar); if (this.options.zoomEnabled || this.panEnabled) {
                ...
                this.isNavigator = s(this.parent) || s(this.parent._defaultsKey) || "Navigator" !== this.parent._defaultsKey ? !1 : !0; this._animator ? this._animator.cancelAllAnimations() : this._animator = new ha(this); this.removeAllEventListeners(); this.disableToolTip = !1; this._axes = []; this.funnelPyramidClickHandler =
                        ...
                        this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) {
                            if (!this.data[d].axisYType || "primary" === this.data[d].axisYType) if (this.options.axisY && 0 < this.options.axisY.length) {
                                ...
                                "axisY", this.options.axisY, 0, "axisY", "bottom"))), this.data[d].axisY = this.axisY[0], this.axisY[0].dataSeries.push(this.data[d]); if ("secondary" === this.data[d].axisYType) if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                                    ...
                                    this._axes.push(this.axisY2[0] = new D(this, "axisY2", this.options.axisY2, 0, "axisY", "top"))), this.data[d].axisY = this.axisY2[0], this.axisY2[0].dataSeries.push(this.data[d]); if (!this.data[d].axisXType || "primary" === this.data[d].axisXType) if (this.options.axisX && 0 < this.options.axisX.length) {
                                        ...
                                        "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] = new D(this, "axisX", this.options.axisX, 0, "axisX", "left"))), this.data[d].axisX = this.axisX[0], this.axisX[0].dataSeries.push(this.data[d]); if ("secondary" === this.data[d].axisXType) if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                    ...
                    var a = this._plotAreaElements; this.title && !this.title.dockInsidePlotArea && this.title.render(); for (var d = 0; d < this.subtitles.length; d++)this.subtitles[d].dockInsidePlotArea || this.subtitles[d].render(); this.legend.dockInsidePlotArea || this.legend.render(); if ("normal" === this.plotInfo.axisPlacement || "xySwapped" ===
                        this.plotInfo.axisPlacement) D.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement); else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea(); else return; for (d = 0; d < a.length; d++)a[d].setLayout(), a[d].render(); var c = []; if (this.animatedRender) { var b = ta(this.width, this.height); b.getContext("2d").drawImage(this.canvas, 0, 0, this.width, this.height) } hb(this); var a = this.ctx.miterLimit, e; this.ctx.miterLimit = 3; u && this._breaksCanvas && (this._preRenderCtx.drawImage(this.canvas,
                            0, 0, this.width, this.height), this._preRenderCtx.drawImage(this._breaksCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx.globalCompositeOperation = "source-atop", this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), this._preRenderCtx.clearRect(0, 0, this.width, this.height)); for (d = 0; d < this.plotInfo.plotTypes.length; d++)for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                                var v = f.plotUnits[l], A = null; v.targetCanvas = null; this.animatedRender && (v.targetCanvas =
                                ...
                                n.animationDuration, function (a) { n.ctx.clearRect(0, 0, n.width, n.height); n.ctx.drawImage(b, 0, 0, Math.floor(n.width * ka), Math.floor(n.height * ka), 0, 0, n.width, n.height); for (var e = 0; e < c.length; e++)A = c[e], 1 > a && "undefined" !== typeof A.startTimePercent ? a >= A.startTimePercent && A.animationCallback(A.easingFunction(a - A.startTimePercent, 0, 1, 1 - A.startTimePercent), A) : A.animationCallback(A.easingFunction(a, 0, 1, 1), A); n.dispatchEvent("dataAnimationIterationEnd", { chart: n }) }, function () {
                                    c = []; for (var a = 0; a < n.plotInfo.plotTypes.length; a++)for (var e =
                                        n.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++)e.plotUnits[d].targetCanvas = null; b = null; n.disableToolTip = !1; n.dispatchEvent("dataAnimationEnd", { chart: n })
                                }); else { if (n._breaksCanvas) if (u) n.plotArea.ctx.drawImage(n._breaksCanvas, 0, 0, this.width, this.height); else for (k = 0; k < n._axes.length; k++)n._axes[k].createMask(); 0 < n._indexLabels.length && n.renderIndexLabels(); n.dispatchEvent("dataAnimationIterationEnd", { chart: n }); n.dispatchEvent("dataAnimationEnd", { chart: n }) } this.attachPlotAreaEventHandlers(); this.zoomEnabled ||
                ...
                }; m.prototype.render = function (a) { a && (this.options = a); this._initialize(); this.setLayout(); this.renderElements(); this._preRenderCanvas = null }; m.prototype.attachPlotAreaEventHandlers = function () { this.attachEvent({ context: this, chart: this, mousedown: this._plotAreaMouseDown, mouseup: this._plotAreaMouseUp, mousemove: this._plotAreaMouseMove, cursor: this.panEnabled ? "move" : "default", capture: !0, bounds: this.plotArea }) }; m.prototype.categoriseDataSeries = function () {
                    for (var a = "", d = 0; d < this.data.length; d++)if (a =
                        this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= m._supportedChartTypes.indexOf(a.type)) {
                            for (var c = null, b = !1, e = null, f = !1, l = 0; l < this.plotInfo.plotTypes.length; l++)if (this.plotInfo.plotTypes[l].type === a.type) { b = !0; c = this.plotInfo.plotTypes[l]; break } b || (c = { type: a.type, totalDataSeries: 0, plotUnits: [] }, this.plotInfo.plotTypes.push(c)); for (l = 0; l < c.plotUnits.length; l++)if (c.plotUnits[l].axisYType === a.axisYType && c.plotUnits[l].axisXType === a.axisXType && c.plotUnits[l].axisYIndex === a.axisYIndex &&
                                c.plotUnits[l].axisXIndex === a.axisXIndex) { f = !0; e = c.plotUnits[l]; break } f || (e = {
                    ...
                    if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        var v = this.data[a.dataSeriesIndexes[l]], A = 0, k = !1, n = !1, p; if ("normal" === v.axisPlacement || "xySwapped" === v.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX &&
                            this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity, g = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (v.dataPoints[A].x && v.dataPoints[A].x.getTime || "dateTime" ===
                                v.xValueType) f = !0; for (A = 0; A < v.dataPoints.length; A++) {
                                "undefined" === typeof v.dataPoints[A].x && (v.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)); v.dataPoints[A].x.getTime ? (f = !0, b = v.dataPoints[A].x.getTime()) : b = v.dataPoints[A].x; e = v.dataPoints[A].y; b < c.min && (c.min = b); b > c.max && (c.max = b); e < d.min && "number" === typeof e && (d.min = e); e > d.max && "number" === typeof e && (d.max = e); if (0 < A) {
                                    if (a.axisX.logarithmic) { var r = b / v.dataPoints[A - 1].x; 1 > r && (r = 1 / r); c.minDiff > r && 1 !== r && (c.minDiff = r) } else r = b - v.dataPoints[A - 1].x, 0 > r &&
                                        (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r); null !== e && null !== v.dataPoints[A - 1].y && (a.axisY.logarithmic ? (r = e / v.dataPoints[A - 1].y, 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e - v.dataPoints[A - 1].y, 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r)))
                                } if (b < q && !k) null !== e && (p = b); else {
                                    if (!k && (k = !0, 0 < A)) { A -= 2; continue } if (b > g && !n) n = !0; else if (b > g && n) continue; v.dataPoints[A].label && (a.axisX.labels[b] = v.dataPoints[A].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === e ? c.viewPortMin ===
                    ...
                    if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], v = [], A = Infinity, k = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                            var p = this.data[a.dataSeriesIndexes[n]], q = 0, g = !1, r = !1, h; if ("normal" === p.axisPlacement ||
                                "xySwapped" === p.axisPlacement) var m = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, t = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ?
                                    this.options.axisX.maximum : Infinity; if (p.dataPoints[q].x && p.dataPoints[q].x.getTime || "dateTime" === p.xValueType) f = !0; for (q = 0; q < p.dataPoints.length; q++) {
                                    "undefined" === typeof p.dataPoints[q].x && (p.dataPoints[q].x = q + (a.axisX.logarithmic ? 1 : 0)); p.dataPoints[q].x.getTime ? (f = !0, b = p.dataPoints[q].x.getTime()) : b = p.dataPoints[q].x; e = s(p.dataPoints[q].y) ? 0 : p.dataPoints[q].y; b < c.min && (c.min = b); b > c.max && (c.max = b); if (0 < q) {
                                        if (a.axisX.logarithmic) {
                                            var x = b / p.dataPoints[q - 1].x; 1 > x && (x = 1 / x); c.minDiff > x && 1 !== x && (c.minDiff =
                                                x)
                                        ...
                                        if (!g && (g = !0, 0 < q)) { q -= 2; continue } if (b > t && !r) r = !0; else if (b > t && r) continue; p.dataPoints[q].label && (a.axisX.labels[b] = p.dataPoints[q].label); b < c.viewPortMin && (c.viewPortMin =
                                            b); b > c.viewPortMax && (c.viewPortMax = b); null === p.dataPoints[q].y ? c.viewPortMin === b && h < b && (c.viewPortMin = h) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l[b] ? l[b] += e : (l[b] = e, A = Math.min(e, A)) : v[b] ? v[b] += e : (v[b] = e, k = Math.max(e, k)))
                                    }
                                        ...
                                        v)) : (d.dataPointYPositiveSums = l, d.dataPointYNegativeSums = v)); p.axisX.valueType = p.xValueType = f ? "dateTime" : "number"
                    ...
                    if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, v = !1, A = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                            var n = this.data[a.dataSeriesIndexes[k]], p = 0, q = !1, g = !1, r; if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var h = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX &&
                                this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, m = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (n.dataPoints[p].x && n.dataPoints[p].x.getTime || "dateTime" === n.xValueType) f = !0; for (p =
                                    ...
                                    "undefined" === typeof n.dataPoints[p].x && (n.dataPoints[p].x = p + (a.axisX.logarithmic ? 1 : 0)); n.dataPoints[p].x.getTime ? (f = !0, b = n.dataPoints[p].x.getTime()) : b = n.dataPoints[p].x; e = s(n.dataPoints[p].y) ? null : n.dataPoints[p].y; b < c.min && (c.min = b); b > c.max && (c.max = b); if (0 < p) {
                                        if (a.axisX.logarithmic) { var t = b / n.dataPoints[p - 1].x; 1 > t && (t = 1 / t); c.minDiff > t && 1 !== t && (c.minDiff = t) } else t = b - n.dataPoints[p - 1].x, 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t); s(e) || null === n.dataPoints[p - 1].y ||
                                        ...
                                        if (!q && (q = !0, 0 < p)) { p -= 2; continue } if (b > m && !g) g = !0; else if (b > m && g) continue; n.dataPoints[p].label && (a.axisX.labels[b] = n.dataPoints[p].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === e ? c.viewPortMin === b && r < b && (c.viewPortMin = r) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] :
                            ...
                            v ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !l && v && (d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)); d.viewPortMin = d.min; d.viewPortMax = d.max; a.dataPointYSums = A
                    }
                    ...
                    if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, v = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
                        ...
                        n = 0, p = !1, q = !1, g, r, h; if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var m = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity, t = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
                            this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (k.dataPoints[n].x && k.dataPoints[n].x.getTime || "dateTime" === k.xValueType) v = !0; for (n = 0; n < k.dataPoints.length; n++) {
                            "undefined" === typeof k.dataPoints[n].x && (k.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0)); k.dataPoints[n].x.getTime ? (v = !0, b = k.dataPoints[n].x.getTime()) : b = k.dataPoints[n].x; if ((e = k.dataPoints[n].y) && e.length) {
                                f = Math.min.apply(null, e); l = Math.max.apply(null, e); r = !0; for (var x =
                                    0; x < e.length; x++)null === e.k && (r = !1); r && (p || (h = g), g = b)
                            } b < c.min && (c.min = b); b > c.max && (c.max = b); f < d.min && (d.min = f); l > d.max && (d.max = l); 0 < n && (a.axisX.logarithmic ? (r = b / k.dataPoints[n - 1].x, 1 > r && (r = 1 / r), c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = b - k.dataPoints[n - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)), e && (null !== e[0] && k.dataPoints[n - 1].y && null !== k.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (r = e[0] / k.dataPoints[n - 1].y[0], 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e[0] - k.dataPoints[n - 1].y[0],
                    ...
                    if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        var v = this.data[a.dataSeriesIndexes[l]], A = 0, k = !1, n = !1, p = b = 0; if ("normal" === v.axisPlacement || "xySwapped" === v.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ?
                                    ...
                                    p = 0 === A ? 0 : v.dataPointEOs[A - 1].cumulativeSum, b = 0) : (e = "number" !== typeof v.dataPoints[A].y ? 0 : v.dataPoints[A].y, v.dataPointEOs[A].cumulativeSumYStartValue = 0 === A ? 0 : v.dataPointEOs[A - 1].cumulativeSum, v.dataPointEOs[A].cumulativeSum = 0 === A ? e : v.dataPointEOs[A - 1].cumulativeSum + e, b += e); for (A = 0; A < v.dataPoints.length; A++)if ("undefined" === typeof v.dataPoints[A].x && (v.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)), v.dataPoints[A].x.getTime ? (f = !0, b = v.dataPoints[A].x.getTime()) : b = v.dataPoints[A].x, e = v.dataPoints[A].y,
                                        b < c.min && (c.min = b), b > c.max && (c.max = b), v.dataPointEOs[A].cumulativeSum < d.min && (d.min = v.dataPointEOs[A].cumulativeSum), v.dataPointEOs[A].cumulativeSum > d.max && (d.max = v.dataPointEOs[A].cumulativeSum), 0 < A && (a.axisX.logarithmic ? (p = b / v.dataPoints[A - 1].x, 1 > p && (p = 1 / p), c.minDiff > p && 1 !== p && (c.minDiff = p)) : (p = b - v.dataPoints[A - 1].x, 0 > p && (p *= -1), c.minDiff > p && 0 !== p && (c.minDiff = p)), null !== e && null !== v.dataPoints[A - 1].y && (a.axisY.logarithmic ? (e = v.dataPointEOs[A].cumulativeSum / v.dataPointEOs[A - 1].cumulativeSum, 1 > e &&
                                            (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = v.dataPointEOs[A].cumulativeSum - v.dataPointEOs[A - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || k) {
                                                if (!k && (k = !0, 0 < A)) { A -= 2; continue } if (b > g && !n) n = !0; else if (b > g && n) continue; v.dataPoints[A].label && (a.axisX.labels[b] = v.dataPoints[A].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); 0 < A && (v.dataPointEOs[A - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = v.dataPointEOs[A - 1].cumulativeSum), v.dataPointEOs[A -
                                                    1].cumulativeSum > d.viewPortMax && (d.viewPortMax = v.dataPointEOs[A - 1].cumulativeSum)); v.dataPointEOs[A].cumulativeSum < d.viewPortMin && (d.viewPortMin = v.dataPointEOs[A].cumulativeSum); v.dataPointEOs[A].cumulativeSum > d.viewPortMax && (d.viewPortMax = v.dataPointEOs[A].cumulativeSum)
                                    } v.axisX.valueType = v.xValueType = f ? "dateTime" : "number"
                    }
                    ...
                    function a(a, b, c, e) {
                        ...
                        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                            var b = a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks, c = a.axisY.scaleBreaks && a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks; if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, k = f.min, l = f.max, n = d.min, p = d.max, f = f._dataRanges,
                                d = d._dataRanges, q, v = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
                                    var h = e.data[a.dataSeriesIndexes[A]]; if (!(4 > h.dataPoints.length)) for (v = 0; v < h.dataPoints.length; v++)if (b && (q = (l + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[v].x.getTime ? h.dataPoints[v].x.getTime() : h.dataPoints[v].x, q = Math.floor((g - k) / q), g < f[q].min && (f[q].min = g), g > f[q].max && (f[q].max = g)), c) {
                                        var m = (p + 1 - n) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100; if ((g = "waterfall" ===
                        ...
                        f =
                        !0; this._axes[l].dataInfo._dataRanges = []; for (var v = 0; v < 100 / Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10); v++)this._axes[l].dataInfo._dataRanges.push({ min: Infinity, max: -Infinity })
                    } if (f) {
                        for (l = 0; l < this.plotInfo.plotTypes.length; l++)for (f = this.plotInfo.plotTypes[l], v = 0; v < f.plotUnits.length; v++)b = f.plotUnits[v], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" ===
                            b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type || "waterfall" === b.type || "error" === b.type || "boxAndWhisker" === b.type ? d(b) : 0 <= b.type.indexOf("stacked") && c(b); for (l = 0; l < this._axes.length; l++)if (this._axes[l].dataInfo._dataRanges) {
                                var A = this._axes[l].dataInfo.min; b = (this._axes[l].dataInfo.max + 1 - A) * Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10) / 100; var k = this._axes[l].dataInfo._dataRanges,
                                    n, p, f = []; if (this._axes[l].dataInfo.dataPointYPositiveSums) { var q = this._axes[l].dataInfo.dataPointYPositiveSums; n = k; for (v in q) if (q.hasOwnProperty(v) && !isNaN(v) && (p = q[v], !s(p))) { var g = Math.floor((p - A) / b); p < n[g].min && (n[g].min = p); p > n[g].max && (n[g].max = p) } delete this._axes[l].dataInfo.dataPointYPositiveSums } if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                                        q = this._axes[l].dataInfo.dataPointYNegativeSums; n = k; for (v in q) q.hasOwnProperty(v) && !isNaN(v) && (p = -1 * q[v], s(p) || (g = Math.floor((p - A) / b), p < n[g].min &&
                                            (n[g].min = p), p > n[g].max && (n[g].max = p))); delete this._axes[l].dataInfo.dataPointYNegativeSums
                                    } for (v = 0; v < k.length - 1; v++)if (n = k[v].max, isFinite(n)) for (; v < k.length - 1;)if (A = k[v + 1].min, isFinite(A)) { p = A - n; p > b && f.push({ diff: p, start: n, end: A }); break } else v++; if (this._axes[l].scaleBreaks.customBreaks) for (v = 0; v < this._axes[l].scaleBreaks.customBreaks.length; v++)for (b = 0; b < f.length; b++)if (this._axes[l].scaleBreaks.customBreaks[v].startValue <= f[b].start && f[b].start <= this._axes[l].scaleBreaks.customBreaks[v].endValue ||
                ...
                }; m.prototype.getObjectAtXY = function (a, d, c) { var b = null; if (c = this.getDataPointAtXY(a, d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (u) b = Ya(a, d, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) { var e = this.legend.items[c]; a >= e.x1 && (a <= e.x2 && d >= e.y1 && d <= e.y2) && (b = e.id) } return b }; m.prototype.getAutoFontSize = lb; m.prototype.resetOverlayedCanvas = function () { this.overlaidCanvasCtx.clearRect(0, 0, this.width, this.height) };
                m.prototype.clearCanvas = kb; m.prototype.attachEvent = function (a) { this._events.push(a) }; m.prototype._touchEventHandler = function (a) {
                ...
                "undefined" === typeof a.target && a.srcElement && (a.target = a.srcElement); var d = Na(a), c = a.type, b, e; a.which ? e = 3 == a.which : a.button && (e = 2 == a.button); m.capturedEventParam && (b = m.capturedEventParam, "mouseup" === c && (m.capturedEventParam = null, b.chart.overlaidCanvas.releaseCapture ? b.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup",
                    ...
                    if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                        var c =
                            d - this.dragStartPoint.y, b = a - this.dragStartPoint.x, e = 0 <= this.zoomType.indexOf("x"), f = 0 <= this.zoomType.indexOf("y"), l = !1; this.resetOverlayedCanvas(); if ("xySwapped" === this.plotInfo.axisPlacement) var v = f, f = e, e = v; if (this.panEnabled || this.zoomEnabled) {
                        ...
                        var c = 0, b = 0, e = c = null, e = 0 <= this.zoomType.indexOf("x"), f = 0 <= this.zoomType.indexOf("y"), l = this; "xySwapped" === this.plotInfo.axisPlacement && (c = f, f = e, e = c); c = this.dragStartPoint.x - a; b = this.dragStartPoint.y - d; 2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled) ? (this.toolTip.hide(), this.toolTip.dispatchEvent("hidden", { chart: this, toolTip: this.toolTip }, this.toolTip)) :
                            this.panEnabled || this.zoomEnabled || this.toolTip.mouseMoveHandler(a, d); if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled)) if (this.panEnabled) e = { x1: e ? this.plotArea.x1 + c : this.plotArea.x1, y1: f ? this.plotArea.y1 + b : this.plotArea.y1, x2: e ? this.plotArea.x2 + c : this.plotArea.x2, y2: f ? this.plotArea.y2 + b : this.plotArea.y2 }, clearTimeout(l._panTimerId), l._panTimerId = setTimeout(function (b, c, e, f) {
                                ...
                                this.resetOverlayedCanvas(); c = this.overlaidCanvasCtx.globalAlpha; this.overlaidCanvasCtx.fillStyle = "#A89896"; var b = e ? this.dragStartPoint.x : this.plotArea.x1, v = f ? this.dragStartPoint.y : this.plotArea.y1, A = e ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, k = f ? d - this.dragStartPoint.y : this.plotArea.y2 - this.plotArea.y1; this.validateRegion(b, v, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !==
                                    this.zoomType).isValid && (this.resetOverlayedCanvas(), this.overlaidCanvasCtx.fillStyle = "#99B2B5"); this.overlaidCanvasCtx.globalAlpha = 0.7; this.overlaidCanvasCtx.fillRect(b, v, A, k); this.overlaidCanvasCtx.globalAlpha = c
                            }
                    ...
                    e) { a = this.validateRegion(a, d, c, b, e); d = a.axesWithValidRange; c = a.axesRanges; if (a.isValid) for (b = 0; b < d.length; b++)e = c[b], d[b].setViewPortRange(e.val1, e.val2), this.syncCharts && "y" != this.zoomType && this.syncCharts(e.val1, e.val2), this.stockChart && (this.stockChart._rangeEventParameter = { stockChart: this.stockChart, source: "chart", index: this.stockChart.charts.indexOf(this), minimum: e.val1, maximum: e.val2 }); return a.isValid }; m.prototype.validateRegion = function (a, d, c, b, e) {
                        e = e || !1; for (var f = 0 <= this.zoomType.indexOf("x"),
                            l = 0 <= this.zoomType.indexOf("y"), v = !1, A = [], k = [], n = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type && f || "axisY" === this._axes[p].type && l) && k.push(this._axes[p]); for (l = 0; l < k.length; l++) {
                                var p = k[l], f = !1, q = p.convertPixelToValue({ x: a, y: d }), g = p.convertPixelToValue({ x: c, y: b }); if (q > g) var r = g, g = q, q = r; if (p.scaleBreaks) for (r = 0; !f && r < p.scaleBreaks._appliedBreaks.length; r++)f = p.scaleBreaks._appliedBreaks[r].startValue <= q && p.scaleBreaks._appliedBreaks[r].endValue >= g; if (isFinite(p.dataInfo.minDiff)) if (r =
                                    p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) && (p.logarithmic && r < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && r < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) A.push(p), n.push({ val1: q, val2: g }), v = !0; else if (!e) { v = !1; break }
                            } return { isValid: v, axesWithValidRange: A, axesRanges: n }
                    }; m.prototype.preparePlotArea = function () {
                        var a = this.plotArea; !u && (0 < a.x1 || 0 < a.y1) && a.ctx.translate(a.x1, a.y1); if ((this.axisX[0] || this.axisX2[0]) &&
                        ...
                        } else d = this.layoutManager.getFreeSpace(), a.x1 = d.x1, a.x2 = d.x2, a.y1 = d.y1, a.y2 = d.y2, a.width = d.width, a.height = d.height; u || (a.canvas.width = a.width, a.canvas.height = a.height, a.canvas.style.left = a.x1 + "px", a.canvas.style.top = a.y1 + "px", (0 < a.x1 || 0 < a.y1) && a.ctx.translate(-a.x1, -a.y1)); a.layoutManager =
                            new Da(a.x1, a.y1, a.x2, a.y2, 2)
                    }; m.prototype.renderIndexLabels = function (a) {
                        var d = a || this.plotArea.ctx, c = this.plotArea, b = 0, e = 0, f = 0, l = f = e = 0, v = 0, A = b = 0, k = 0; for (a = 0; a < this._indexLabels.length; a++) {
                            var n = this._indexLabels[a], p = n.chartType.toLowerCase(), q, g, l = la("indexLabelFontColor", n.dataPoint, n.dataSeries), r = la("indexLabelFontSize", n.dataPoint, n.dataSeries), v = la("indexLabelFontFamily", n.dataPoint, n.dataSeries), A = la("indexLabelFontStyle", n.dataPoint, n.dataSeries), k = la("indexLabelFontWeight", n.dataPoint,
                                n.dataSeries), h = la("indexLabelBackgroundColor", n.dataPoint, n.dataSeries); q = la("indexLabelMaxWidth", n.dataPoint, n.dataSeries); g = la("indexLabelWrap", n.dataPoint, n.dataSeries); var m = la("indexLabelLineDashType", n.dataPoint, n.dataSeries), t = la("indexLabelLineColor", n.dataPoint, n.dataSeries), x = s(n.dataPoint.indexLabelLineThickness) ? s(n.dataSeries.options.indexLabelLineThickness) ? 0 : n.dataSeries.options.indexLabelLineThickness : n.dataPoint.indexLabelLineThickness, b = 0 < x ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ?
                                    this.plotArea.height : this.plotArea.width) << 0) : 0, E = { percent: null, total: null }, B = null; if (0 <= n.dataSeries.type.indexOf("stacked") || "pie" === n.dataSeries.type || "doughnut" === n.dataSeries.type) E = this.getPercentAndTotal(n.dataSeries, n.dataPoint); if (n.dataSeries.indexLabelFormatter || n.dataPoint.indexLabelFormatter) B = { chart: this, dataSeries: n.dataSeries, dataPoint: n.dataPoint, index: n.indexKeyword, total: E.total, percent: E.percent }; var C = n.dataPoint.indexLabelFormatter ? n.dataPoint.indexLabelFormatter(B) : n.dataPoint.indexLabel ?
                                        this.replaceKeywordsWithValue(n.dataPoint.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : n.dataSeries.indexLabelFormatter ? n.dataSeries.indexLabelFormatter(B) : n.dataSeries.indexLabel ? this.replaceKeywordsWithValue(n.dataSeries.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : null; if (null !== C && "" !== C) {
                                            var E = la("indexLabelPlacement", n.dataPoint, n.dataSeries), B = la("indexLabelOrientation", n.dataPoint, n.dataSeries), z = la("indexLabelTextAlign", n.dataPoint, n.dataSeries), w = n.direction, e = n.dataSeries.axisX,
                                            f = n.dataSeries.axisY, y = !1, h = new ia(d, { x: 0, y: 0, maxWidth: q ? q : 0.5 * this.width, maxHeight: g ? 5 * r : 1.5 * r, angle: "horizontal" === B ? 0 : -90, text: C, padding: 0, backgroundColor: h, textAlign: z, fontSize: r, fontFamily: v, fontWeight: k, fontColor: l, fontStyle: A, textBaseline: "middle" }); h.measureText(); n.dataSeries.indexLabelMaxWidth = h.maxWidth; if ("stackedarea100" === p) { if (n.point.x < c.x1 || n.point.x > c.x2 || n.point.y < c.y1 - 1 || n.point.y > c.y2 + 1) continue } else if ("rangearea" === p || "rangesplinearea" === p) {
                                                ...
                                                e.viewportMaximum) continue; l = v = 2; "horizontal" === B ? (A = h.width, k = h.height) : (k = h.width, A = h.height); if ("normal" === this.plotInfo.axisPlacement) {
                                                    if (0 <= p.indexOf("line") || 0 <= p.indexOf("area")) E = "auto", v = 4; else if (0 <= p.indexOf("stacked")) "auto" === E && (E = "inside"); else if ("bubble" === p || "scatter" === p) E = "inside"; q = n.point.x - ("horizontal" === B ? A / 2 : A / 2 - r / 2); "inside" !== E ? (e = c.y1, f = c.y2, 0 < w ? (g = n.point.y + ("horizontal" === B ? r / 2 : 0) - k - v - b, g < e && (g = "auto" === E ? Math.max(n.point.y, e) + r / 2 + v : e + r / 2 + v, y = g + k > n.point.y)) : (g = n.point.y +
                        ...
                        var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var b = this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var f = [], l, v = 0; v < a.dataSeriesIndexes.length; v++) {
                                var A = a.dataSeriesIndexes[v], k = this.data[A]; c.lineWidth = k.lineThickness; var n = k.dataPoints, p = "solid"; if (c.setLineDash) {
                                    var q = N(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType,
                                    g = N(p, k.lineThickness); c.setLineDash(g)
                            ...
                            var b = this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var f = [], l, v = 0; v < a.dataSeriesIndexes.length; v++) {
                                var A = a.dataSeriesIndexes[v], k = this.data[A]; c.lineWidth = k.lineThickness; var n = k.dataPoints, p = "solid"; if (c.setLineDash) {
                                    var q = N(k.nullDataLineDashType,
                                        k.lineThickness), p = k.lineDashType, g = N(p, k.lineThickness); c.setLineDash(g)
                                } var r = k.id; this._eventManager.objectMap[r] = { objectType: "dataSeries", dataSeriesIndex: A }; r = Q(r); b.strokeStyle = r; b.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0; var r = k._colorSet, h = r = k.lineColor = k.options.lineColor ? k.options.lineColor : r[0]; c.strokeStyle = r; var m = !0, t = 0, x, s; c.beginPath(); if (0 < n.length) {
                        ...
                        function d(a) {
                            a = w(a, 2); if (0 < a.length) {
                                b.beginPath(); u && e.beginPath(); b.moveTo(a[0].x, a[0].y); a[0].newStrokeStyle && (b.strokeStyle = a[0].newStrokeStyle); a[0].newLineDashArray && b.setLineDash(a[0].newLineDashArray); u && e.moveTo(a[0].x, a[0].y); for (var c = 0; c < a.length - 3; c += 3)if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c +
                            ...
                            var e =
                                this._eventManager.ghostCtx; b.save(); var f = this.plotArea; b.beginPath(); b.rect(f.x1, f.y1, f.width, f.height); b.clip(); for (var l = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
                                    var A = a.dataSeriesIndexes[v], k = this.data[A]; b.lineWidth = k.lineThickness; var n = k.dataPoints, p = "solid"; if (b.setLineDash) { var q = N(k.nullDataLineDashType, k.lineThickness), p = k.lineDashType, g = N(p, k.lineThickness); b.setLineDash(g) } var r = k.id; this._eventManager.objectMap[r] = { objectType: "dataSeries", dataSeriesIndex: A }; r = Q(r); e.strokeStyle = r; e.lineWidth =
                                    ...
                                    n < f) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f)); p < f && (p = f); p > n && (p = n); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                                        var q = a.dataSeriesIndexes[n], g = this.data[q], r = g.dataPoints; if (0 < r.length) for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f =
                                            0; f < r.length; f++)if (r[f].getTime ? A = r[f].x.getTime() : A = r[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                                                l = a.axisX.convertValueToPixel(A); v = a.axisY.convertValueToPixel(r[f].y); l = a.axisX.reversed ? l + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + n) * p << 0 : l - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount + n) * p << 0; var m = a.axisX.reversed ? l - p << 0 : l + p << 0, t; 0 <= r[f].y ? t = k : (t = v, v = k); v > t && (b = v, v = t, t = b); b = r[f].color ? r[f].color : g._colorSet[f % g._colorSet.length];
                                                ca(c, l, v, m, t, b, 0, null, h && 0 <= r[f].y, 0 > r[f].y && h, !1, !1, g.fillOpacity); b = g.dataPointIds[f]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: v, x2: m, y2: t }; b = Q(b); u && ca(this._eventManager.ghostCtx, l, v, m, t, b, 0, null, !1, !1, !1, !1); (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                                    chartType: "column", dataPoint: r[f], dataSeries: g, point: { x: l + (m - l) / 2, y: 0 > r[f].y === a.axisY.reversed ? v : t }, direction: 0 > r[f].y ===
                                                        a.axisY.reversed ? 1 : -1, bounds: { x1: l, y1: Math.min(v, t), x2: m, y2: Math.max(v, t) }, color: b
                                                })
                                            }
                                        ...
                                        var h =
                                            a.dataSeriesIndexes[r], m = this.data[h], t = m.dataPoints; if (0 < t.length) {
                                                var x = 5 < g && m.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (k = 0; k < t.length; k++)if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                                    n = a.axisX.convertValueToPixel(b); var s = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, B = s + g << 0, C; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) v[b] = t[k].y + (v[b] ? v[b] :
                                                    ...
                                                    ca(c, s, p, B, C, b, 0, null, x && 0 <= t[k].y, 0 > t[k].y && x, !1, !1, m.fillOpacity); b = m.dataPointIds[k]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: s, y1: p, x2: B, y2: C }; b = Q(b); u && ca(this._eventManager.ghostCtx, s, p, B, C, b, 0, null, !1, !1, !1, !1); (t[k].indexLabel || m.indexLabel || t[k].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                                                        chartType: "stackedColumn", dataPoint: t[k], dataSeries: m, point: { x: n, y: 0 <= t[k].y ? p : C }, direction: 0 > t[k].y === a.axisY.reversed ?
                                                            1 : -1, bounds: { x1: s, y1: Math.min(p, C), x2: B, y2: Math.max(p, C) }, color: b
                                                    })
                                                }
                                            }
                                    } u && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
                                ...
                                k > n && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < k) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k)); g < k && (g = k); g > n && (g = n); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                                    var h =
                                        a.dataSeriesIndexes[r], m = this.data[h], t = m.dataPoints; if (0 < t.length) for (var x = 5 < g && m.bevelEnabled ? !0 : !1, k = 0; k < t.length; k++)if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                            n = a.axisX.convertValueToPixel(b); p = 0 !== a.dataPointYSums[b] ? 100 * (t[k].y / a.dataPointYSums[b]) : 0; var s = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, B = s + g << 0, C; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                        ...
                        var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var b = null, e = this.plotArea, f = [], l = [], v = [], A = [], k = 0, n, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; p = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.height <<
                                0; var g = a.axisX.dataInfo.minDiff; isFinite(g) || (g = 0.3 * Math.abs(a.axisX.range)); g = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(g) / Math.log(a.axisX.range) : Math.abs(g) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && k > p && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, p)); !this.dataPointMaxWidth && (this.dataPointMinWidth && p < k) && (p = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k)); g <
                                    k && (g = k); g > p && (g = p); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                                        var h = a.dataSeriesIndexes[r], m = this.data[h], t = m.dataPoints; if (0 < t.length) {
                                            var x = 5 < g && m.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (k = 0; k < t.length; k++)if (b = t[k].x.getTime ? t[k].x.getTime() :
                                                t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                                    p = a.axisX.convertValueToPixel(b); var s = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, B = s + g << 0, C; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) v[b] = t[k].y + (v[b] ? v[b] : 0), 0 < v[b] && (C = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(v[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) A[b] = t[k].y + (A[b] ? A[b] : 0), n = l[b] ?
                                                        l[b] : q, l[b] = C = a.axisY.convertValueToPixel(A[b]); else if (n = a.axisY.convertValueToPixel(t[k].y), 0 <= t[k].y) { var z = f[b] ? f[b] : 0; C = q + z; n += z; f[b] = z + (n - C) } else z = l[b] ? l[b] : 0, C = n - z, n = q - z, l[b] = z + (n - C); b = t[k].color ? t[k].color : m._colorSet[k % m._colorSet.length]; ca(c, C, s, n, B, b, 0, null, x, !1, !1, !1, m.fillOpacity); b = m.dataPointIds[k]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: C, y1: s, x2: n, y2: B }; b = Q(b); u && ca(this._eventManager.ghostCtx, C, s, n, B, b, 0, null, !1, !1, !1,
                                                            !1); (t[k].indexLabel || m.indexLabel || t[k].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: t[k], dataSeries: m, point: { x: 0 <= t[k].y ? n : C, y: p }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(C, n), y1: s, x2: Math.max(C, n), y2: B }, color: b })
                                            }
                                        }
                        ...
                        var d =
                            a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                                ...
                                c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                                    var h = a.dataSeriesIndexes[r], m = this.data[h], t = m.dataPoints; if (0 < t.length) {
                                        var s = 5 < g && m.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (k = 0; k < t.length; k++)if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                            "number" === typeof t[k].y) {
                                                p = a.axisX.convertValueToPixel(b); var E; E = 0 !== a.dataPointYSums[b] ? 100 * (t[k].y / a.dataPointYSums[b]) : 0; var B = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, C = B + g << 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) { v[b] = E + (v[b] ? v[b] : 0); if (0 >= v[b]) continue; E = f[b] ? f[b] : q; f[b] = n = a.axisY.convertValueToPixel(v[b]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) A[b] = E + (A[b] ? A[b] : 0), n = l[b] ? l[b] :
                                                    ...
                                                    }; b = Q(b); u && ca(this._eventManager.ghostCtx, E, B, n, C, b, 0, null, !1, !1, !1, !1); (t[k].indexLabel || m.indexLabel || t[k].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: t[k], dataSeries: m, point: { x: 0 <= t[k].y ? n : E, y: p }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(E, n), y1: B, x2: Math.max(E, n), y2: C }, color: b })
                                        }
                                    }
                        ...
                        var d, c; function b() { C && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? B = E : 0 > a.axisY.viewportMaximum ? B = v.y1 : 0 < a.axisY.viewportMinimum && (B = E), f.lineTo(m, B), f.lineTo(C.x, B), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, u && (l.lineTo(m, B), l.lineTo(C.x, B), l.closePath(), l.fill()), f.beginPath(), f.moveTo(m, t), l.beginPath(), l.moveTo(m, t), C = { x: m, y: t }) }
                        var e = a.targetCanvasCtx || this.plotArea.ctx, f = u ? this._preRenderCtx : e; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var l = this._eventManager.ghostCtx, v = a.axisY.lineCoordinates, A = [], k = this.plotArea, n; f.save(); u && l.save(); f.beginPath(); f.rect(k.x1, k.y1, k.width, k.height); f.clip(); u && (l.beginPath(), l.rect(k.x1, k.y1, k.width, k.height), l.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                                        ...
                                        s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja))) if ("number" !== typeof r[h].y) g.connectNullData || (ja || d) || b(), ja = !0; else {
                                            m = a.axisX.convertValueToPixel(s); t = a.axisY.convertValueToPixel(r[h].y); d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(), f.moveTo(n.x, n.y), m = d, t = c, C = n, c = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(m, t), u && l.lineTo(m, t)) : (f.beginPath(), f.moveTo(m, t), u &&
                                                (l.beginPath(), l.moveTo(m, t)), C = { x: m, y: t }), ja = d = !1) : (f.lineTo(m, t), u && l.lineTo(m, t), 0 == h % 250 && b()); n = { x: m, y: t }; h < r.length - 1 && (y !== (r[h].lineColor || w) || c !== (r[h].lineDashType || g.lineDashType)) && (b(), y = r[h].lineColor || w, f.strokeStyle = y, f.setLineDash && (r[h].lineDashType ? (c = r[h].lineDashType, f.setLineDash(N(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(P)))); var aa = g.dataPointIds[h]; this._eventManager.objectMap[aa] = { id: aa, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: m, y1: t }; 0 !==
                                                    r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(h, m, t, f), A.push(s), aa = Q(aa), u && A.push({ x: m, y: t, ctx: l, type: s.type, size: s.size, color: aa, borderColor: aa, borderThickness: s.borderThickness })); (r[h].indexLabel || g.indexLabel || r[h].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: r[h], dataSeries: g, point: { x: m, y: t }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, color: z })
                                        } b(); W.drawMarkers(A)
                                }
                        ...
                        function d() {
                            var c = w(s, 2); if (0 < c.length) {
                                ...
                                } b.beginPath(); b.moveTo(c[0].x, c[0].y); u && (e.beginPath(), e.moveTo(c[0].x, c[0].y)); for (d = 0; d < c.length - 3; d += 3)b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), u && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y); a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ?
                                    m = h : 0 > a.axisY.viewportMaximum ? m = f.y1 : 0 < a.axisY.viewportMinimum && (m = h); t = { x: c[0].x, y: c[0].y }; b.lineTo(c[c.length - 1].x, m); b.lineTo(t.x, m); b.closePath(); b.globalAlpha = n.fillOpacity; b.fill(); b.globalAlpha = 1; u && (e.lineTo(c[c.length - 1].x, m), e.lineTo(t.x, m), e.closePath(), e.fill())
                            }
                        } var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var e = this._eventManager.ghostCtx, f = a.axisY.lineCoordinates, l = [], v = this.plotArea; b.save(); u && e.save(); b.beginPath(); b.rect(v.x1,
                                v.y1, v.width, v.height); b.clip(); u && (e.beginPath(), e.rect(v.x1, v.y1, v.width, v.height), e.clip()); for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                                                    ...
                                                    g = a.axisX.convertValueToPixel(g); r = a.axisY.convertValueToPixel(p[q].y); var S = n.dataPointIds[q]; this._eventManager.objectMap[S] = { id: S, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: q, x1: g, y1: r }; s[s.length] = { x: g, y: r }; q < p.length - 1 && (C !== (p[q].lineColor || B) || z !== (p[q].lineDashType || n.lineDashType)) && (C = p[q].lineColor || B, s[s.length - 1].newStrokeStyle = C, b.setLineDash && (p[q].lineDashType ? (z = p[q].lineDashType, s[s.length -
                                                        1].newLineDashArray = N(z, n.lineThickness)) : (z = n.lineDashType, s[s.length - 1].newLineDashArray = D))); if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < n.markerSize)) { var P = n.getMarkerProperties(q, g, r, b); l.push(P); S = Q(S); u && l.push({ x: g, y: r, ctx: e, type: P.type, size: P.size, color: S, borderColor: S, borderThickness: P.borderThickness }) } (p[q].indexLabel || n.indexLabel || p[q].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
                                                            chartType: "splineArea", dataPoint: p[q], dataSeries: n, point: { x: g, y: r }, direction: 0 >
                                                                p[q].y === a.axisY.reversed ? 1 : -1, color: E
                                                        }); r = !1
                                            } d(); W.drawMarkers(l)
                                    }
                        ...
                        var d, c; function b() {
                            ...
                            var l = this._eventManager.ghostCtx, v = a.axisY.lineCoordinates, A = [], k = this.plotArea, n; f.save(); u && l.save(); f.beginPath(); f.rect(k.x1, k.y1, k.width, k.height); f.clip(); u && (l.beginPath(), l.rect(k.x1, k.y1, k.width, k.height), l.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                                ...
                                g = this.data[q], r = g.dataPoints, A = g.id; this._eventManager.objectMap[A] = { objectType: "dataSeries", dataSeriesIndex: q }; A = Q(A); l.fillStyle = A; A = []; d = !0; var h = 0, m, t, s, E = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), B, C = null; c = !1; if (0 < r.length) {
                                    var z = g._colorSet[h % g._colorSet.length], w = g.lineColor = g.options.lineColor || z, y = w; f.fillStyle = z; f.strokeStyle = w; f.lineWidth = g.lineThickness; var S = "solid"; if (f.setLineDash) {
                                        ...
                                        var aa = t; "number" !== typeof r[h].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(s), t = a.axisY.convertValueToPixel(r[h].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || S === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(),
                                            f.moveTo(n.x, n.y), m = d, t = c, C = n, S = g.nullDataLineDashType, f.setLineDash(P)), f.lineTo(m, aa), f.lineTo(m, t), u && (l.lineTo(m, aa), l.lineTo(m, t))) : (f.beginPath(), f.moveTo(m, t), u && (l.beginPath(), l.moveTo(m, t)), C = { x: m, y: t }), c = d = !1) : (f.lineTo(m, aa), u && l.lineTo(m, aa), f.lineTo(m, t), u && l.lineTo(m, t), 0 == h % 250 && b()), n = { x: m, y: t }, h < r.length - 1 && (y !== (r[h].lineColor || w) || S !== (r[h].lineDashType || g.lineDashType)) && (b(), y = r[h].lineColor || w, f.strokeStyle = y, f.setLineDash && (r[h].lineDashType ? (S = r[h].lineDashType, f.setLineDash(N(S,
                                                g.lineThickness))) : (S = g.lineDashType, f.setLineDash(D)))), s = g.dataPointIds[h], this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: m, y1: t }, 0 !== r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (aa = g.getMarkerProperties(h, m, t, f), A.push(aa), s = Q(s), u && A.push({ x: m, y: t, ctx: l, type: aa.type, size: aa.size, color: s, borderColor: s, borderThickness: aa.borderThickness })), (r[h].indexLabel || g.indexLabel || r[h].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                                    chartType: "stepArea",
                                                    dataPoint: r[h], dataSeries: g, point: { x: m, y: t }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, color: z
                                                }))
                                    } b(); W.drawMarkers(A)
                                }
                        ...
                        function d() { if (!(1 > k.length)) { for (0 < z.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop(); b.lineTo(a.x, a.y); u && s.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = z.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); u && (s.closePath(), s.fill(), s.beginPath()); k = [] } } var c =
                            a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                                var e = null, f = null, l = [], v = this.plotArea, h = [], k = [], n = [], p = [], q = 0, g, r, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx, t, x, E; u && s.beginPath(); b.save(); u && s.save(); b.beginPath(); b.rect(v.x1, v.y1, v.width, v.height); b.clip(); u && (s.beginPath(), s.rect(v.x1, v.y1, v.width, v.height), s.clip()); for (var e = [], B = 0; B < a.dataSeriesIndexes.length; B++) {
                                    ...
                                    z = this.data[C], w = z.dataPoints; z.dataPointIndexes = []; for (q = 0; q < w.length; q++)C = w[q].x.getTime ? w[q].x.getTime() : w[q].x, z.dataPointIndexes[C] = q, e[C] || (n.push(C), e[C] = !0); n.sort(Pa)
                                } for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                                    C = a.dataSeriesIndexes[B]; z = this.data[C]; w = z.dataPoints; x = !0; k = []; q = z.id; this._eventManager.objectMap[q] = { objectType: "dataSeries", dataSeriesIndex: C }; q = Q(q); s.fillStyle = q; if (0 < n.length) {
                                        var e = z._colorSet[0], y = z.lineColor = z.options.lineColor || e, S = y; b.fillStyle = e; b.strokeStyle = y; b.lineWidth =
                                            z.lineThickness; E = "solid"; if (b.setLineDash) { var P = N(z.nullDataLineDashType, z.lineThickness); E = z.lineDashType; var D = N(E, z.lineThickness); b.setLineDash(D) } for (var aa = !0, q = 0; q < n.length; q++) {
                                                var f = n[q], fa = null, fa = 0 <= z.dataPointIndexes[f] ? w[z.dataPointIndexes[f]] : { x: f, y: null }; if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa))) if ("number" !== typeof fa.y) z.connectNullData || (aa || x) || d(), aa = !0; else {
                                            ...
                                            } d(); b.moveTo(g, r); u && s.moveTo(g, r)
                                    } delete z.dataPointIndexes
                                } W.drawMarkers(l); u && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height),
                                    this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(v.x1, v.y1, v.width, v.height), s.restore()); b.restore(); return { source: c, dest: this.plotArea.ctx, animationCallback: L.xClipAnimation, easingFunction: L.easing.linear, animationBase: 0 }
                            }
                    }; m.prototype.renderStackedArea100 = function (a) {
                        function d() {
                            for (0 < z.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop(); b.lineTo(a.x, a.y); u && E.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = z.fillOpacity; b.fill();
                            b.globalAlpha = 1; b.beginPath(); u && (E.closePath(), E.fill(), E.beginPath()); k = []
                        } var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var e = null, f = null, l = this.plotArea, v = [], h = [], k = [], n = [], p = [], q = 0, g, r, m, s, t, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), E = this._eventManager.ghostCtx; b.save(); u && E.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height); b.clip(); u && (E.beginPath(), E.rect(l.x1, l.y1, l.width, l.height), E.clip());
                            for (var e = [], B = 0; B < a.dataSeriesIndexes.length; B++) { var w = a.dataSeriesIndexes[B], z = this.data[w], y = z.dataPoints; z.dataPointIndexes = []; for (q = 0; q < y.length; q++)w = y[q].x.getTime ? y[q].x.getTime() : y[q].x, z.dataPointIndexes[w] = q, e[w] || (n.push(w), e[w] = !0); n.sort(Pa) } for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                                w = a.dataSeriesIndexes[B]; z = this.data[w]; y = z.dataPoints; s = !0; e = z.id; this._eventManager.objectMap[e] = { objectType: "dataSeries", dataSeriesIndex: w }; e = Q(e); E.fillStyle = e; k = []; if (0 < n.length) {
                                    var e = z._colorSet[q %
                                        z._colorSet.length], D = z.lineColor = z.options.lineColor || e, S = D; b.fillStyle = e; b.strokeStyle = D; b.lineWidth = z.lineThickness; t = "solid"; if (b.setLineDash) { var P = N(z.nullDataLineDashType, z.lineThickness); t = z.lineDashType; var F = N(t, z.lineThickness); b.setLineDash(F) } for (var aa = !0, q = 0; q < n.length; q++) {
                                            var f = n[q], fa = null, fa = 0 <= z.dataPointIndexes[f] ? y[z.dataPointIndexes[f]] : { x: f, y: null }; if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa))) if ("number" !== typeof fa.y) z.connectNullData ||
                                                (aa || s) || d(), aa = !0; else {
                                                    var ma; ma = 0 !== a.dataPointYSums[f] ? 100 * (fa.y / a.dataPointYSums[f]) : 0; g = a.axisX.convertValueToPixel(f); var ba = h[f] ? h[f] : 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { p[f] = ma + (p[f] ? p[f] : 0); if (0 >= p[f] && a.axisY.logarithmic) continue; r = a.axisY.convertValueToPixel(p[f]) } else r = a.axisY.convertValueToPixel(ma), r -= ba; k.push({ x: g, y: x - ba }); h[f] = x - r; s || aa ? (!s && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || t === z.lineDashType &&
                                                        z.lineDashType !== z.nullDataLineDashType) && (s = k.pop(), t = k[k.length - 1], d(), b.moveTo(m.x, m.y), k.push(t), k.push(s), t = z.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g, r), u && E.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), u && (E.beginPath(), E.moveTo(g, r))), aa = s = !1) : (b.lineTo(g, r), u && E.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), u && E.moveTo(g, r), k.push({ x: g, y: x - ba }))); m = { x: g, y: r }; q < y.length - 1 && (S !== (y[q].lineColor || D) || t !== (y[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({
                                                            x: g, y: x -
                                                                ba
                                        ...
                                        } d(); b.moveTo(g, r); u && E.moveTo(g, r)
                                } delete z.dataPointIndexes
                            } W.drawMarkers(v); u && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation =
                                "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), E.restore()); b.restore(); return { source: c, dest: this.plotArea.ctx, animationCallback: L.xClipAnimation, easingFunction: L.easing.linear, animationBase: 0 }
                        }
                                ...
                                var b = this.plotArea, e = 0, f, l; c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(b.x1, b.y1, b.width, b.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var v = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)for (var n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints,
                                    g = 0, e = 0; e < q.length; e++)f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (g = q[e].z, g > v && (v = g), g < h && (h = g)); for (var r = 25 * Math.PI, m = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, r), k = 0; k < a.dataSeriesIndexes.length; k++)if (n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, 0 < q.length) for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                        f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                                            f = a.axisX.convertValueToPixel(f); l = a.axisY.convertValueToPixel(q[e].y); var g = q[e].z, s = 2 * Math.max(Math.sqrt((v === h ? m / 2 : r + (m - r) / (v - h) * (g - h)) / Math.PI) << 0, 1), g = p.getMarkerProperties(e, c); g.size = s; c.globalAlpha = p.fillOpacity; W.drawMarker(f, l, c, g.type, g.size, g.color, g.borderColor, g.borderThickness); c.globalAlpha = 1; var t = p.dataPointIds[e]; this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: e, x1: f, y1: l, size: s };
                                        s = Q(t); u && W.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, s, s, g.borderThickness); (q[e].indexLabel || p.indexLabel || q[e].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({ chartType: "bubble", dataPoint: q[e], dataSeries: p, point: { x: f, y: l }, direction: 1, bounds: { x1: f - g.size / 2, y1: l - g.size / 2, x2: f + g.size / 2, y2: l + g.size / 2 }, color: null })
                                    } u && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas,
                        ...
                        c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var b = this.plotArea, e = 0, f, l; c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(b.x1, b.y1, b.width, b.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var v = 0; v < a.dataSeriesIndexes.length; v++) {
                                var h = a.dataSeriesIndexes[v], k = this.data[h], n = k.dataPoints; if (0 < n.length) {
                        ...
                        var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d, b = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var e = null, f = null, l = this.plotArea, v = 0, h, k, n, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ?
                                this.dataPointWidth : 0.015 * this.width, r = a.axisX.dataInfo.minDiff; isFinite(r) || (r = 0.3 * Math.abs(a.axisX.range)); r = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * l.width * (a.axisX.logarithmic ? Math.log(r) / Math.log(a.axisX.range) : Math.abs(r) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e > f && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, f)); !this.dataPointMaxWidth && (this.dataPointMinWidth && f < e) && (f = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); r <
                                    e && (r = e); r > f && (r = f); c.save(); u && b.save(); c.beginPath(); c.rect(l.x1, l.y1, l.width, l.height); c.clip(); u && (b.beginPath(), b.rect(l.x1, l.y1, l.width, l.height), b.clip()); for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                                        var w = a.dataSeriesIndexes[m], t = this.data[w], x = t.dataPoints; if (0 < x.length) for (var E = 5 < r && t.bevelEnabled ? !0 : !1, v = 0; v < x.length; v++)if (x[v].getTime ? g = x[v].x.getTime() : g = x[v].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[v].y) && x[v].y.length && "number" === typeof x[v].y[0] &&
                                            "number" === typeof x[v].y[1] && "number" === typeof x[v].y[2] && "number" === typeof x[v].y[3]) {
                                                h = a.axisX.convertValueToPixel(g); k = a.axisY.convertValueToPixel(x[v].y[0]); n = a.axisY.convertValueToPixel(x[v].y[1]); p = a.axisY.convertValueToPixel(x[v].y[2]); q = a.axisY.convertValueToPixel(x[v].y[3]); var B = h - r / 2 << 0, C = B + r << 0, f = t.options.fallingColor ? t.fallingColor : t._colorSet[0], e = x[v].color ? x[v].color : t._colorSet[0], z = Math.round(Math.max(1, 0.15 * r)), y = 0 === z % 2 ? 0 : 0.5, D = t.dataPointIds[v]; this._eventManager.objectMap[D] =
                            ...
                            l = 0, v, h, k, n, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, r = a.axisX.dataInfo.minDiff; isFinite(r) || (r = 0.3 * Math.abs(a.axisX.range)); r = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * f.width * (a.axisX.logarithmic ? Math.log(r) / Math.log(a.axisX.range) : Math.abs(r) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e >
                                l && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l)); !this.dataPointMaxWidth && (this.dataPointMinWidth && l < e) && (l = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); r < e && (r = e); r > l && (r = l); c.save(); u && b.save(); c.beginPath(); c.rect(f.x1, f.y1, f.width, f.height); c.clip(); u && (b.beginPath(), b.rect(f.x1, f.y1, f.width, f.height), b.clip()); for (var m = !1, m = !!a.axisY.reversed, w = 0; w < a.dataSeriesIndexes.length; w++) {
                                    ...
                                    if (0 < E.length) for (var B = 5 < r && x.bevelEnabled ? !0 : !1, l = 0; l < E.length; l++)if (E[l].getTime ? g = E[l].x.getTime() : g = E[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(E[l].y) && E[l].y.length && "number" === typeof E[l].y[0] && "number" === typeof E[l].y[1] && "number" === typeof E[l].y[2] && "number" === typeof E[l].y[3] && "number" === typeof E[l].y[4] && 5 === E[l].y.length) {
                                        v = a.axisX.convertValueToPixel(g); h = a.axisY.convertValueToPixel(E[l].y[0]); k = a.axisY.convertValueToPixel(E[l].y[1]); n = a.axisY.convertValueToPixel(E[l].y[2]);
                                        p = a.axisY.convertValueToPixel(E[l].y[3]); q = a.axisY.convertValueToPixel(E[l].y[4]); var C = v - r / 2 << 0, z = v + r / 2 << 0, e = E[l].color ? E[l].color : x._colorSet[0], y = Math.round(Math.max(1, 0.15 * r)), D = 0 === y % 2 ? 0 : 0.5, S = E[l].whiskerColor ? E[l].whiskerColor : E[l].color ? x.whiskerColor ? x.whiskerColor : E[l].color : x.whiskerColor ? x.whiskerColor : e, P = "number" === typeof E[l].whiskerThickness ? E[l].whiskerThickness : "number" === typeof x.options.whiskerThickness ? x.whiskerThickness : y, F = E[l].whiskerDashType ? E[l].whiskerDashType : x.whiskerDashType,
                                            aa = s(E[l].whiskerLength) ? s(x.options.whiskerLength) ? r : x.whiskerLength : E[l].whiskerLength, aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= r ? r : aa : "string" === typeof aa ? parseInt(aa) * r / 100 > r ? r : parseInt(aa) * r / 100 : r, fa = 1 === Math.round(P) % 2 ? 0.5 : 0, ma = E[l].stemColor ? E[l].stemColor : E[l].color ? x.stemColor ? x.stemColor : E[l].color : x.stemColor ? x.stemColor : e, ba = "number" === typeof E[l].stemThickness ? E[l].stemThickness : "number" === typeof x.options.stemThickness ? x.stemThickness : y, G = 1 === Math.round(ba) % 2 ? 0.5 : 0, H = E[l].stemDashType ? E[l].stemDashType :
                                                x.stemDashType, J = E[l].lineColor ? E[l].lineColor : E[l].color ? x.lineColor ? x.lineColor : E[l].color : x.lineColor ? x.lineColor : e, M = "number" === typeof E[l].lineThickness ? E[l].lineThickness : "number" === typeof x.options.lineThickness ? x.lineThickness : y, T = E[l].lineDashType ? E[l].lineDashType : x.lineDashType, K = 1 === Math.round(M) % 2 ? 0.5 : 0, R = x.upperBoxColor, xa = x.lowerBoxColor, sa = s(x.options.fillOpacity) ? 1 : x.fillOpacity, O = x.dataPointIds[l]; this._eventManager.objectMap[O] = {
                                                    id: O, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: l,
                                                    x1: C, y1: h, x2: z, y2: k, x3: v, y3: n, x4: v, y4: p, y5: q, borderThickness: y, color: e, stemThickness: ba, stemColor: ma, whiskerThickness: P, whiskerLength: aa, whiskerColor: S, lineThickness: M, lineColor: J
                                                }; c.save(); 0 < ba && (c.beginPath(), c.strokeStyle = ma, c.lineWidth = ba, c.setLineDash && c.setLineDash(N(H, ba)), c.moveTo(v - G, k), c.lineTo(v - G, h), c.stroke(), c.moveTo(v - G, p), c.lineTo(v - G, n), c.stroke()); c.restore(); b.lineWidth = Math.max(y, 4); c.beginPath(); ca(c, C, Math.min(q, k), z, Math.max(k, q), xa, 0, e, m ? B : !1, m ? !1 : B, !1, !1, sa); c.beginPath();
                        ...
                        var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                            var b = null, e = this.plotArea, f = 0, l, v, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
                                    ...
                                    (this.dataPointMinWidth && l < f) && (l = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f)); k < f && (k = f); k > l && (k = l); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                                        var p = a.dataSeriesIndexes[n], q = this.data[p], g = q.dataPoints; if (0 < g.length) for (var r =
                                            5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                                                b = a.axisX.convertValueToPixel(h); l = a.axisY.convertValueToPixel(g[f].y[0]); v = a.axisY.convertValueToPixel(g[f].y[1]); var m = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + n) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount +
                                                    n) * k << 0, w = a.axisX.reversed ? m - k << 0 : m + k << 0, b = g[f].color ? g[f].color : q._colorSet[f % q._colorSet.length]; if (l > v) { var t = l; l = v; v = t } t = q.dataPointIds[f]; this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: f, x1: m, y1: l, x2: w, y2: v }; ca(c, m, l, w, v, b, 0, b, r, r, !1, !1, q.fillOpacity); b = Q(t); u && ca(this._eventManager.ghostCtx, m, l, w, v, b, 0, null, !1, !1, !1, !1); if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({
                                                        chartType: "rangeColumn",
                                                        dataPoint: g[f], dataSeries: q, indexKeyword: 0, point: { x: m + (w - m) / 2, y: g[f].y[1] >= g[f].y[0] ? v : l }, direction: g[f].y[1] >= g[f].y[0] ? -1 : 1, bounds: { x1: m, y1: Math.min(l, v), x2: w, y2: Math.max(l, v) }, color: b
                        ...
                        function (a) {
                            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d, b = a.axisY._position ? "left" === a.axisY._position || "right" === a.axisY._position ? !1 : !0 : !1; if (!(0 >= a.dataSeriesIndexes.length)) {
                                var e = null, f = !1, l = this.plotArea, v = 0, h, k, n, p, q, g, r, m = a.axisX.dataInfo.minDiff; isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range)); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(l.x1, l.y1, l.width, l.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(l.x1,
                                    l.y1, l.width, l.height), this._eventManager.ghostCtx.clip()); for (var w = 0, t = 0; t < this.data.length; t++)!this.data[t].type.match(/(bar|column)/ig) || !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) && w || w++; for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                                        var E = a.dataSeriesIndexes[x], B = this.data[E], C = B.dataPoints, z = s(B._linkedSeries) ? !1 : B._linkedSeries.type.match(/(bar|column)/ig) && B._linkedSeries.visible ? !0 : !1, D = 0; if (z) for (e = B._linkedSeries.id, t = 0; t < e; t++)!this.data[t].type.match(/(bar|column)/ig) ||
                                            !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) && D || (this.data[t].type.match(/(range)/ig) && (f = !0), D++); e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; v = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? w : 1))) << 0 : 0.3 * this.width; f && (v = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
                                                b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? w : 1))) << 0 : 0.03 * this.width); t = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / (z ? w : 1)) << 0; this.dataPointMaxWidth && e > v && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, v)); !this.dataPointMaxWidth && (this.dataPointMinWidth && v < e) && (v = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); t < e &&
                                                    (t = e); t > v && (t = v); if (0 < C.length) for (var F = B._colorSet, v = 0; v < C.length; v++) {
                                                        var e = B.lineColor = B.options.color ? B.options.color : F[0], S = {
                                                            color: C[v].whiskerColor ? C[v].whiskerColor : C[v].color ? B.whiskerColor ? B.whiskerColor : C[v].color : B.whiskerColor ? B.whiskerColor : e, thickness: s(C[v].whiskerThickness) ? B.whiskerThickness : C[v].whiskerThickness, dashType: C[v].whiskerDashType ? C[v].whiskerDashType : B.whiskerDashType, length: s(C[v].whiskerLength) ? s(B.options.whiskerLength) ? t : B.options.whiskerLength : C[v].whiskerLength,
                                                            ...
                                                            color: C[v].stemColor ? C[v].stemColor : C[v].color ? B.stemColor ? B.stemColor : C[v].color : B.stemColor ? B.stemColor : e, thickness: C[v].stemThickness ? C[v].stemThickness : B.stemThickness, dashType: C[v].stemDashType ?
                                                                C[v].stemDashType : B.stemDashType
                                                        }; P.thickness = "number" === typeof P.thickness ? 0 > P.thickness ? 0 : Math.round(P.thickness) : 2; C[v].getTime ? r = C[v].x.getTime() : r = C[v].x; if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(C[v].y) && C[v].y.length && "number" === typeof C[v].y[0] && "number" === typeof C[v].y[1]) {
                                                            var ja = a.axisX.convertValueToPixel(r); b ? k = ja : h = ja; ja = a.axisY.convertValueToPixel(C[v].y[0]); b ? n = ja : q = ja; ja = a.axisY.convertValueToPixel(C[v].y[1]); b ? p = ja : g = ja; b ? (q = a.axisX.reversed ? k + (z ? w :
                                            ...
                                            this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                                                var q = a.dataSeriesIndexes[p], g = this.data[q], r = g.dataPoints; if (0 < r.length) {
                                                    var m = 5 < n && g.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (f = 0; f < r.length; f++)if (r[f].getTime ? k = r[f].x.getTime() : k = r[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(r[f].y) && r[f].y.length && "number" === typeof r[f].y[0] && "number" === typeof r[f].y[1]) {
                                                        ...
                                                        v = a.axisY.convertValueToPixel(r[f].y[1]); h = a.axisX.convertValueToPixel(k); h = a.axisX.reversed ? h + a.plotType.totalDataSeries * n / 2 - (a.previousDataSeriesCount + p) * n << 0 : h - a.plotType.totalDataSeries * n / 2 + (a.previousDataSeriesCount + p) * n << 0; var w = a.axisX.reversed ? h - n << 0 : h + n << 0; l > v && (b = l, l = v, v = b); b = r[f].color ? r[f].color : g._colorSet[f % g._colorSet.length]; ca(c, l, h, v, w, b, 0, null, m, !1, !1, !1, g.fillOpacity); b = g.dataPointIds[f]; this._eventManager.objectMap[b] = {
                                                            id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f,
                                                            x1: l, y1: h, x2: v, y2: w
                                                        }; b = Q(b); u && ca(this._eventManager.ghostCtx, l, h, v, w, b, 0, null, !1, !1, !1, !1); if (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: r[f], dataSeries: g, indexKeyword: 0, point: { x: r[f].y[1] >= r[f].y[0] ? l : v, y: h + (w - h) / 2 }, direction: r[f].y[1] >= r[f].y[0] ? -1 : 1, bounds: { x1: Math.min(l, v), y1: h, x2: Math.max(l, v), y2: w }, color: b }), this._indexLabels.push({
                                                            chartType: "rangeBar", dataPoint: r[f], dataSeries: g, indexKeyword: 1, point: {
                                                                x: r[f].y[1] >=
                                                                    r[f].y[0] ? v : l, y: h + (w - h) / 2
                                                            }, direction: r[f].y[1] >= r[f].y[0] ? 1 : -1, bounds: { x1: Math.min(l, v), y1: h, x2: Math.max(l, v), y2: w }, color: b
                                                        })
                                                    }
                                                }
                            ...
                            function d() {
                                if (x) {
                                    for (var a = null, c = m.length - 1; 0 <= c; c--)a = m[c], b.lineTo(a.x, a.y2), e.lineTo(a.x, a.y2); b.closePath(); b.globalAlpha = n.fillOpacity; b.fill(); b.globalAlpha = 1; e.fill(); if (0 < n.lineThickness) {
                                        b.beginPath(); b.moveTo(a.x, a.y2); for (c = 0; c < m.length; c++)a = m[c],
                                            b.lineTo(a.x, a.y2); b.moveTo(m[0].x, m[0].y1); for (c = 0; c < m.length; c++)a = m[c], b.lineTo(a.x, a.y1); b.stroke()
                                    } b.beginPath(); b.moveTo(r, s); e.beginPath(); e.moveTo(r, s); x = { x: r, y: s }; m = []; m.push({ x: r, y1: s, y2: w })
                                }
                            } var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                                var e = this._eventManager.ghostCtx, f = [], l = this.plotArea; b.save(); u && e.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height); b.clip(); u && (e.beginPath(), e.rect(l.x1, l.y1, l.width, l.height), e.clip());
                                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                                    var m = [], k = a.dataSeriesIndexes[h], n = this.data[k], p = n.dataPoints, f = n.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: k }; f = Q(f); e.fillStyle = f; var f = [], q = !0, g = 0, r, s, w, t, x = null; if (0 < p.length) {
                                        var E = n._colorSet[g % n._colorSet.length], B = n.lineColor = n.options.lineColor || E, C = B; b.fillStyle = E; b.strokeStyle = B; b.lineWidth = n.lineThickness; var z = "solid"; if (b.setLineDash) {
                                            ...
                                            r = a.axisX.convertValueToPixel(t); s = a.axisY.convertValueToPixel(p[g].y[0]); w = a.axisY.convertValueToPixel(p[g].y[1]); q || S ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || z === n.lineDashType &&
                                                n.lineDashType !== n.nullDataLineDashType) && (m[m.length - 1].newLineDashArray = D, z = n.nullDataLineDashType, b.setLineDash(y)), b.lineTo(r, s), u && e.lineTo(r, s), m.push({ x: r, y1: s, y2: w })) : (b.beginPath(), b.moveTo(r, s), x = { x: r, y: s }, m = [], m.push({ x: r, y1: s, y2: w }), u && (e.beginPath(), e.moveTo(r, s))), S = q = !1) : (b.lineTo(r, s), m.push({ x: r, y1: s, y2: w }), u && e.lineTo(r, s), 0 == g % 250 && d()); t = n.dataPointIds[g]; this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: r, y1: s, y2: w }; g < p.length -
                                                    1 && (C !== (p[g].lineColor || B) || z !== (p[g].lineDashType || n.lineDashType)) && (d(), C = p[g].lineColor || B, m[m.length - 1].newStrokeStyle = C, b.strokeStyle = C, b.setLineDash && (p[g].lineDashType ? (z = p[g].lineDashType, m[m.length - 1].newLineDashArray = N(z, n.lineThickness), b.setLineDash(m[m.length - 1].newLineDashArray)) : (z = n.lineDashType, m[m.length - 1].newLineDashArray = D, b.setLineDash(D)))); if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < n.markerSize)) {
                                                        var P = n.getMarkerProperties(g, r, w, b); f.push(P); var F = Q(t); u && f.push({
                                                            x: r,
                                                            y: w, ctx: e, type: P.type, size: P.size, color: F, borderColor: F, borderThickness: P.borderThickness
                                                        }); P = n.getMarkerProperties(g, r, s, b); f.push(P); F = Q(t); u && f.push({ x: r, y: s, ctx: e, type: P.type, size: P.size, color: F, borderColor: F, borderThickness: P.borderThickness })
                                                        ...
                                                        chartType: "rangeArea",
                                                        dataPoint: p[g], dataSeries: n, indexKeyword: 1, point: { x: r, y: w }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? 1 : -1, color: E
                                                    })
                            ...
                            function d(a, c) {
                                var d = w(s, 2); if (0 < d.length) {
                                    ...
                                    } b.beginPath(); b.moveTo(d[0].x, d[0].y); u && (e.beginPath(), e.moveTo(d[0].x, d[0].y)); for (f = 0; f < d.length - 3; f += 3)b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y), u && e.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y); d = w(y, 2); b.lineTo(y[y.length -
                                        1].x, y[y.length - 1].y); for (f = d.length - 1; 2 < f; f -= 3)b.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y), u && e.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y); b.closePath(); b.globalAlpha = k.fillOpacity; b.fill(); u && (e.closePath(), e.fill()); b.globalAlpha = 1; if (0 < k.lineThickness) {
                                ...
                                var e = this._eventManager.ghostCtx, f = [], l = this.plotArea; b.save(); u && e.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height); b.clip(); u && (e.beginPath(), e.rect(l.x1, l.y1, l.width, l.height), e.clip()); for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                                    var m = a.dataSeriesIndexes[h], k = this.data[m], n = k.dataPoints, f = k.id; this._eventManager.objectMap[f] =
                                        { objectType: "dataSeries", dataSeriesIndex: m }; f = Q(f); e.fillStyle = f; var f = [], p = 0, q, g, r, s = [], y = []; if (0 < n.length) {
                                            var t = k._colorSet[p % k._colorSet.length], x = k.lineColor = k.options.lineColor || t, E = x; b.fillStyle = t; b.lineWidth = k.lineThickness; var B = "solid", C; if (b.setLineDash) { var z = N(k.nullDataLineDashType, k.lineThickness), B = k.lineDashType; C = N(B, k.lineThickness) } for (g = !1; p < n.length; p++)if (q = n[p].x.getTime ? n[p].x.getTime() : n[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                                                !g))) if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                                                    q = a.axisX.convertValueToPixel(q); g = a.axisY.convertValueToPixel(n[p].y[0]); r = a.axisY.convertValueToPixel(n[p].y[1]); var D = k.dataPointIds[p]; this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: p, x1: q, y1: g, y2: r }; s[s.length] = { x: q, y: g }; y[y.length] = { x: q, y: r }; p < n.length - 1 && (E !== (n[p].lineColor || x) || B !== (n[p].lineDashType || k.lineDashType)) && (E = n[p].lineColor || x, s[s.length -
                                                        1].newStrokeStyle = E, b.setLineDash && (n[p].lineDashType ? (B = n[p].lineDashType, s[s.length - 1].newLineDashArray = N(B, k.lineThickness)) : (B = k.lineDashType, s[s.length - 1].newLineDashArray = C))); if (0 !== n[p].markerSize && (0 < n[p].markerSize || 0 < k.markerSize)) {
                                                            var F = k.getMarkerProperties(p, q, g, b); f.push(F); var S = Q(D); u && f.push({ x: q, y: g, ctx: e, type: F.type, size: F.size, color: S, borderColor: S, borderThickness: F.borderThickness }); F = k.getMarkerProperties(p, q, r, b); f.push(F); S = Q(D); u && f.push({
                                                    ...
                                                    (0 < s.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = z, B = k.nullDataLineDashType) : (d(C, x), s = [], y = [])), g = !0; d(C, x); W.drawMarkers(f)
                                        }
                                } u && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                                    0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), this._eventManager.ghostCtx.restore()); b.restore(); return { source: c, dest: this.plotArea.ctx, animationCallback: L.xClipAnimation, easingFunction: L.easing.linear, animationBase: 0 }
                            }
                                        ...
                                        Math.abs(q) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && l > m && (l = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m)); !this.dataPointMaxWidth && (this.dataPointMinWidth && m < l) && (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, l)); q < l && (q = l); q > m && (q = m); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(f.x1, f.y1, f.width, f.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(f.x1,
                                            f.y1, f.width, f.height), this._eventManager.ghostCtx.clip()); for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                                                var r = a.dataSeriesIndexes[g], s = this.data[r], w = s.dataPoints, e = s._colorSet[0]; s.risingColor = s.options.risingColor ? s.options.risingColor : e; s.fallingColor = s.options.fallingColor ? s.options.fallingColor : "#e40a0a"; var t = "number" === typeof s.options.lineThickness ? Math.round(s.lineThickness) : 1, x = 1 === Math.round(t) % 2 ? -0.5 : 0; if (0 < w.length) for (var E = 5 < q && s.bevelEnabled ? !0 : !1, B = !1, y = null, z = null, l = 0; l < w.length; l++)if (w[l].getTime ?
                                                    n = w[l].x.getTime() : n = w[l].x, "number" !== typeof w[l].y) { if (0 < l && !B && s.connectNullData) var D = s.options.nullDataLineDashType || !w[l - 1].lineDashType ? s.nullDataLineDashType : w[l - 1].lineDashType; B = !0 } else {
                                                        h = a.axisX.convertValueToPixel(n); m = 0 === s.dataPointEOs[l].cumulativeSum ? p : a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum); k = 0 === s.dataPointEOs[l].cumulativeSumYStartValue ? p : a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue); h = a.axisX.reversed ? h + a.plotType.totalDataSeries *
                                                            q / 2 - (a.previousDataSeriesCount + g) * q << 0 : h - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount + g) * q << 0; var F = a.axisX.reversed ? h - q << 0 : h + q << 0; m > k && (e = m, m = k, k = e); a.axisY.reversed && (e = m, m = k, k = e); e = s.dataPointIds[l]; this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: l, x1: h, y1: m, x2: F, y2: k }; var S = w[l].color ? w[l].color : 0 < w[l].y ? s.risingColor : s.fallingColor; ca(c, h, m, F, k, S, 0, S, E, E, !1, !1, s.fillOpacity); e = Q(e); u && ca(this._eventManager.ghostCtx, h, m, F, k, e, 0, null, !1,
                                                                !1, !1, !1); var P, S = h; P = "undefined" !== typeof w[l].isIntermediateSum && !0 === w[l].isIntermediateSum || "undefined" !== typeof w[l].isCumulativeSum && !0 === w[l].isCumulativeSum ? 0 < w[l].y ? m : k : 0 < w[l].y ? k : m; 0 < l && y && (!B || s.connectNullData) && (B && c.setLineDash && c.setLineDash(N(D, t)), c.beginPath(), c.moveTo(y, z - x), c.lineTo(S, P - x), 0 < t && c.stroke(), u && (b.beginPath(), b.moveTo(y, z - x), b.lineTo(S, P - x), 0 < t && b.stroke())); B = !1; y = F; z = 0 < w[l].y ? m : k; S = w[l].lineDashType ? w[l].lineDashType : s.options.lineDashType ? s.options.lineDashType :
                                                                    "shortDash"; c.strokeStyle = w[l].lineColor ? w[l].lineColor : s.options.lineColor ? s.options.lineColor : "#9e9e9e"; c.lineWidth = t; c.setLineDash && (S = N(S, t), c.setLineDash(S)); (w[l].indexLabel || s.indexLabel || w[l].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({ chartType: "waterfall", dataPoint: w[l], dataSeries: s, point: { x: h + (F - h) / 2, y: 0 <= w[l].y ? m : k }, direction: 0 > w[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: h, y1: Math.min(m, k), x2: F, y2: Math.max(m, k) }, color: e })
                                                }
                            ...
                            function d() {
                                                ...
                                                k._colorSet.length]; p.indexLabelLineThickness = s(f.indexLabelLineThickness) ? k.indexLabelLineThickness : f.indexLabelLineThickness; p.indexLabelLineDashType = f.indexLabelLineDashType ? f.indexLabelLineDashType : k.indexLabelLineDashType; p.indexLabelFontColor = f.indexLabelFontColor ? f.indexLabelFontColor : k.indexLabelFontColor; p.indexLabelFontStyle = f.indexLabelFontStyle ? f.indexLabelFontStyle : k.indexLabelFontStyle; p.indexLabelFontWeight = f.indexLabelFontWeight ? f.indexLabelFontWeight : k.indexLabelFontWeight; p.indexLabelFontSize =
                                                    s(f.indexLabelFontSize) ? k.indexLabelFontSize : f.indexLabelFontSize; p.indexLabelFontFamily = f.indexLabelFontFamily ? f.indexLabelFontFamily : k.indexLabelFontFamily; p.indexLabelBackgroundColor = f.indexLabelBackgroundColor ? f.indexLabelBackgroundColor : k.options.indexLabelBackgroundColor ? k.options.indexLabelBackgroundColor : k.indexLabelBackgroundColor; p.indexLabelMaxWidth = f.indexLabelMaxWidth ? f.indexLabelMaxWidth : k.indexLabelMaxWidth ? k.indexLabelMaxWidth : 0.33 * q.width; p.indexLabelWrap = "undefined" !== typeof f.indexLabelWrap ?
                                                        f.indexLabelWrap : k.indexLabelWrap; p.indexLabelTextAlign = f.indexLabelTextAlign ? f.indexLabelTextAlign : k.indexLabelTextAlign ? k.indexLabelTextAlign : "left"; p.startAngle = 0 === e ? k.startAngle ? k.startAngle / 180 * Math.PI : 0 : g[e - 1].endAngle; p.startAngle = (p.startAngle + 2 * Math.PI) % (2 * Math.PI); p.endAngle = p.startAngle + 2 * Math.PI / B * Math.abs(f.y); f = (p.endAngle + p.startAngle) / 2; f = (f + 2 * Math.PI) % (2 * Math.PI); p.midAngle = f; if (p.midAngle > Math.PI / 2 - t && p.midAngle < Math.PI / 2 + t) { if (0 === a || g[c].midAngle > p.midAngle) c = e; a++ } else if (p.midAngle >
                                                            3 * Math.PI / 2 - t && p.midAngle < 3 * Math.PI / 2 + t) { if (0 === b || g[d].midAngle > p.midAngle) d = e; b++ } p.hemisphere = f > Math.PI / 2 && f <= 3 * Math.PI / 2 ? "left" : "right"; p.indexLabelTextBlock = new ia(m.plotArea.ctx, {
                                                                fontSize: p.indexLabelFontSize, fontFamily: p.indexLabelFontFamily, fontColor: p.indexLabelFontColor, fontStyle: p.indexLabelFontStyle, fontWeight: p.indexLabelFontWeight, textAlign: p.indexLabelTextAlign, backgroundColor: p.indexLabelBackgroundColor, maxWidth: p.indexLabelMaxWidth, maxHeight: p.indexLabelWrap ? 5 * p.indexLabelFontSize :
                                                                    1.5 * p.indexLabelFontSize, text: p.indexLabelText, padding: 0, textBaseline: "top"
                                                            }); p.indexLabelTextBlock.measureText()
                                    } l = f = 0; h = !1; for (e = 0; e < n.length; e++)p = g[(c + e) % n.length], 1 < a && (p.midAngle > Math.PI / 2 - t && p.midAngle < Math.PI / 2 + t) && (f <= a / 2 && !h ? (p.hemisphere = "right", f++) : (p.hemisphere = "left", h = !0)); h = !1; for (e = 0; e < n.length; e++)p = g[(d + e) % n.length], 1 < b && (p.midAngle > 3 * Math.PI / 2 - t && p.midAngle < 3 * Math.PI / 2 + t) && (l <= b / 2 && !h ? (p.hemisphere = "left", l++) : (p.hemisphere = "right", h = !0))
                                }
                            } function c(a) {
                                    ...
                                    q.y1, q.width, q.height); b.fillStyle = m.backgroundColor; b.fillRect(q.x1, q.y1, q.width, q.height); for (b = 0; b < n.length; b++) {
                                        var c = g[b].startAngle, d = g[b].endAngle; if (d > c) {
                                            var e = 0.07 * z * Math.cos(g[b].midAngle), f = 0.07 * z * Math.sin(g[b].midAngle), l = !1; if (n[b].exploded) { if (1E-9 < Math.abs(g[b].center.x - (E.x + e)) || 1E-9 < Math.abs(g[b].center.y - (E.y + f))) g[b].center.x = E.x + e * a, g[b].center.y = E.y + f * a, l = !0 } else if (0 < Math.abs(g[b].center.x - E.x) || 0 < Math.abs(g[b].center.y - E.y)) g[b].center.x = E.x + e * (1 - a), g[b].center.y = E.y + f * (1 - a),
                                                l = !0; l && (e = {}, e.dataSeries = k, e.dataPoint = k.dataPoints[b], e.index = b, m.toolTip.highlightObjects([e])); X(m.plotArea.ctx, g[b].center, g[b].radius, n[b].color ? n[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, g[b].percentInnerRadius)
                                        }
                                ...
                                d = (d || 0) + 1; if (1E3 < d) return 0; c = c || 0; var k = 0,
                                    l = E.y - 1 * u, p = E.y + 1 * u; if (0 <= a && a < n.length) {
                                ...
                                var a = m.plotArea.ctx; a.fillStyle = "grey"; a.strokeStyle = "grey"; a.font = "16px Arial"; a.textBaseline = "middle"; for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                                    if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && z - d <= D) l = !1; l && (z -= d); d = 0; if ("inside" !== k.indexLabelPlacement) {
                                        u = z * w; for (a = 0; a < n.length; a++) {
                                            var h =
                                                g[a]; h.indexLabelTextBlock.x = E.x + u * Math.cos(h.midAngle); h.indexLabelTextBlock.y = E.y + u * Math.sin(h.midAngle); h.indexLabelAngle = h.midAngle; h.radius = z; h.percentInnerRadius = F
                                        } for (var v, s, a = 0; a < n.length; a++) {
                                            var h = g[a], t = e(a); if (null !== t) {
                                                v = g[a]; s = g[t]; var B = 0, B = b(v, s) - r; if (0 > B) {
                                                    for (var y = s = 0, C = 0; C < n.length; C++)C !== a && g[C].hemisphere === h.hemisphere && (g[C].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? s++ : y++); s = B / (s + y || 1) * y; var y = -1 * (B - s), H = C = 0; "right" === h.hemisphere ? (C = f(a, s), y = -1 * (B - C), H = f(t, y), +H.toFixed(x) <
                                            ...
                                            2 - E.y) < z) && (t /= Math.abs(Math.cos(h.indexLabelAngle)), 9 < t && (t *= 0.3), t > d && (d = t)), t = t = 0, 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? (t = q.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5), t *= -1) : t = q.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5), 0 < t && (!l && h.indexLabelText && (s = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1, 0 === f(a, t * s) && f(a, 2 * s)), Math.abs(h.indexLabelTextBlock.x - E.x) < z && (t /= Math.abs(Math.sin(h.indexLabelAngle)), 9 < t && (t *= 0.3), t > d && (d = t))); var K = function (a,
                                                b, c) { for (var d = [], e = 0; d.push(g[b]), b !== c; b = (b + 1 + n.length) % n.length); d.sort(function (a, b) { return a.y - b.y }); for (b = 0; b < d.length; b++)if (c = d[b], e < 0.7 * a) e += c.indexLabelTextBlock.height, c.indexLabelTextBlock.text = "", c.indexLabelText = "", c.indexLabelTextBlock.measureText(); else break }; (function () {
                                                    for (var a = -1, c = -1, d = 0, f = !1, k = 0; k < n.length; k++)if (f = !1, v = g[k], v.indexLabelText) {
                                                        var l = e(k); if (null !== l) {
                                                            var h = g[l]; B = 0; B = b(v, h); var q; if (q = 0 > B) {
                                                                q = v.indexLabelTextBlock.x; var m = v.indexLabelTextBlock.y - v.indexLabelTextBlock.height /
                                                                    2, r = v.indexLabelTextBlock.y + v.indexLabelTextBlock.height / 2, s = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2, t = h.indexLabelTextBlock.x + h.indexLabelTextBlock.width, A = h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2; q = v.indexLabelTextBlock.x + v.indexLabelTextBlock.width < h.indexLabelTextBlock.x - p || q > t + p || m > A + p || r < s - p ? !1 : !0
                                    ...
                                    this.data[a.dataSeriesIndexes[0]], n = k.dataPoints, p = 10, q = this.plotArea, g = k.dataPointEOs, r = 2, u, w = 1.3, t = 20 / 180 * Math.PI, x = 6, E = { x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2 }, B = 0; a = !1; for (var y = 0; y < n.length; y++)B += Math.abs(n[y].y), !a && ("undefined" !== typeof n[y].indexLabel && null !== n[y].indexLabel && 0 < n[y].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof n[y].label && null !== n[y].label && 0 < n[y].label.toString().length) && (a = !0); if (0 !== B) {
                                        ...
                                        m.isAnimating || !s(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && m._animator.animate(0,
                                            ...
                                            var b = m.plotArea.ctx; b.clearRect(q.x1, q.y1, q.width, q.height); b.fillStyle = m.backgroundColor; b.fillRect(q.x1, q.y1, q.width, q.height); for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < n.length; c++) {
                                                ...
                                                f = !1; e > b && (e = b, f = !0); var l = n[c].color ? n[c].color : k._colorSet[c % k._colorSet.length]; e > d && X(m.plotArea.ctx, g[c].center, g[c].radius, l, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius); if (f) break
                ...
                var pa = function (a, d, c, b) { "undefined" === typeof c && (c = 1); 0 >= Math.round(d.y4 - d.y1) || (a.save(), a.globalAlpha = c, a.beginPath(), a.moveTo(Math.round(d.x1), Math.round(d.y1)), a.lineTo(Math.round(d.x2), Math.round(d.y2)), a.lineTo(Math.round(d.x3), Math.round(d.y3)), a.lineTo(Math.round(d.x4), Math.round(d.y4)), "undefined" !== d.x5 && (a.lineTo(Math.round(d.x5), Math.round(d.y5)), a.lineTo(Math.round(d.x6), Math.round(d.y6))), a.closePath(), a.fillStyle = b ? b : d.color, a.fill(), a.globalAplha = 1, a.restore()) }; m.prototype.renderFunnel =
                    function (a) {
                        function d() { for (var a = 0, b = [], c = 0; c < x.length; c++) { if ("undefined" === typeof x[c].y) return -1; x[c].y = "number" === typeof x[c].y ? x[c].y : 0; a += Math.abs(x[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < x.length; c++)b.push(Math.abs(x[c].y) * D / a); return b } function c() {
                            var a = Y, b = Z, c = K, d = W, e, f; e = M; f = Q - ba; d = Math.abs((f - e) * (b - a + (d - c)) / 2); c = W - K; e = f - e; f = c * (f - Q); f = Math.abs(f); f = d + f; for (var d = [], g = 0, k = 0; k < x.length; k++) { if ("undefined" === typeof x[k].y) return -1; x[k].y = "number" === typeof x[k].y ? x[k].y : 0; g += Math.abs(x[k].y) } if (0 ===
                                g) return -1; for (var l = d[0] = 0, n = 0, h, p, b = b - a, l = !1, k = 0; k < x.length; k++)a = Math.abs(x[k].y) * f / g, l ? h = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = $ * $ * b * b - 4 * Math.abs($) * a, 0 > p ? (p = c, l = (b + p) * (e - n) / 2, a -= l, h = e - n, n += e - n, h += 0 == p ? 0 : a / p, n += a / p, l = !0) : (h = (Math.abs($) * b - Math.sqrt(p)) / 2, p = b - 2 * h / Math.abs($), n += h, n > e && (n -= h, p = c, l = (b + p) * (e - n) / 2, a -= l, h = e - n, n += e - n, h += a / p, n += a / p, l = !0), b = p)), d.push(h); return d
                        } function b() {
                            if (t && x) {
                                for (var a, b, c, d, e, f, k, l, n, h, p, q, m, v, r, A = [], w = [], E = { percent: null, total: null }, B = null, z = 0; z < x.length; z++)r = O[z],
                                    r = "undefined" !== typeof r.x5 ? (r.y2 + r.y4) / 2 : (r.y2 + r.y3) / 2, r = g(r).x2 + 1, A[z] = J - r - V; r = 0.5 * V; for (var z = 0, C = x.length - 1; z < x.length || 0 <= C; z++ , C--) {
                                        b = t.reversed ? x[C] : x[z]; a = b.color ? b.color : t.reversed ? t._colorSet[(x.length - 1 - z) % t._colorSet.length] : t._colorSet[z % t._colorSet.length]; c = b.indexLabelPlacement || t.indexLabelPlacement || "outside"; v = b.indexLabelTextAlign || t.indexLabelTextAlign || "left"; d = b.indexLabelBackgroundColor || t.indexLabelBackgroundColor || (u ? "transparent" : null); e = b.indexLabelFontColor || t.indexLabelFontColor ||
                        ...
                        } function h(a, b) { return (b < O.length ? I[b].textBlock.y : t.reversed ? na + B : sa + B) - (0 > a ? t.reversed ? sa - B : na - B : I[a].textBlock.y + I[a].height + da) } function m(a, b, c) {
                            var d, e, g, l = [], h = B, p = []; -1 !== b && (0 <= X.indexOf(b) ? (e = X.indexOf(b), X.splice(e, 1)) : (X.push(b), X = X.sort(function (a, b) { return a - b }))); if (0 === X.length) l = ga; else {
                                e = B * (1 != X.length || 0 != X[0] && X[0] != O.length - 1 ? 2 : 1) / k(); for (var q = 0; q < O.length; q++) {
                                    if (1 == X.length && 0 == X[0]) { if (0 === q) { l.push(ga[q]); d = h; continue } } else 0 ===
                                        q && (d = -1 * h); l.push(ga[q] + d); if (0 <= X.indexOf(q) || q < O.length && 0 <= X.indexOf(q + 1)) d += e
                                }
                            } g = function () { for (var a = [], b = 0; b < O.length; b++)a.push(l[b] - O[b].y1); return a }(); var v = {
                        ...
                        function p(a) { for (a -= 1; -1 <= a && -1 != a && I[a].isDirty; a--); return a } function q(a) { for (a += 1; a <= O.length && a != O.length && I[a].isDirty; a++); return a } function g(a) { for (var b, c = 0; c < x.length; c++)if (O[c].y1 < a && O[c].y4 > a) { b = O[c]; break } return b ? (a = b.y6 ? a > b.y6 ? b.x3 + (b.x4 - b.x3) / (b.y4 - b.y3) * (a - b.y3) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2), { x1: a, x2: a }) : -1 } function r(a) { for (var b = 0; b < O.length; b++)I[b].isDirty || (a && (I[b].textBlock.ctx = a), I[b].textBlock.render(!0)) } function w(a) {
                            ...
                            for (var t = this.data[a.dataSeriesIndexes[0]], x = t.dataPoints, E = this.plotArea, B = 0.025 * E.width, C = 0.01 * E.width, z = 0, D = E.height - 2 * B, F = Math.min(E.width - 2 * C, 2.8 * E.height), H = !1, P = 0; P < x.length; P++)if (!H && ("undefined" !== typeof x[P].indexLabel && null !== x[P].indexLabel && 0 < x[P].indexLabel.toString().length) && (H = !0), !H && ("undefined" !== typeof x[P].label && null !== x[P].label && 0 < x[P].label.toString().length) && (H = !0), !H && "function" === typeof t.indexLabelFormatter ||
                                "function" === typeof x[P].indexLabelFormatter) H = !0; H = H || "undefined" !== typeof t.indexLabel && null !== t.indexLabel && 0 < t.indexLabel.toString().length; "inside" !== t.indexLabelPlacement && H || (C = (E.width - 0.75 * F) / 2); var P = E.x1 + C, J = E.x2 - C, M = E.y1 + B, Q = E.y2 - B, R = a.targetCanvasCtx || this.plotArea.ctx || this.ctx; if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                                    var ba, G; a = 75 * F / 100; var V = 30 * (J - a) / 100; "funnel" === t.type ? (ba = s(t.options.neckHeight) ? 0.35 * D : t.neckHeight, G = s(t.options.neckWidth) ? 0.25 * a : t.neckWidth, "string" ===
                                        typeof ba && ba.match(/%$/) ? (ba = parseInt(ba), ba = ba * D / 100) : ba = parseInt(ba), "string" === typeof G && G.match(/%$/) ? (G = parseInt(G), G = G * a / 100) : G = parseInt(G), ba > D ? ba = D : 0 >= ba && (ba = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === t.type && (G = ba = 0, t.reversed = t.reversed ? !1 : !0); var C = P + a / 2, Y = P, Z = P + a, na = t.reversed ? Q : M, K = C - G / 2, W = C + G / 2, xa = t.reversed ? M + ba : Q - ba, sa = t.reversed ? M : Q; a = []; var C = [], O = [], F = [], U = M, ca, $ = (xa - na) / (K - Y), ea = -$, P = "area" === (t.valueRepresents ? t.valueRepresents : "height") ? c() : d(); if (-1 !== P) {
                                            ...
                                            if (H && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) { l(); for (G = 0; G < x.length; G++)I[G].isDirty || (a = I[G].textBlock.x + I[G].width, a = (J - a) / 2, 0 == G && (z = a), z > a && (z = a)); for (G = 0; G < O.length; G++)O[G].x1 += z, O[G].x2 += z, O[G].x3 += z, O[G].x4 += z, O[G].x5 && (O[G].x5 += z, O[G].x6 += z), I[G].textBlock.x += z } for (G = 0; G < O.length; G++)z = O[G], pa(R, z, t.fillOpacity), ga.push(z.y1); w(R); H && t.visible && ("inside" === t.indexLabelPlacement || y.animationEnabled || n(R), y.animationEnabled || r()); if (!H) for (G = 0; G < x.length; G++)z = t.dataPointIds[G],
                                                a = { id: z, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: O[t.reversed ? x.length - 1 - G : G] }, y._eventManager.objectMap[z] = a; !y.animationEnabled && P ? m(y, -1, 0) : y.animationEnabled && !y.animatedRender && m(y, -1, 0); this.funnelPyramidClickHandler = function (a) {
                                                    var b = -1; if (!ha && !y.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = t.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) {
                                                        a = b; if ("funnel" === t.type || "pyramid" === t.type) t.reversed ? x[x.length - 1 - a].exploded =
                                                            x[x.length - 1 - a].exploded ? !1 : !0 : x[a].exploded = x[a].exploded ? !1 : !0; m(y, b, 500)
                                                    }
                        ...
                        var f = this; e = "undefined" === typeof e ? 0 : e; if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                            var l = "#percent", h = "#total", m = this.getPercentAndTotal(c, d), h = isNaN(m.total) ? h : m.total, l = isNaN(m.percent) ? l : m.percent; do {
                                m = ""; if (c.percentFormatString) m = c.percentFormatString; else {
                                    var m = "#,##0.",
                                    k = Math.max(Math.ceil(Math.log(1 / Math.abs(l)) / Math.LN10), 2); if (isNaN(k) || !isFinite(k)) k = 2; for (var n = 0; n < k; n++)m += "#"; c.percentFormatString = m
                                } a = a.replace("#percent", ea(l, m, f._cultureInfo)); a = a.replace("#total", ea(h, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo))
                        ...
                        var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(), c = null, b = 0, e = 0, f = 0, l = 0, h = this.markerMargin = this.chart.options.legend && !s(this.chart.options.legend.markerMargin) ?
                            ...
                            this.orientation = "vertical"; if ("left" === this.horizontalAlign || "center" === this.horizontalAlign || "right" === this.horizontalAlign) c = this.horizontalAlign;
                                ...
                                var p = this.dataSeries[n]; if (p.dataPoints && p.dataPoints.length) if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                                    ...
                                    u = p.markerSize || "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type ? 0.75 * this.lineHeight : 0, w = p.legendMarkerBorderColor ? p.legendMarkerBorderColor : p.markerBorderColor, t = p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : p.markerBorderThickness ? Math.max(1, Math.round(0.2 * u)) : 0; "error" === p.type && this.errorMarkerColor.push(r); g = this.chart.replaceKeywordsWithValue(g, p.dataPoints[0], p, n); q = {
                                        markerType: q, markerColor: r, text: g, textBlock: null, chartType: p.type, markerSize: u, lineColor: p._colorSet[0],
                                        dataSeriesIndex: p.index, dataPointIndex: null, markerBorderColor: w, markerBorderThickness: t
                                    }; m.push(q)
                                } else for (var x = 0; x < p.dataPoints.length; x++) {
                                    var y = p.dataPoints[x], q = y.legendMarkerType ? y.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : H.getDefaultLegendMarker(p.type), g = y.legendText ? y.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: p, dataPoint: y }) : y.name ? y.name : "DataPoint: " + (x + 1), r = y.legendMarkerColor ? y.legendMarkerColor :
                                        p.legendMarkerColor ? p.legendMarkerColor : y.color ? y.color : p.color ? p.color : p._colorSet[x % p._colorSet.length], u = 0.75 * this.lineHeight, w = y.legendMarkerBorderColor ? y.legendMarkerBorderColor : p.legendMarkerBorderColor ? p.legendMarkerBorderColor : y.markerBorderColor ? y.markerBorderColor : p.markerBorderColor, t = y.legendMarkerBorderThickness ? y.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : y.markerBorderThickness || p.markerBorderThickness ? Math.max(1, Math.round(0.2 * u)) : 0, g = this.chart.replaceKeywordsWithValue(g,
                                            y, p, x), q = { markerType: q, markerColor: r, text: g, textBlock: null, chartType: p.type, markerSize: u, dataSeriesIndex: n, dataPointIndex: x, markerBorderColor: w, markerBorderThickness: t }; (y.showInLegend || p.showInLegend && !1 !== y.showInLegend) && m.push(q)
                                }
                            } !0 === this.reversed && m.reverse(); if (0 < m.length) {
                                p = null; r = g = y = x = 0; y = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, f) : this.itemMaxWidth = Math.min(this.itemWidth, f) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, f) : this.itemMaxWidth =
                                    f; u = 0 === u ? 0.75 * this.lineHeight : u; y -= u + h; for (n = 0; n < m.length; n++) {
                                        q = m[n]; w = y; if ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType) w -= 2 * 0.1 * this.lineHeight; if (!(0 >= l || "undefined" === typeof l || 0 >= w || "undefined" === typeof w)) {
                                            ...
                                            q.textBlock = new ia(this.ctx, {
                                            ...
                                            }); q.textBlock.measureText(); null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (u + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))); if (!p || p.width + Math.round(q.textBlock.width + u + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) p = { items: [], width: 0 }, k.push(p), this.height += g, g = 0; g = Math.max(g, q.textBlock.height)
                                            } else q.textBlock =
                                                new ia(this.ctx, { x: 0, y: 0, maxWidth: y, maxHeight: !0 === this.itemWrap ? l : 1.5 * this.fontSize, angle: 0, text: q.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" }), q.textBlock.measureText(), null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (u + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < l - this.lineHeight ? (p = {
                                                    items: [],
                                                    width: 0
                                                }, k.push(p)) : (p = k[x], x = (x + 1) % k.length), this.height += q.textBlock.height; q.textBlock.x = p.width; q.textBlock.y = 0; p.width += Math.round(q.textBlock.width + u + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)); p.items.push(q); this.width = Math.max(p.width, this.width); r = q.textBlock.width + (u + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))
                                        }
                                ...
                                d.x1 : "right" === this.horizontalAlign ? d.x2 - this.width : d.x1 + d.width / 2 - this.width / 2, b = d.y2 - this.height); this.items = m; for (n = 0; n < this.items.length; n++)q = m[n], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] = { id: q.id, objectType: "legendItem", legendItemIndex: n, dataSeriesIndex: q.dataSeriesIndex, dataPointIndex: q.dataPointIndex }; this.markerSize = u; this.rows = k; 0 < m.length && a.layoutManager.registerSpace(c, { width: this.width + 2 + 2, height: this.height + 5 + 5 }); this.bounds = {
                                    x1: e, y1: b, x2: e +
                                                ...
                                                case "column": case "stackedColumn": case "stackedColumn100": case "bar": case "stackedBar": case "stackedBar100": case "rangeColumn": case "rangeBar": case "waterfall": case "error": a >=
                                                    q.x1 && (a <= q.x2 && d >= q.y1 && d <= q.y2) && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y1 - d), Math.abs(q.y2 - d)) }), h = !0); break; case "line": case "stepLine": case "spline": case "area": case "stepArea": case "stackedArea": case "stackedArea100": case "splineArea": case "scatter": var s = la("markerSize", g, this) || 4, u = c ? 20 : s, r = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2)); r <= u && b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: r }); q =
                                                        Math.abs(q.x1 - a); q <= m ? m = q : 0 < l ? k++ : n++; r <= s / 2 && (h = !0); break; case "rangeArea": case "rangeSplineArea": s = la("markerSize", g, this) || 4; u = c ? 20 : s; r = Math.min(Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2)), Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y2 - d, 2))); r <= u && b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: r }); q = Math.abs(q.x1 - a); q <= m ? m = q : 0 < l ? k++ : n++; r <= s / 2 && (h = !0); break; case "bubble": s = q.size; r = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2)); r <= s / 2 && (b.push({
                                                            ...
                                                            distance: r
                                                        }), h = !0); break; case "pie": case "doughnut": s = q.center; u = "doughnut" === this.type ? q.percentInnerRadius * q.radius : 0; r = Math.sqrt(Math.pow(s.x - a, 2) + Math.pow(s.y - d, 2)); r < q.radius && r > u && (r = Math.atan2(d - s.y, a - s.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (q.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), u = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === u && 1 < q.endAngle && (u = 360), s >= u && 0 !== g.y && (u += 360, r < s && (r += 360)), r > s && r < u && (b.push({
                                                            dataPoint: g,
                                                ...
                                                this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize, a.angle = this.labelAngle = s(this.options.labelAngle) ? s(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = s(this.options.labelWrap) ? s(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = s(this.sessionVariables.labelMaxHeight) ?
                                                    this.sessionVariables.labelMaxHeight = l : this.sessionVariables.labelMaxHeight, a.measureText(); for (c = 0; c < this.stripLines.length; c++) {
                                                        var f = this.stripLines[c], y; if ("outside" === f.labelPlacement) {
                                                            ...
                                                            "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize, s(f.labelBackgroundColor) && (s(f.startValue) && 0 !== f.startValue ? f.labelBackgroundColor = u ? "transparent" : null : f.labelBackgroundColor = "#EEEEEE"); a = new ia(this.ctx, {
                                                                        ...
                                                                        b[g].lineCoordinates.height), Y += C[g] + b[g].margin); if (a && 0 < a.length) for (g = 0; g < a.length; g++)a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (z = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1, l = a[g]._labels[a[g]._labels.length - ("dateTime" ===
                                                                            a[g].valueType ? 2 : 1)].position, l = a[g].getApparentDifference(a[g].viewportMinimum, l), D = a[g].logarithmic ? (1 < l ? Math.log(l) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1)); if (d && 0 < d.length) for (g = 0; g < d.length; g++)d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (z = (d[g].logarithmic ?
                                                                                Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1, l = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position, l = d[g].getApparentDifference(d[g].viewportMinimum, l), D = d[g].logarithmic ? (1 < l ? Math.log(l) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 :
                                                                                    (0 < l ? l * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1); for (g = 0; g < q.length; g++)"axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues()); if (0 < u) {
                                                                                        if (a && 0 < a.length) for (g = 0; g < a.length; g++)r = M[u - 1][g] === M[u][g] ? !0 : !1; else r = !0; if (d && 0 < d.length) for (g = 0; g < d.length; g++)H = N[u - 1][g] === N[u][g] ? !0 : !1; else H = !0; if (c && 0 < c.length) for (g = 0; g < c.length; g++)J = Q[u - 1][g] === Q[u][g] ? !0 : !1; else J = !0; if (b && 0 < b.length) for (g = 0; g < b.length; g++)L = R[u -
                                                                                            1][g] === R[u][g] ? !0 : !1; else L = !0
                                                                                    } if (r && H && J && L) break; u++
                                    ...
                                    if (b && 0 < b.length) for (g = 0; g < b.length; g++)b[g] && 0 < b[g]._labels.length && (k = b[g]._labels[0], h = b[g]._labels[b[g]._labels.length - 1], B = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), C = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))); if (n.panEnabled) for (g = 0; g < c.length; g++)p[g] = s(n.sessionVariables.axisY.height) ?
                                        n.sessionVariables.axisY.height = p[g] : n.sessionVariables.axisY.height; else for (g = 0; g < c.length; g++)n.sessionVariables.axisY.height = p[g]; if (c && 0 < c.length) for (g = c.length - 1; 0 <= g; g--)h = Math.round(f.y2), k = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = h - (p[g] + c[g].margin + W), c[g].lineCoordinates.y2 = h - (p[g] + c[g].margin + W), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + p[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" ===
                                            c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), c[g].bounds = { x1: l, y1: h - (p[g] + W + c[g].margin), x2: m, y2: k - (W + c[g].margin), width: m - l, height: p[g] }, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width), W += p[g] + c[g].margin; if (b && 0 < b.length) for (g = b.length - 1; 0 <= g; g--)b[g] && (h = Math.round(f.y1), k = Math.round(f.y1 + (z[g] + b[g].margin + G)), b[g].lineCoordinates.y1 =
                                                ...
                                                } for (g = 0; g < q.length; g++)"axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues()); if (0 < u) {
                                                    if (a && 0 < a.length) for (g = 0; g < a.length; g++)r = M[u - 1][g] === M[u][g] ? !0 : !1; else r = !0; if (d && 0 < d.length) for (g = 0; g < d.length; g++)H = N[u - 1][g] === N[u][g] ? !0 :
                                                        !1; else H = !0; if (c && 0 < c.length) for (g = 0; g < c.length; g++)J = D[u - 1][g] === D[u][g] ? !0 : !1; else J = !0; if (b && 0 < b.length) for (g = 0; g < b.length; g++)L = t[u - 1][g] === t[u][g] ? !0 : !1; else L = !0
                                                } if (r && H && J && L) break; u++
                        ...
                        function () {
                            ...
                            function () {
                                ...
                                if (this.scaleBreaks &&
                                    0 < this.scaleBreaks._appliedBreaks.length) {
                                        var a = this.scaleBreaks._appliedBreaks; u ? (this.maskCanvas = ta(this.chart.width, this.chart.height), this.maskCtx = this.maskCanvas.getContext("2d")) : (this.maskCanvas = this.chart.plotArea.canvas, this.maskCtx = this.chart.plotArea.ctx); this.maskCtx.save(); this.maskCtx.beginPath(); this.maskCtx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.maskCtx.clip(); for (var d = 0; d < a.length; d++)a[d].endValue < this.viewportMinimum ||
                            ...
                            s(a) || (a < this.viewportMinimum || a > this.viewportMaximum) || ("top" === this._position || "bottom" === this._position ? this.crosshair.render(this.convertValueToPixel(a),
                                ...
                                var a = this.chart.ctx, d = u ? this.chart._preRenderCtx : a, c = Math.ceil(this.tickThickness / (this.reversed ? -2 : 2)), b = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), e, f; d.save(); if ("bottom" === this._position || "top" === this._position) {
                                ...
                                function (a) {
                                    ...
                                    }; oa(Z, V); oa(U, V); U.prototype.createUserOptions = function (a) {
                                        if ("undefined" !==
                                        ...
                                        var b, e, f, l, h = null, m = null, k = null, n = ""; if (!this.valueFormatString) if ("dateTime" === this.parent.valueType) this.valueFormatString = this.parent.valueFormatString; else {
                                            ...
                                            this.parent.labelFontSize : this.labelFontSize); this.labelMaxWidth = s(this.options.labelMaxWidth) ? 0.3 * this.chart.width : this.labelMaxWidth; this.labelMaxHeight = s(this.options.labelWrap) || this.labelWrap ? 0.3 * this.chart.height : 2 * this.labelFontSize; 0 < p && q.setLineDash && q.setLineDash(N(this.lineDashType, p)); k = new ia(q, {
                                                ...
                                                var r = 0, n = []; if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                                                    var u = null; if ("bottom" === this.parent._position || "top" === this.parent._position) r = this.parent.dataSeries[0].axisX.convertPixelToValue({ y: d });
                                                        ...
                                                        "error" === n[0].dataSeries.type) for (var u = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y[0])), t = 0, r = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (var x = 0; x < n[r].dataPoint.y.length; x++)t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < u && (u = t, w = r); else t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y)), t < u && (u = t, w = r); else if ("stackedBar" === n[0].dataSeries.type) for (var u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), y = t =
                                                            0, r = w = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (x = 0; x < n[r].dataPoint.y.length; x++)t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < u && (u = t, w = r); else y += n[r].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(y)), t < u && (u = t, w = r); else if ("stackedBar100" === n[0].dataSeries.type) for (var u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), B = y = t = 0, r = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (x = 0; x < n[r].dataPoint.y.length; x++)t =
                                                                Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < u && (u = t, w = r); else y += n[r].dataPoint.y, B = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, B = 100 * (y / n[r].dataSeries.plotUnit.dataPointYSums[B]), t = Math.abs(a - this.parent.convertValueToPixel(B)), t < u && (u = t, w = r); else for (u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = w = t = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (x = 0; x < n[r].dataPoint.y.length; x++)t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[x])),
                                                                    t < u && (u = t, w = r); else t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y)), t < u && (u = t, w = r); x = n[w]; if ("bottom" === this.parent._position || "top" === this.parent._position) {
                                                                        b = 0; if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
                                                                            u = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[0])); for (r = t = 0; r < x.dataPoint.y.length; r++)t = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[r])), t < u && (u = t, b = r); h = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y[b]) <<
                                                                            ...
                                                                            u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); y = t = 0; for (r = w; 0 <= r; r--)y += n[r].dataPoint.y, t = Math.abs(a -
                                                                                this.parent.convertValueToPixel(y)), t < u && (u = t, b = r); h = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y) << 0) + 0.5 : this.parent.convertValueToPixel(y) << 0; this.value = y; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y }) : s(this.options.label) ? ea(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label
                                                    ...
                                                    r = this.parent.convertPixelToValue({ x: a }); for (w = 0; w < this.parent.dataSeries.length; w++)(u = this.parent.dataSeries[w].getDataPointAtX(r, !0)) && 0 <= u.index && (u.dataSeries = this.parent.dataSeries[w], null !== u.dataPoint.y &&
                                                        u.dataSeries.visible && n.push(u)); if (0 === n.length) return; n.sort(function (a, b) { return a.distance - b.distance }); x = n[0]; b = e = h = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.x) << 0; f = this.chart.plotArea.y1; l = this.chart.plotArea.y2; this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: l }; B = !1; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), r = 0; r < this.parent.viewportMaximum; r += n)if (this.parent.labels[r]) B = !0; else { B = !1; break } if (B) {
                                                            ...
                                                            value: x.dataPoint.x
                                                        }) : s(this.options.label) ? Aa(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : s(this.options.label) ? ea(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label); this.value = x.dataPoint.x; k.x = b - k.measureText().width / 2; k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 -
                                                ...
                                                !s(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (r = this.parent.dataSeries[0].axisX.convertPixelToValue({ x: a })); for (w = 0; w < this.parent.dataSeries.length; w++)(u = this.parent.dataSeries[w].getDataPointAtX(r,
                                                    !0)) && 0 <= u.index && (u.dataSeries = this.parent.dataSeries[w], null !== u.dataPoint.y && u.dataSeries.visible && n.push(u)); if (0 === n.length) return; n.sort(function (a, b) { return a.distance - b.distance }); w = 0; if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type || "boxAndWhisker" === n[0].dataSeries.type) for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])),
                                                        r = t = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (x = 0; x < n[r].dataPoint.y.length; x++)t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < u && (u = t, w = r); else t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y)), t < u && (u = t, w = r); else if ("stackedColumn" === n[0].dataSeries.type || "stackedArea" === n[0].dataSeries.type) for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = y = t = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (x = 0; x <
                                                            n[r].dataPoint.y.length; x++)t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < u && (u = t, w = r); else y += n[r].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(y)), t < u && (u = t, w = r); else if ("stackedColumn100" === n[0].dataSeries.type || "stackedArea100" === n[0].dataSeries.type) for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = B = y = t = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (x = 0; x < n[r].dataPoint.y.length; x++)t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[x])),
                                                                t < u && (u = t, w = r); else y += n[r].dataPoint.y, B = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, B = 100 * (y / n[r].dataSeries.plotUnit.dataPointYSums[B]), t = Math.abs(d - this.parent.convertValueToPixel(B)), t < u && (u = t, w = r); else for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = t = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (x = 0; x < n[r].dataPoint.y.length; x++)t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < u && (u = t, w = r); else t = Math.abs(d -
                                                                    this.parent.convertValueToPixel(n[r].dataPoint.y)), t < u && (u = t, w = r); x = n[w]; b = 0; if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type || "boxAndWhisker" === this.parent.dataSeries[w].type) {
                                                                        u = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[0])); for (r = t = 0; r < x.dataPoint.y.length; r++)t =
                                                                        ...
                                                                        this.parent.dataSeries[w].type || "stackedArea" === this.parent.dataSeries[w].type) {
                                                                            u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); y = t = 0; for (r = w; 0 <= r; r--)y += n[r].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(y)), t < u && (u = t, b = r); m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y) << 0) + 0.5 : this.parent.convertValueToPixel(y) << 0; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y }) : s(this.options.label) ?
                                                        ...
                                                        u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); y = t = 0; for (r = w; 0 <= r; r--)y += n[r].dataPoint.y, B = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, B = 100 * (y / n[r].dataSeries.plotUnit.dataPointYSums[B]), t = Math.abs(d - this.parent.convertValueToPixel(B)), t < u && (u = t, b = r); m =
                                    ...
                                    }; oa(Y, V); Y.prototype._initialize = function () {
            ...
            }(); y.version = "v3.4.1 GA"; window.CanvasJS && (y && !window.CanvasJS.Chart) && (window.CanvasJS.Chart = y)
})();
